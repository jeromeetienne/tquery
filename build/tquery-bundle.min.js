...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){function c(a){return a%4?4-a%4:0}function e(a,b){return(new Uint8Array(a,b,1))[0]}function i(a,b){return(new Uint32Array(a,b,1))[0]}function k(b,c){var d,e,f,g,h,j,i,k,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=l[3*d];f=l[3*d+1];g=l[3*d+2];h=H[2*e];e=H[2*e+1];j=H[2*f];i=H[2*f+1];f=H[2*g];k=H[2*g+1];g=P.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,e));m.push(new THREE.UV(j,i));m.push(new THREE.UV(f,k));g.push(m)}}
function l(b,c){var d,e,f,g,h,j,i,k,l,m,n=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=n[4*d];f=n[4*d+1];g=n[4*d+2];h=n[4*d+3];j=H[2*e];e=H[2*e+1];i=H[2*f];l=H[2*f+1];k=H[2*g];m=H[2*g+1];g=H[2*h];f=H[2*h+1];h=P.faceVertexUvs[0];var p=[];p.push(new THREE.UV(j,e));p.push(new THREE.UV(i,l));p.push(new THREE.UV(k,m));p.push(new THREE.UV(g,f));h.push(p)}}function p(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),j=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=j[d],P.faces.push(new THREE.Face3(e,
f,g,null,null,h))}function m(b,c,d){for(var e,f,g,h,j,c=new Uint32Array(a,c,4*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],j=i[d],P.faces.push(new THREE.Face4(e,f,g,h,null,null,j))}function o(b,c,d,e){for(var f,g,h,j,i,k,l,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];i=d[3*e];k=d[3*e+1];l=d[3*e+2];j=m[e];var n=M[3*k],p=M[3*k+1];k=M[3*k+2];var o=M[3*l],q=M[3*l+1];l=M[3*l+2];P.faces.push(new THREE.Face3(f,
g,h,[new THREE.Vector3(M[3*i],M[3*i+1],M[3*i+2]),new THREE.Vector3(n,p,k),new THREE.Vector3(o,q,l)],null,j))}}function q(b,c,d,e){for(var f,g,h,j,i,k,l,m,n,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];j=c[4*e+3];k=d[4*e];l=d[4*e+1];m=d[4*e+2];n=d[4*e+3];i=p[e];var o=M[3*l],q=M[3*l+1];l=M[3*l+2];var r=M[3*m],s=M[3*m+1];m=M[3*m+2];var t=M[3*n],u=M[3*n+1];n=M[3*n+2];P.faces.push(new THREE.Face4(f,g,h,j,[new THREE.Vector3(M[3*
k],M[3*k+1],M[3*k+2]),new THREE.Vector3(o,q,l),new THREE.Vector3(r,s,m),new THREE.Vector3(t,u,n)],null,i))}}var n,r,u,t,w,s,x,F,C,z,v,A,G,K,Q,P=this,E=0,M=[],H=[],j,S,T;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(P,d,b);(function(a,b,c){for(var a=new Uint8Array(a,b,c),d="",e=0;e<c;e++)d+=String.fromCharCode(a[b+e]);return d})(a,E,12);n=e(a,E+12);e(a,E+13);e(a,E+14);e(a,E+15);r=e(a,E+16);u=e(a,E+17);t=e(a,E+18);w=e(a,E+19);s=i(a,E+20);x=i(a,E+20+4);F=i(a,E+20+8);b=i(a,E+20+12);C=
...
127,e/127,f/127)}return 3*x*Int8Array.BYTES_PER_ELEMENT}(E);E+=c(3*x);E+=function(b){if(F){var b=new Float32Array(a,b,2*F),c,d,e;for(c=0;c<F;c++)d=b[2*c],e=b[2*c+1],H.push(d,e)}return 2*F*Float32Array.BYTES_PER_ELEMENT}(E);j=E+j+c(2*b);S=j+S+c(2*C);r=S+r+c(2*z);w=r+w+c(2*v);n=w+n+c(2*A);u=n+u+c(2*G);t=u+t+c(2*K);(function(a){if(z){var b=a+3*z*Uint32Array.BYTES_PER_ELEMENT;p(z,a,b+3*z*Uint32Array.BYTES_PER_ELEMENT);k(z,b)}})(S);(function(a){if(v){var b=a+3*v*Uint32Array.BYTES_PER_ELEMENT,c=b+3*v*Uint32Array.BYTES_PER_ELEMENT;
o(v,a,b,c+3*v*Uint32Array.BYTES_PER_ELEMENT);k(v,c)}})(r);(function(a){if(K){var b=a+4*K*Uint32Array.BYTES_PER_ELEMENT;m(K,a,b+4*K*Uint32Array.BYTES_PER_ELEMENT);l(K,b)}})(u);(function(a){if(Q){var b=a+4*Q*Uint32Array.BYTES_PER_ELEMENT,c=b+4*Q*Uint32Array.BYTES_PER_ELEMENT;q(Q,a,b,c+4*Q*Uint32Array.BYTES_PER_ELEMENT);l(Q,c)}})(t);b&&p(b,E,E+3*b*Uint32Array.BYTES_PER_ELEMENT);(function(a){if(C){var b=a+3*C*Uint32Array.BYTES_PER_ELEMENT;o(C,a,b,b+3*C*Uint32Array.BYTES_PER_ELEMENT)}})(j);A&&m(A,w,w+
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);(function(b){var c,e,i,k,l,p,m,o,q,n,r,u,t,w,s=a.faces;p=a.vertices;var x=a.normals,F=a.colors,C=0;for(c=0;c<a.uvs.length;c++)a.uvs[c].length&&C++;for(c=0;c<C;c++)d.faceUvs[c]=[],d.faceVertexUvs[c]=[];k=0;for(l=p.length;k<l;)m=new THREE.Vector3,m.x=p[k++]*b,m.y=p[k++]*b,m.z=p[k++]*b,d.vertices.push(m);k=0;for(l=s.length;k<l;){b=s[k++];p=b&1;i=b&2;c=b&4;
e=b&8;o=b&16;m=b&32;n=b&64;b&=128;p?(r=new THREE.Face4,r.a=s[k++],r.b=s[k++],r.c=s[k++],r.d=s[k++],p=4):(r=new THREE.Face3,r.a=s[k++],r.b=s[k++],r.c=s[k++],p=3);i&&(i=s[k++],r.materialIndex=i);i=d.faces.length;if(c)for(c=0;c<C;c++)u=a.uvs[c],q=s[k++],w=u[2*q],q=u[2*q+1],d.faceUvs[c][i]=new THREE.UV(w,q);if(e)for(c=0;c<C;c++){u=a.uvs[c];t=[];for(e=0;e<p;e++)q=s[k++],w=u[2*q],q=u[2*q+1],t[e]=new THREE.UV(w,q);d.faceVertexUvs[c][i]=t}o&&(o=3*s[k++],e=new THREE.Vector3,e.x=x[o++],e.y=x[o++],e.z=x[o],
r.normal=e);if(m)for(c=0;c<p;c++)o=3*s[k++],e=new THREE.Vector3,e.x=x[o++],e.y=x[o++],e.z=x[o],r.vertexNormals.push(e);n&&(m=s[k++],m=new THREE.Color(F[m]),r.color=m);if(b)for(c=0;c<p;c++)m=s[k++],m=new THREE.Color(F[m]),r.vertexColors.push(m);d.faces.push(r)}})(e);(function(){var b,c,e,i;if(a.skinWeights){b=0;for(c=a.skinWeights.length;b<c;b+=2)e=a.skinWeights[b],i=a.skinWeights[b+1],d.skinWeights.push(new THREE.Vector4(e,i,0,0))}if(a.skinIndices){b=0;for(c=a.skinIndices.length;b<c;b+=2)e=a.skinIndices[b],
...
X.b,1)),Z.r=Math.max(0,Math.min(n.color.r*Z.r,1)),Z.g=Math.max(0,Math.min(n.color.g*Z.g,1)),Z.b=Math.max(0,Math.min(n.color.b*Z.b,1)),$.r=Math.max(0,Math.min(n.color.r*$.r,1)),$.g=Math.max(0,Math.min(n.color.g*$.g,1)),$.b=Math.max(0,Math.min(n.color.b*$.b,1)),ha.r=0.5*(Z.r+$.r),ha.g=0.5*(Z.g+$.g),ha.b=0.5*(Z.b+$.b),Sa=Cc(X,Z,$,ha),gc(E,M,H,j,S,T,0,0,1,0,0,1,Sa)):(O.r=aa.r,O.g=aa.g,O.b=aa.b,p(i,m.centroidWorld,m.normalWorld,O),O.r=Math.max(0,Math.min(n.color.r*O.r,1)),O.g=Math.max(0,Math.min(n.color.g*
...
S,T,0,0,1,0,0,1,Sa)):n instanceof THREE.MeshNormalMaterial&&(O.r=hc(m.normalWorld.x),O.g=hc(m.normalWorld.y),O.b=hc(m.normalWorld.z),n.wireframe?Mb(O,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):Eb(O))}function u(a,d,e,g,h,k,n,m,o){f.info.render.vertices+=4;f.info.render.faces++;b(m.opacity);c(m.blending);m.map||m.envMap?(t(a,d,g,0,1,3,n,m,o),t(h,e,k,1,2,3,n,m,o)):(E=a.positionScreen.x,M=a.positionScreen.y,H=d.positionScreen.x,j=d.positionScreen.y,S=e.positionScreen.x,T=e.positionScreen.y,
D=g.positionScreen.x,Y=g.positionScreen.y,J=h.positionScreen.x,ea=h.positionScreen.y,fa=k.positionScreen.x,ia=k.positionScreen.y,m instanceof THREE.MeshBasicMaterial?(w(E,M,H,j,S,T,D,Y),m.wireframe?Mb(m.color,m.wireframeLinewidth,m.wireframeLinecap,m.wireframeLinejoin):Eb(m.color)):m instanceof THREE.MeshLambertMaterial?$a?!m.wireframe&&m.shading==THREE.SmoothShading&&4==n.vertexNormalsWorld.length?(X.r=Z.r=$.r=ha.r=aa.r,X.g=Z.g=$.g=ha.g=aa.g,X.b=Z.b=$.b=ha.b=aa.b,p(i,n.v1.positionWorld,n.vertexNormalsWorld[0],
X),p(i,n.v2.positionWorld,n.vertexNormalsWorld[1],Z),p(i,n.v4.positionWorld,n.vertexNormalsWorld[3],$),p(i,n.v3.positionWorld,n.vertexNormalsWorld[2],ha),X.r=Math.max(0,Math.min(m.color.r*X.r,1)),X.g=Math.max(0,Math.min(m.color.g*X.g,1)),X.b=Math.max(0,Math.min(m.color.b*X.b,1)),Z.r=Math.max(0,Math.min(m.color.r*Z.r,1)),Z.g=Math.max(0,Math.min(m.color.g*Z.g,1)),Z.b=Math.max(0,Math.min(m.color.b*Z.b,1)),$.r=Math.max(0,Math.min(m.color.r*$.r,1)),$.g=Math.max(0,Math.min(m.color.g*$.g,1)),$.b=Math.max(0,
Math.min(m.color.b*$.b,1)),ha.r=Math.max(0,Math.min(m.color.r*ha.r,1)),ha.g=Math.max(0,Math.min(m.color.g*ha.g,1)),ha.b=Math.max(0,Math.min(m.color.b*ha.b,1)),Sa=Cc(X,Z,$,ha),x(E,M,H,j,D,Y),gc(E,M,H,j,D,Y,0,0,1,0,0,1,Sa),x(J,ea,S,T,fa,ia),gc(J,ea,S,T,fa,ia,1,0,1,1,0,1,Sa)):(O.r=aa.r,O.g=aa.g,O.b=aa.b,p(i,n.centroidWorld,n.normalWorld,O),O.r=Math.max(0,Math.min(m.color.r*O.r,1)),O.g=Math.max(0,Math.min(m.color.g*O.g,1)),O.b=Math.max(0,Math.min(m.color.b*O.b,1)),w(E,M,H,j,S,T,D,Y),m.wireframe?Mb(O,
...
Db=p.image.width*p.repeat.x,r=p.image.height*p.repeat.y,h=(h+o)*Db,j=(j+q)*r,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+o)*Db-h,k=(k+q)*r-j,l=(l+o)*Db-h,m=(m+q)*r-j,o=i*m-l*k;0==o?(void 0===Ka[p.id]&&(b=document.createElement("canvas"),b.width=p.image.width,b.height=p.image.height,b=b.getContext("2d"),b.drawImage(p.image,0,0),Ka[p.id]=b.getImageData(0,0,p.image.width,p.image.height).data),b=Ka[p.id],h=4*(Math.floor(h)+Math.floor(j)*p.image.width),O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),Eb(O)):(o=1/o,p=(m*c-k*
...
eb||!1===eb.visible||(xa.empty(),Ha instanceof THREE.RenderableParticle?(v=Ha,v.x*=o,v.y*=q,r(v,Ha,eb,a)):Ha instanceof THREE.RenderableLine?(v=Ha.v1,A=Ha.v2,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=o,A.positionScreen.y*=q,xa.addPoint(v.positionScreen.x,v.positionScreen.y),xa.addPoint(A.positionScreen.x,A.positionScreen.y),Wa.intersects(xa)&&s(v,A,Ha,eb,a)):Ha instanceof THREE.RenderableFace3?(v=Ha.v1,A=Ha.v2,G=Ha.v3,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=
o,A.positionScreen.y*=q,G.positionScreen.x*=o,G.positionScreen.y*=q,eb.overdraw&&(Nb(v.positionScreen,A.positionScreen),Nb(A.positionScreen,G.positionScreen),Nb(G.positionScreen,v.positionScreen)),xa.add3Points(v.positionScreen.x,v.positionScreen.y,A.positionScreen.x,A.positionScreen.y,G.positionScreen.x,G.positionScreen.y),Wa.intersects(xa)&&t(v,A,G,0,1,2,Ha,eb,a)):Ha instanceof THREE.RenderableFace4&&(v=Ha.v1,A=Ha.v2,G=Ha.v3,K=Ha.v4,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=
o,A.positionScreen.y*=q,G.positionScreen.x*=o,G.positionScreen.y*=q,K.positionScreen.x*=o,K.positionScreen.y*=q,Q.positionScreen.copy(A.positionScreen),P.positionScreen.copy(K.positionScreen),eb.overdraw&&(Nb(v.positionScreen,A.positionScreen),Nb(A.positionScreen,K.positionScreen),Nb(K.positionScreen,v.positionScreen),Nb(G.positionScreen,Q.positionScreen),Nb(G.positionScreen,P.positionScreen)),xa.addPoint(v.positionScreen.x,v.positionScreen.y),xa.addPoint(A.positionScreen.x,A.positionScreen.y),xa.addPoint(G.positionScreen.x,
G.positionScreen.y),xa.addPoint(K.positionScreen.x,K.positionScreen.y),Wa.intersects(xa)&&u(v,A,G,K,Q,P,Ha,eb,a)),Ba.addRectangle(xa));n.setTransform(1,0,0,1,0,0)}};
...
THREE.RenderableParticle)o=A,o.x*=p,o.y*=-m;else if(A instanceof THREE.RenderableLine){if(o=A.v1,q=A.v2,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=p,q.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),u.intersects(t)){A=o;var Y=q,J=P++;null==G[J]&&(G[J]=document.createElementNS("http://www.w3.org/2000/svg","line"),0==E&&G[J].setAttribute("shape-rendering","crispEdges"));K=G[J];K.setAttribute("x1",A.positionScreen.x);
K.setAttribute("y1",A.positionScreen.y);K.setAttribute("x2",Y.positionScreen.x);K.setAttribute("y2",Y.positionScreen.y);D instanceof THREE.LineBasicMaterial&&(K.setAttribute("style","fill: none; stroke: "+D.color.getContextStyle()+"; stroke-width: "+D.linewidth+"; stroke-opacity: "+D.opacity+"; stroke-linecap: "+D.linecap+"; stroke-linejoin: "+D.linejoin),i.appendChild(K))}}else if(A instanceof THREE.RenderableFace3){if(o=A.v1,q=A.v2,n=A.v3,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=
p,q.positionScreen.y*=-m,n.positionScreen.x*=p,n.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),t.addPoint(n.positionScreen.x,n.positionScreen.y),u.intersects(t)){var Y=o,J=q,ea=n;d.info.render.vertices+=3;d.info.render.faces++;K=b(Q++);K.setAttribute("d","M "+Y.positionScreen.x+" "+Y.positionScreen.y+" L "+J.positionScreen.x+" "+J.positionScreen.y+" L "+ea.positionScreen.x+","+ea.positionScreen.y+"z");D instanceof THREE.MeshBasicMaterial?
...
"fill: none; stroke: "+s.getContextStyle()+"; stroke-width: "+D.wireframeLinewidth+"; stroke-opacity: "+D.opacity+"; stroke-linecap: "+D.wireframeLinecap+"; stroke-linejoin: "+D.wireframeLinejoin):K.setAttribute("style","fill: "+s.getContextStyle()+"; fill-opacity: "+D.opacity);i.appendChild(K)}}else if(A instanceof THREE.RenderableFace4&&(o=A.v1,q=A.v2,n=A.v3,r=A.v4,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=p,q.positionScreen.y*=-m,n.positionScreen.x*=p,n.positionScreen.y*=
-m,r.positionScreen.x*=p,r.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),t.addPoint(n.positionScreen.x,n.positionScreen.y),t.addPoint(r.positionScreen.x,r.positionScreen.y),u.intersects(t))){var Y=o,J=q,ea=n,fa=r;d.info.render.vertices+=4;d.info.render.faces++;K=b(Q++);K.setAttribute("d","M "+Y.positionScreen.x+" "+Y.positionScreen.y+" L "+J.positionScreen.x+" "+J.positionScreen.y+" L "+ea.positionScreen.x+","+ea.positionScreen.y+
...
if(!j)continue;g&&H.setBlending(j.blending,j.blendEquation,j.blendSrc,j.blendDst);H.setDepthTest(j.depthTest);H.setDepthWrite(j.depthWrite);u(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits)}H.setObjectFaces(i);k instanceof THREE.BufferGeometry?H.renderBufferDirect(d,e,f,j,k,i):H.renderBuffer(d,e,f,j,k,i)}}function k(a,b,c,d,e,f,g){for(var h,j,i=0,k=a.length;i<k;i++)if(h=a[i],j=h.object,j.visible){if(g)h=g;else{h=h[b];if(!h)continue;f&&H.setBlending(h.blending,h.blendEquation,h.blendSrc,
...
K=r.spot.exponents,G=0,X=0,M=0,O=0,c=0,h=b.length;c<h;c++)k=b[c],k.onlyShadow||(p=k.color,o=k.intensity,q=k.distance,k instanceof THREE.AmbientLight?H.gammaInput?(l+=p.r*p.r,m+=p.g*p.g,n+=p.b*p.b):(l+=p.r,m+=p.g,n+=p.b):k instanceof THREE.DirectionalLight?(q=3*G,H.gammaInput?(s[q]=p.r*p.r*o*o,s[q+1]=p.g*p.g*o*o,s[q+2]=p.b*p.b*o*o):(s[q]=p.r*o,s[q+1]=p.g*o,s[q+2]=p.b*o),aa.copy(k.matrixWorld.getPosition()),aa.subSelf(k.target.matrixWorld.getPosition()),aa.normalize(),t[q]=aa.x,t[q+1]=aa.y,t[q+2]=aa.z,
G+=1):k instanceof THREE.PointLight?(O=3*X,H.gammaInput?(u[O]=p.r*p.r*o*o,u[O+1]=p.g*p.g*o*o,u[O+2]=p.b*p.b*o*o):(u[O]=p.r*o,u[O+1]=p.g*o,u[O+2]=p.b*o),p=k.matrixWorld.getPosition(),v[O]=p.x,v[O+1]=p.y,v[O+2]=p.z,x[X]=q,X+=1):k instanceof THREE.SpotLight&&(O=3*M,H.gammaInput?(z[O]=p.r*p.r*o*o,z[O+1]=p.g*p.g*o*o,z[O+2]=p.b*p.b*o*o):(z[O]=p.r*o,z[O+1]=p.g*o,z[O+2]=p.b*o),p=k.matrixWorld.getPosition(),A[O]=p.x,A[O+1]=p.y,A[O+2]=p.z,E[M]=q,aa.copy(p),aa.subSelf(k.target.matrixWorld.getPosition()),aa.normalize(),
D[O]=aa.x,D[O+1]=aa.y,D[O+2]=aa.z,J[M]=Math.cos(k.angle),K[M]=k.exponent,M+=1));c=3*G;for(h=s.length;c<h;c++)s[c]=0;c=3*X;for(h=u.length;c<h;c++)u[c]=0;c=3*M;for(h=z.length;c<h;c++)z[c]=0;r.directional.length=G;r.point.length=X;r.spot.length=M;r.ambient[0]=l;r.ambient[1]=m;r.ambient[2]=n;Ta=!1}c=Qa;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=
...
l.visible&&(!(l instanceof THREE.Mesh||l instanceof THREE.ParticleSystem)||!l.frustumCulled||Wa.contains(l))){r(l,b);var o=f,q=o.object,s=o.buffer,t=void 0,t=q.material;t instanceof THREE.MeshFaceMaterial?(t=s.materialIndex,0<=t&&(t=q.geometry.materials[t],t.transparent?(o.transparent=t,o.opaque=null):(o.opaque=t,o.transparent=null))):t&&(t.transparent?(o.transparent=t,o.opaque=null):(o.opaque=t,o.transparent=null));f.render=!0;this.sortObjects&&(l.renderDepth?f.z=l.renderDepth:($a.copy(l.matrixWorld.getPosition()),
...
2]=Va.z,pa.array[va+3]=Va.w,va+=4;j.bindBuffer(j.ARRAY_BUFFER,pa.buffer);j.bufferData(j.ARRAY_BUFFER,pa.array,Zc)}}}ga.verticesNeedUpdate=!1;ga.colorsNeedUpdate=!1;Ua.attributes&&m(Ua)}else jb instanceof THREE.ParticleSystem&&(Ua=c(jb,hb),ic=Ua.attributes&&p(Ua),(ga.verticesNeedUpdate||ga.colorsNeedUpdate||jb.sortParticles||ic)&&f(ga,j.DYNAMIC_DRAW,jb),ga.verticesNeedUpdate=!1,ga.colorsNeedUpdate=!1,Ua.attributes&&m(Ua))}};this.initMaterial=function(a,b,c,d){var e,f,g;a instanceof THREE.MeshDepthMaterial?
...
l.lerpSelf(w,0.5),k=[s.clone(),h.clone(),l.clone()],h=[l.clone(),w.clone(),s.clone()]):(l=s.clone(),l.lerpSelf(w,0.5),k=[s.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),w.clone()]),F[f].push(k,h))}else{x.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)F[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,k=a.vertices[f],l=a.vertices[g],p=a.vertices[h],m=a.vertices[i],o=k.distanceTo(l),q=l.distanceTo(p),n=p.distanceTo(m),r=k.distanceTo(m),o>b||q>b||n>b||r>b){u=a.vertices.length;t=
a.vertices.length+1;w=e.clone();s=e.clone();o>=q&&o>=n&&o>=r||n>=q&&n>=o&&n>=r?(o=k.clone(),o.lerpSelf(l,0.5),l=p.clone(),l.lerpSelf(m,0.5),w.a=f,w.b=u,w.c=t,w.d=i,s.a=u,s.b=g,s.c=h,s.d=t,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),w.vertexNormals[1].copy(f),w.vertexNormals[2].copy(g),s.vertexNormals[0].copy(f),s.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),
f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),w.vertexColors[1].copy(f),w.vertexColors[2].copy(g),s.vertexColors[0].copy(f),s.vertexColors[3].copy(g)),e=0):(o=l.clone(),o.lerpSelf(p,0.5),l=m.clone(),l.lerpSelf(k,0.5),w.a=f,w.b=g,w.c=u,w.d=t,s.a=t,s.b=u,s.c=h,s.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),w.vertexNormals[2].copy(f),w.vertexNormals[3].copy(g),
s.vertexNormals[0].copy(g),s.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),w.vertexColors[2].copy(f),w.vertexColors[3].copy(g),s.vertexColors[0].copy(g),s.vertexColors[1].copy(f)),e=1);x.push(w,s);a.vertices.push(o,l);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(k=a.faceVertexUvs[f][c],s=k[0],h=k[1],w=k[2],k=k[3],0===e?(l=s.clone(),l.lerpSelf(h,
0.5),p=w.clone(),p.lerpSelf(k,0.5),s=[s.clone(),l.clone(),p.clone(),k.clone()],h=[l.clone(),h.clone(),w.clone(),p.clone()]):(l=h.clone(),l.lerpSelf(w,0.5),p=k.clone(),p.lerpSelf(s,0.5),s=[s.clone(),h.clone(),l.clone(),p.clone()],h=[p.clone(),l.clone(),w.clone(),k.clone()]),F[f].push(s,h))}else{x.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)F[f].push(a.faceVertexUvs[f][c])}a.faces=x;a.faceVertexUvs=F}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},b=b|1,d=a.width,e=a.height,f=document.createElement("canvas");f.width=d;f.height=e;var g=f.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,e).data,i=g.createImageData(d,e),k=i.data,l=0;l<d;l++)for(var p=0;p<e;p++){var m=0>p-1?0:p-1,o=p+1>e-1?e-1:p+1,q=0>l-1?0:l-1,n=l+1>d-1?d-1:l+1,r=[],u=[0,0,h[4*(p*d+l)]/255*b];r.push([-1,0,h[4*(p*d+q)]/255*b]);r.push([-1,-1,h[4*(m*d+q)]/255*b]);r.push([0,
-1,h[4*(m*d+l)]/255*b]);r.push([1,-1,h[4*(m*d+n)]/255*b]);r.push([1,0,h[4*(p*d+n)]/255*b]);r.push([1,1,h[4*(o*d+n)]/255*b]);r.push([0,1,h[4*(o*d+l)]/255*b]);r.push([-1,1,h[4*(o*d+q)]/255*b]);m=[];q=r.length;for(o=0;o<q;o++){var n=r[o],t=r[(o+1)%q],n=[n[0]-u[0],n[1]-u[1],n[2]-u[2]],t=[t[0]-u[0],t[1]-u[1],t[2]-u[2]];m.push(c([n[1]*t[2]-n[2]*t[1],n[2]*t[0]-n[0]*t[2],n[0]*t[1]-n[1]*t[0]]))}r=[0,0,0];for(o=0;o<m.length;o++)r[0]+=m[o][0],r[1]+=m[o][1],r[2]+=m[o][2];r[0]/=m.length;r[1]/=m.length;r[2]/=m.length;
u=4*(p*d+l);k[u]=255*((r[0]+1)/2)|0;k[u+1]=255*(r[1]+0.5)|0;k[u+2]=255*r[2]|0;k[u+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,a,b,THREE.RGBFormat);a.needsUpdate=!0;return a}};
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,g,h,i,l,m){var n,p=d||1,o=e||1,q=h/2,r=i/2,t=k.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)n="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)n="y",o=f||1;else if("z"===a&&"y"===b||"y"===a&&"z"===b)n="x",p=f||1;var j=p+1,u=o+1,w=h/p,D=i/o,Y=new THREE.Vector3;Y[n]=0<l?1:-1;for(h=0;h<u;h++)for(i=0;i<j;i++){var J=new THREE.Vector3;J[a]=(i*w-q)*c;J[b]=(h*D-r)*g;J[n]=l;k.vertices.push(J)}for(h=0;h<o;h++)for(i=0;i<p;i++)a=new THREE.Face4(i+
j*h+t,i+j*(h+1)+t,i+1+j*(h+1)+t,i+1+j*h+t),a.normal.copy(Y),a.vertexNormals.push(Y.clone(),Y.clone(),Y.clone(),Y.clone()),a.materialIndex=m,k.faces.push(a),k.faceVertexUvs[0].push([new THREE.UV(i/p,h/o),new THREE.UV(i/p,(h+1)/o),new THREE.UV((i+1)/p,(h+1)/o),new THREE.UV((i+1)/p,h/o)])}THREE.Geometry.call(this);var k=this,l=a/2,p=b/2,m=c/2,o,q,n,r,u,t;if(void 0!==g){if(g instanceof Array)this.materials=g;else{this.materials=[];for(o=0;6>o;o++)this.materials.push(g)}o=0;r=1;q=2;u=3;n=4;t=5}else this.materials=
[];this.sides={px:!0,nx:!0,py:!0,ny:!0,pz:!0,nz:!0};if(void 0!=h)for(var w in h)void 0!==this.sides[w]&&(this.sides[w]=h[w]);this.sides.px&&i("z","y",-1,-1,c,b,l,o);this.sides.nx&&i("z","y",1,-1,c,b,-l,r);this.sides.py&&i("x","z",1,1,a,c,p,q);this.sides.ny&&i("x","z",1,-1,a,c,-p,u);this.sides.pz&&i("x","y",1,-1,a,b,m,n);this.sides.nz&&i("x","y",-1,-1,a,b,-m,t);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=new THREE.Geometry;THREE.CubeGeometry.prototype.constructor=THREE.CubeGeometry;
THREE.CylinderGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);var a=void 0!==a?a:20,b=void 0!==b?b:20,c=void 0!==c?c:100,g=c/2,d=d||8,e=e||1,h,i,k=[],l=[];for(i=0;i<=e;i++){var p=[],m=[],o=i/e,q=o*(b-a)+a;for(h=0;h<=d;h++){var n=h/d,r=new THREE.Vector3;r.x=q*Math.sin(2*n*Math.PI);r.y=-o*c+g;r.z=q*Math.cos(2*n*Math.PI);this.vertices.push(r);p.push(this.vertices.length-1);m.push(new THREE.UV(n,o))}k.push(p);l.push(m)}c=(b-a)/c;for(h=0;h<d;h++){0!==a?(p=this.vertices[k[0][h]].clone(),m=this.vertices[k[0][h+
1]].clone()):(p=this.vertices[k[1][h]].clone(),m=this.vertices[k[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<e;i++){var o=k[i][h],q=k[i+1][h],n=k[i+1][h+1],r=k[i][h+1],u=p.clone(),t=p.clone(),w=m.clone(),s=m.clone(),x=l[i][h].clone(),F=l[i+1][h].clone(),C=l[i+1][h+1].clone(),z=l[i][h+1].clone();this.faces.push(new THREE.Face4(o,q,n,r,[u,t,w,s]));this.faceVertexUvs[0].push([x,F,C,z])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)o=k[0][h],q=k[0][h+1],n=this.vertices.length-1,u=new THREE.Vector3(0,1,0),t=new THREE.Vector3(0,1,0),w=new THREE.Vector3(0,1,0),x=l[0][h].clone(),F=l[0][h+1].clone(),C=new THREE.UV(F.u,0),this.faces.push(new THREE.Face3(o,q,n,[u,t,w])),this.faceVertexUvs[0].push([x,F,C])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)o=k[i][h+1],q=k[i][h],n=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),t=new THREE.Vector3(0,-1,0),w=new THREE.Vector3(0,-1,0),x=
l[i][h+1].clone(),F=l[i][h].clone(),C=new THREE.UV(F.u,1),this.faces.push(new THREE.Face3(o,q,n,[u,t,w])),this.faceVertexUvs[0].push([x,F,C])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=new THREE.Geometry;THREE.CylinderGeometry.prototype.constructor=THREE.CylinderGeometry;
...
for(var g=0,h=m+2*l,g=0;g<h;g++){var i=T*g,j=T*(g+1),k=d+e+i,i=d+f+i,n=d+f+j,j=d+e+j,p=c,o=g,q=h,k=k+G,i=i+G,n=n+G,j=j+G;A.faces.push(new THREE.Face4(k,i,n,j,null,null,t));k=O.generateSideWallUV(A,a,p,b,k,i,n,j,o,q);A.faceVertexUvs[0].push(k)}}}function f(a,b,c){A.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=G;d+=G;e+=G;A.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?O.generateBottomUV(A,a,b,c,d,e):O.generateTopUV(A,a,b,c,d,e);A.faceVertexUvs[0].push(c)}var h=void 0!==b.amount?
b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,k=void 0!==b.bevelSize?b.bevelSize:i-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,m=void 0!==b.steps?b.steps:1,o=b.bendPath,q=b.extrudePath,n,r=!1,u=b.material,t=b.extrudeMaterial,w,s,x,F;q&&(n=q.getSpacedPoints(m),r=!0,p=!1,w=new THREE.TubeGeometry.FrenetFrames(q,m,!1),s=new THREE.Vector3,x=new THREE.Vector3,F=new THREE.Vector3);p||(k=i=l=0);var C,z,v,A=this,G=this.vertices.length;o&&a.addWrapPath(o);
var q=a.extractPoints(),o=q.shape,K=q.holes;if(q=!THREE.Shape.Utils.isClockWise(o)){o=o.reverse();z=0;for(v=K.length;z<v;z++)C=K[z],THREE.Shape.Utils.isClockWise(C)&&(K[z]=C.reverse());q=!1}var Q=THREE.Shape.Utils.triangulateShape(o,K),P=o;z=0;for(v=K.length;z<v;z++)C=K[z],o=o.concat(C);var E,M,H,j,S,T=o.length,D,Y=Q.length,q=[],J=0;H=P.length;E=H-1;for(M=J+1;J<H;J++,E++,M++)E===H&&(E=0),M===H&&(M=0),q[J]=d(P[J],P[E],P[M]);var ea=[],fa,ia=q.concat();z=0;for(v=K.length;z<v;z++){C=K[z];fa=[];J=0;H=
C.length;E=H-1;for(M=J+1;J<H;J++,E++,M++)E===H&&(E=0),M===H&&(M=0),fa[J]=d(C[J],C[E],C[M]);ea.push(fa);ia=ia.concat(fa)}for(E=0;E<l;E++){H=E/l;j=i*(1-H);M=k*Math.sin(H*Math.PI/2);J=0;for(H=P.length;J<H;J++)S=c(P[J],q[J],M),f(S.x,S.y,-j);z=0;for(v=K.length;z<v;z++){C=K[z];fa=ea[z];J=0;for(H=C.length;J<H;J++)S=c(C[J],fa[J],M),f(S.x,S.y,-j)}}M=k;for(J=0;J<T;J++)S=p?c(o[J],ia[J],M):o[J],r?(x.copy(w.normals[0]).multiplyScalar(S.x),s.copy(w.binormals[0]).multiplyScalar(S.y),F.copy(n[0]).addSelf(x).addSelf(s),
f(F.x,F.y,F.z)):f(S.x,S.y,0);for(H=1;H<=m;H++)for(J=0;J<T;J++)S=p?c(o[J],ia[J],M):o[J],r?(x.copy(w.normals[H]).multiplyScalar(S.x),s.copy(w.binormals[H]).multiplyScalar(S.y),F.copy(n[H]).addSelf(x).addSelf(s),f(F.x,F.y,F.z)):f(S.x,S.y,h/m*H);for(E=l-1;0<=E;E--){H=E/l;j=i*(1-H);M=k*Math.sin(H*Math.PI/2);J=0;for(H=P.length;J<H;J++)S=c(P[J],q[J],M),f(S.x,S.y,h+j);z=0;for(v=K.length;z<v;z++){C=K[z];fa=ea[z];J=0;for(H=C.length;J<H;J++)S=c(C[J],fa[J],M),r?f(S.x,S.y+n[m-1].y,n[m-1].x+j):f(S.x,S.y,h+j)}}var O=
THREE.ExtrudeGeometry.WorldUVGenerator;(function(){if(p){var a;a=T*0;for(J=0;J<Y;J++){D=Q[J];g(D[2]+a,D[1]+a,D[0]+a,true)}a=m+l*2;a=T*a;for(J=0;J<Y;J++){D=Q[J];g(D[0]+a,D[1]+a,D[2]+a,false)}}else{for(J=0;J<Y;J++){D=Q[J];g(D[2],D[1],D[0],true)}for(J=0;J<Y;J++){D=Q[J];g(D[0]+T*m,D[1]+T*m,D[2]+T*m,false)}}})();(function(){var a=0;e(P,a);a=a+P.length;z=0;for(v=K.length;z<v;z++){C=K[z];e(C,a);a=a+C.length}})()};
...
q))}k.push(p);l.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=k[i][h+1],e=k[i][h],f=k[i+1][h],g=k[i+1][h+1],p=this.vertices[d].clone().normalize(),m=this.vertices[e].clone().normalize(),o=this.vertices[f].clone().normalize(),q=this.vertices[g].clone().normalize(),n=l[i][h+1].clone(),r=l[i][h].clone(),u=l[i+1][h].clone(),t=l[i+1][h+1].clone();Math.abs(this.vertices[d].y)==a?(this.faces.push(new THREE.Face3(d,f,g,[p,o,q])),this.faceVertexUvs[0].push([n,u,t])):Math.abs(this.vertices[f].y)==a?(this.faces.push(new THREE.Face3(d,
e,f,[p,m,o])),this.faceVertexUvs[0].push([n,r,u])):(this.faces.push(new THREE.Face4(d,e,f,g,[p,m,o,q])),this.faceVertexUvs[0].push([n,r,u,t]))}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=new THREE.Geometry;THREE.SphereGeometry.prototype.constructor=THREE.SphereGeometry;
...
G[1],v=new THREE.Vector3,u[s]?(v.addSelf(o[K]),v.addSelf(o[G]),v.multiplyScalar(0.5)):(v.addSelf(n[z]),v.addSelf(n[C]),v.addSelf(o[K]),v.addSelf(o[G]),v.multiplyScalar(0.25)),r[s]=w+q.length+A,k.push(v),A++,m.supportUVs)v=new THREE.UV,v.u=f(K,z).u+f(G,z).u,v.v=f(K,z).v+f(G,z).v,v.u/=2,v.v/=2,g(r[s],z,v),u[s]||(v=new THREE.UV,v.u=f(K,C).u+f(G,C).u,v.v=f(K,C).v+f(G,C).v,v.u/=2,v.v/=2,g(r[s],C,v));b("-- Step 2 done");var E,M;C=["123","12","2","23"];G=["123","23","3","31"];var H=["123","31","1","12"],
...
z=new THREE.Vector3;s=0;for(x=o.length;s<x;s++)if(void 0!==Q[s]){r.set(0,0,0);z.set(0,0,0);K=new THREE.Vector3(0,0,0);v=0;for(F in P[s])r.addSelf(n[F]),v++;C=0;A=Q[s].length;for(F=0;F<A;F++)u[e(Q[s][F][0],Q[s][F][1])]&&C++;if(2!=C){r.divideScalar(v);for(F=0;F<A;F++)v=Q[s][F],v=o[v[0]].clone().addSelf(o[v[1]]).divideScalar(2),z.addSelf(v);z.divideScalar(A);K.addSelf(o[s]);K.multiplyScalar(A-3);K.addSelf(r);K.addSelf(z.multiplyScalar(2));K.divideScalar(A);k[s]=K}}a.vertices=k;a.faces=l;a.faceVertexUvs[0]=
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");o=!1};this.render=function(a,d,e,u){var a=a.__webglFlares,t=a.length;if(t){var w=new THREE.Vector3,s=u/e,x=0.5*e,F=0.5*u,C=16/u,z=new THREE.Vector2(C*s,C),v=new THREE.Vector3(1,1,0),A=new THREE.Vector2(1,1),G=m,C=p;b.useProgram(l);o||(b.enableVertexAttribArray(p.vertex),b.enableVertexAttribArray(p.uv),o=!0);b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
...
0;8>r;r++)if(u=t[r],u.copy(n[r]),THREE.ShadowMapPlugin.__projector.unprojectVector(u,q),o.matrixWorldInverse.multiplyVector3(u),u.x<g.x&&(g.x=u.x),u.x>h.x&&(h.x=u.x),u.y<g.y&&(g.y=u.y),u.y>h.y&&(h.y=u.y),u.z<g.z&&(g.z=u.z),u.z>h.z)h.z=u.z;o.left=g.x;o.right=h.x;o.top=h.y;o.bottom=g.y;o.updateProjectionMatrix()}o=m.shadowMap;n=m.shadowMatrix;q=m.shadowCamera;q.position.copy(m.matrixWorld.getPosition());q.lookAt(m.target.matrixWorld.getPosition());q.updateMatrixWorld();q.matrixWorldInverse.getInverse(q.matrixWorld);
...
q.matrixWorldInverse);e.setFromMatrix(f);b.setRenderTarget(o);b.clear();t=i.__webglObjects;m=0;for(o=t.length;m<o;m++)if(r=t[m],n=r.object,r.render=!1,n.visible&&n.castShadow&&(!(n instanceof THREE.Mesh)||!n.frustumCulled||e.contains(n)))n._modelViewMatrix.multiply(q.matrixWorldInverse,n.matrixWorld),r.render=!0;m=0;for(o=t.length;m<o;m++)r=t[m],r.render&&(n=r.object,r=r.buffer,u=n.customDepthMaterial?n.customDepthMaterial:n.geometry.morphTargets.length?d:c,r instanceof THREE.BufferGeometry?b.renderBufferDirect(q,
i.__lights,null,u,r,n):b.renderBuffer(q,i.__lights,null,u,r,n));t=i.__webglObjectsImmediate;m=0;for(o=t.length;m<o;m++)r=t[m],n=r.object,n.visible&&n.castShadow&&(n._modelViewMatrix.multiply(q.matrixWorldInverse,n.matrixWorld),b.renderImmediateObject(q,i.__lights,null,c,n))}l=b.getClearColor();p=b.getClearAlpha();a.clearColor(l.r,l.g,l.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
k.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=!1};this.render=function(d,e,o,q){var d=d.__webglSprites,n=d.length;if(n){var r=i,u=k,t=q/o,o=0.5*o,w=0.5*q,s=!0;b.useProgram(h);l||(b.enableVertexAttribArray(r.position),b.enableVertexAttribArray(r.uv),l=!0);b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(!0);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(r.position,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(u.projectionMatrix,
!1,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(u.map,0);for(var x,F=[],r=0;r<n;r++)x=d[r],x.visible&&0!==x.opacity&&(x.useScreenCoordinates?x.z=-x.position.z:(x._modelViewMatrix.multiply(e.matrixWorldInverse,x.matrixWorld),x.z=-x._modelViewMatrix.elements[14]));d.sort(a);for(r=0;r<n;r++)if(x=d[r],x.visible&&0!==x.opacity&&x.map&&x.map.image&&x.map.image.width)x.useScreenCoordinates?(b.uniform1i(u.useScreenCoordinates,1),b.uniform3f(u.screenPosition,(x.position.x-o)/o,(w-x.position.y)/
...
tQuery.Object3D._hasClassOne=function(a,b){return void 0===a._tqClasses?!1:a._tqClasses.match(RegExp("(^| |\t)+("+b+")($| |\t)+"))?!0:!1};tQuery.Object3D._removeClassOne=function(a,b){void 0!==a._tqClasses&&(a._tqClasses=a._tqClasses.replace(RegExp("(^| |\t)("+b+")($| |\t)")," "))};tQuery.Object3D._select=function(a,b){var b=b||tQuery.world.tScene(),c=a.split(" ").filter(function(a){return 0<a.length}),d=[];b.children.forEach(function(a){a=this._crawls(a,c);d=d.concat(a)}.bind(this));return d};
...
tQuery.World=function(a){a=a||{};this._opts=a=tQuery.extend(a,{renderW:window.innerWidth,renderH:window.innerHeight,webGLNeeded:!0,autoRendering:!0,scene:null,camera:null,renderer:null});tQuery.world=this;this._autoRendering=!0;this._scene=a.scene||new THREE.Scene;a.camera?this._camera=a.camera:(this._camera=new THREE.PerspectiveCamera(35,a.renderW/a.renderH,0.01,1E4),this._camera.position.set(0,0,3),this._scene.add(this._camera));this._loop=new tQuery.Loop;this._loop.hookOnRender(this._$loopCb=function(){this.render()}.bind(this));
if(a.renderer)this._renderer=a.renderer;else if(tQuery.World.hasWebGL())this._renderer=new THREE.WebGLRenderer({antialias:!0,preserveDrawingBuffer:!0});else{if(a.webGLNeeded)throw this._addGetWebGLMessage(),Error("WebGL required and not available");this._renderer=new THREE.CanvasRenderer}this._renderer.setClearColorHex(12303291,1);this._renderer.setSize(a.renderW,a.renderH)};tQuery.pluginsInstanceOn(tQuery.World);tQuery.MicroeventMixin(tQuery.World.prototype);
...
var Stats=function(){var a,b,c=0,d=0,e=Date.now(),f=e,g=e,h=0,i=1E3,k=0,l,p,m,o=[[16,16,48],[0,255,255]],q=0,n=1E3,r=0,u,t,w,s=[[16,48,16],[0,255,0]];a=document.createElement("div");a.style.cursor="pointer";a.style.width="80px";a.style.opacity="0.9";a.style.zIndex="10001";a.addEventListener("mousedown",function(a){a.preventDefault();c=(c+1)%2;0==c?(l.style.display="block",u.style.display="none"):(l.style.display="none",u.style.display="block")},!1);l=document.createElement("div");l.style.textAlign=
...
"30px";m.style.backgroundColor="rgb("+o[1][0]+","+o[1][1]+","+o[1][2]+")";for(l.appendChild(m);74>m.children.length;)b=document.createElement("span"),b.style.width="1px",b.style.height="30px",b.style.cssFloat="left",b.style.backgroundColor="rgb("+o[0][0]+","+o[0][1]+","+o[0][2]+")",m.appendChild(b);u=document.createElement("div");u.style.textAlign="left";u.style.lineHeight="1.2em";u.style.backgroundColor="rgb("+Math.floor(s[0][0]/2)+","+Math.floor(s[0][1]/2)+","+Math.floor(s[0][2]/2)+")";u.style.padding=
