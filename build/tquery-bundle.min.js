...
this.y=a.elements[13];this.z=a.elements[14];return this},getRotationFromMatrix:function(a,b){var c=b?b.x:1,d=b?b.y:1,e=b?b.z:1,f=a.elements[0]/c,g=a.elements[4]/d,c=a.elements[1]/c,d=a.elements[5]/d,h=a.elements[9]/e,j=a.elements[10]/e;this.y=Math.asin(a.elements[8]/e);e=Math.cos(this.y);1.0E-5<Math.abs(e)?(this.x=Math.atan2(-h/e,j/e),this.z=Math.atan2(-g/e,f/e)):(this.x=0,this.z=Math.atan2(c,d));return this},getScaleFromMatrix:function(a){var b=this.set(a.elements[0],a.elements[1],a.elements[2]).length(),
...
THREE.Ray=function(a,b){function c(a,b,c){q.sub(c,a);u=q.dot(b);t=n.add(a,r.copy(b).multiplyScalar(u));return c.distanceTo(t)}function d(a,b,c,d){q.sub(d,b);n.sub(c,b);r.sub(a,b);w=q.dot(q);s=q.dot(n);x=q.dot(r);H=n.dot(n);C=n.dot(r);z=1/(w*H-s*s);v=(H*x-s*C)*z;A=(w*C-s*x)*z;return 0<=v&&0<=A&&1>v+A}this.origin=a||new THREE.Vector3;this.direction=b||new THREE.Vector3;var e=1.0E-4;this.setPrecision=function(a){e=a};var f=new THREE.Vector3,g=new THREE.Vector3,h=new THREE.Vector3,j=new THREE.Vector3,
...
a.matrixWorld.getColumnZ().length());if(q>a.geometry.boundingSphere.radius*Math.max(r.x,Math.max(r.y,r.z)))return n;var s,t,i=a.geometry,u=i.vertices,v;a.matrixRotationWorld.extractRotation(a.matrixWorld);q=0;for(r=i.faces.length;q<r;q++)if(b=i.faces[q],k.copy(this.origin),l.copy(this.direction),v=a.matrixWorld,p=v.multiplyVector3(p.copy(b.centroid)).subSelf(k),m=a.matrixRotationWorld.multiplyVector3(m.copy(b.normal)),s=l.dot(m),!(Math.abs(s)<e)&&(t=m.dot(p)/s,!(0>t)&&(a.doubleSided||(a.flipSided?
0<s:0>s))))if(o.add(k,l.multiplyScalar(t)),b instanceof THREE.Face3)f=v.multiplyVector3(f.copy(u[b.a])),g=v.multiplyVector3(g.copy(u[b.b])),h=v.multiplyVector3(h.copy(u[b.c])),d(o,f,g,h)&&(b={distance:k.distanceTo(o),point:o.clone(),face:b,object:a},n.push(b));else if(b instanceof THREE.Face4&&(f=v.multiplyVector3(f.copy(u[b.a])),g=v.multiplyVector3(g.copy(u[b.b])),h=v.multiplyVector3(h.copy(u[b.c])),j=v.multiplyVector3(j.copy(u[b.d])),d(o,f,g,j)||d(o,g,h,j)))b={distance:k.distanceTo(o),point:o.clone(),
face:b,object:a},n.push(b)}return n};this.intersectObjects=function(a){for(var b=[],c=0,d=a.length;c<d;c++)Array.prototype.push.apply(b,this.intersectObject(a[c]));b.sort(function(a,b){return a.distance-b.distance});return b};var q=new THREE.Vector3,n=new THREE.Vector3,r=new THREE.Vector3,u,t,w,s,x,H,C,z,v,A};
...
transpose:function(){var a,b=this.elements;a=b[1];b[1]=b[3];b[3]=a;a=b[2];b[2]=b[6];b[6]=a;a=b[5];b[5]=b[7];b[7]=a;return this},transposeIntoArray:function(a){var b=this.m;a[0]=b[0];a[1]=b[3];a[2]=b[6];a[3]=b[1];a[4]=b[4];a[5]=b[7];a[6]=b[2];a[7]=b[5];a[8]=b[8];return this}};THREE.Matrix4=function(a,b,c,d,e,f,g,h,j,k,l,p,m,o,q,n){this.elements=new Float32Array(16);this.set(void 0!==a?a:1,b||0,c||0,d||0,e||0,void 0!==f?f:1,g||0,h||0,j||0,k||0,void 0!==l?l:1,p||0,m||0,o||0,q||0,void 0!==n?n:1)};
...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1.0E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],j=c[12],k=c[1],l=c[5],p=c[9],m=c[13],o=c[2],q=c[6],n=c[10],r=c[14],u=c[3],t=c[7],w=c[11],c=c[15],s=d[0],x=d[4],H=
d[8],C=d[12],z=d[1],v=d[5],A=d[9],K=d[13],F=d[2],Q=d[6],P=d[10],E=d[14],M=d[3],G=d[7],i=d[11],d=d[15];e[0]=f*s+g*z+h*F+j*M;e[4]=f*x+g*v+h*Q+j*G;e[8]=f*H+g*A+h*P+j*i;e[12]=f*C+g*K+h*E+j*d;e[1]=k*s+l*z+p*F+m*M;e[5]=k*x+l*v+p*Q+m*G;e[9]=k*H+l*A+p*P+m*i;e[13]=k*C+l*K+p*E+m*d;e[2]=o*s+q*z+n*F+r*M;e[6]=o*x+q*v+n*Q+r*G;e[10]=o*H+q*A+n*P+r*i;e[14]=o*C+q*K+n*E+r*d;e[3]=u*s+t*z+w*F+c*M;e[7]=u*x+t*v+w*Q+c*G;e[11]=u*H+t*A+w*P+c*i;e[15]=u*C+t*K+w*E+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
b[2]+d*b[6]+e*b[10];a.normalize();return a},crossVector:function(a){var b=this.elements,c=new THREE.Vector4;c.x=b[0]*a.x+b[4]*a.y+b[8]*a.z+b[12]*a.w;c.y=b[1]*a.x+b[5]*a.y+b[9]*a.z+b[13]*a.w;c.z=b[2]*a.x+b[6]*a.y+b[10]*a.z+b[14]*a.w;c.w=a.w?b[3]*a.x+b[7]*a.y+b[11]*a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],e=a[12],f=a[1],g=a[5],h=a[9],j=a[13],k=a[2],l=a[6],p=a[10],m=a[14],o=a[3],q=a[7],n=a[11],a=a[15];return e*h*l*o-d*j*l*o-e*g*p*o+c*j*p*o+d*g*m*o-c*h*
m*o-e*h*k*q+d*j*k*q+e*f*p*q-b*j*p*q-d*f*m*q+b*h*m*q+e*g*k*n-c*j*k*n-e*f*l*n+b*j*l*n+c*f*m*n-b*g*m*n-d*g*k*a+c*h*k*a+d*f*l*a-b*h*l*a-c*f*p*a+b*g*p*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;b=a[3];a[3]=a[12];a[12]=b;b=a[7];a[7]=a[13];a[13]=b;b=a[11];a[11]=a[14];a[14]=b;return this},flattenToArray:function(a){var b=this.elements;a[0]=b[0];a[1]=b[1];a[2]=b[2];a[3]=b[3];a[4]=b[4];a[5]=b[5];a[6]=b[6];a[7]=b[7];a[8]=b[8];a[9]=b[9];
...
h;b[6]=l*e+a*j;b[7]=l*f+a*k;b[8]=l*g-a*c;b[9]=l*h-a*d;b[10]=l*j-a*e;b[11]=l*k-a*f;return this},rotateY:function(a){var b=this.elements,c=b[0],d=b[1],e=b[2],f=b[3],g=b[8],h=b[9],j=b[10],k=b[11],l=Math.cos(a),a=Math.sin(a);b[0]=l*c-a*g;b[1]=l*d-a*h;b[2]=l*e-a*j;b[3]=l*f-a*k;b[8]=l*g+a*c;b[9]=l*h+a*d;b[10]=l*j+a*e;b[11]=l*k+a*f;return this},rotateZ:function(a){var b=this.elements,c=b[0],d=b[1],e=b[2],f=b[3],g=b[4],h=b[5],j=b[6],k=b[7],l=Math.cos(a),a=Math.sin(a);b[0]=l*c+a*g;b[1]=l*d+a*h;b[2]=l*e+a*
j;b[3]=l*f+a*k;b[4]=l*g-a*c;b[5]=l*h-a*d;b[6]=l*j-a*e;b[7]=l*k-a*f;return this},rotateByAxis:function(a,b){var c=this.elements;if(1===a.x&&0===a.y&&0===a.z)return this.rotateX(b);if(0===a.x&&1===a.y&&0===a.z)return this.rotateY(b);if(0===a.x&&0===a.y&&1===a.z)return this.rotateZ(b);var d=a.x,e=a.y,f=a.z,g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,j=f*f,k=Math.cos(b),l=Math.sin(b),p=1-k,m=d*e*p,o=d*f*p,p=e*f*p,d=d*l,q=e*l,l=f*l,f=g+(1-g)*k,g=m+l,e=o-q,m=m-l,h=h+(1-h)*k,l=p+d,o=o+q,p=p-d,
j=j+(1-j)*k,k=c[0],d=c[1],q=c[2],n=c[3],r=c[4],u=c[5],t=c[6],w=c[7],s=c[8],x=c[9],H=c[10],C=c[11];c[0]=f*k+g*r+e*s;c[1]=f*d+g*u+e*x;c[2]=f*q+g*t+e*H;c[3]=f*n+g*w+e*C;c[4]=m*k+h*r+l*s;c[5]=m*d+h*u+l*x;c[6]=m*q+h*t+l*H;c[7]=m*n+h*w+l*C;c[8]=o*k+p*r+j*s;c[9]=o*d+p*u+j*x;c[10]=o*q+p*t+j*H;c[11]=o*n+p*w+j*C;return this},scale:function(a){var b=this.elements,c=a.x,d=a.y,a=a.z;b[0]*=c;b[4]*=d;b[8]*=a;b[1]*=c;b[5]*=d;b[9]*=a;b[2]*=c;b[6]*=d;b[10]*=a;b[3]*=c;b[7]*=d;b[11]*=a;return this},getMaxScaleOnAxis:function(){var a=
...
var e,f,g=[],h,j,k=[],l,p,m=[],o,q=[],n,r,u=[],t,w,s=[],x={objects:[],sprites:[],lights:[],elements:[]},H=new THREE.Vector3,C=new THREE.Vector4,z=new THREE.Matrix4,v=new THREE.Matrix4,A=new THREE.Frustum,K=new THREE.Vector4,F=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);z.multiply(b.projectionMatrix,b.matrixWorldInverse);z.multiplyVector3(a);return a};this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);z.multiply(b.matrixWorld,
b.projectionMatrixInverse);z.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectGraph=function(b,d){f=0;x.objects.length=0;x.sprites.length=0;x.lights.length=0;var g=function(b){if(!1!==b.visible){(b instanceof THREE.Mesh||b instanceof THREE.Line)&&(!1===b.frustumCulled||A.contains(b))?(H.copy(b.matrixWorld.getPosition()),z.multiplyVector3(H),
e=a(),e.object=b,e.z=H.z,x.objects.push(e)):b instanceof THREE.Sprite||b instanceof THREE.Particle?(H.copy(b.matrixWorld.getPosition()),z.multiplyVector3(H),e=a(),e.object=b,e.z=H.z,x.sprites.push(e)):b instanceof THREE.Light&&x.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)g(b.children[c])}};g(b);d&&x.objects.sort(c);return x};this.projectScene=function(a,e,f){var g=e.near,G=e.far,i=!1,H,T,D,Y,J,ea,fa,ia,O,X,Z,$,ha,Ma,Ka;w=r=o=p=0;x.elements.length=0;void 0===e.parent&&(console.warn("DEPRECATED: Camera hasn't been added to a Scene. Adding it..."),
a.add(e));a.updateMatrixWorld();e.matrixWorldInverse.getInverse(e.matrixWorld);z.multiply(e.projectionMatrix,e.matrixWorldInverse);A.setFromMatrix(z);x=this.projectGraph(a,!1);a=0;for(H=x.objects.length;a<H;a++)if(O=x.objects[a].object,X=O.matrixWorld,j=0,O instanceof THREE.Mesh){Z=O.geometry;$=O.geometry.materials;Y=Z.vertices;ha=Z.faces;Ma=Z.faceVertexUvs;Z=O.matrixRotationWorld.extractRotation(X);T=0;for(D=Y.length;T<D;T++)h=b(),h.positionWorld.copy(Y[T]),X.multiplyVector3(h.positionWorld),h.positionScreen.copy(h.positionWorld),
z.multiplyVector4(h.positionScreen),h.positionScreen.x/=h.positionScreen.w,h.positionScreen.y/=h.positionScreen.w,h.visible=h.positionScreen.z>g&&h.positionScreen.z<G;Y=0;for(T=ha.length;Y<T;Y++){D=ha[Y];if(D instanceof THREE.Face3)if(J=k[D.a],ea=k[D.b],fa=k[D.c],J.visible&&ea.visible&&fa.visible)if(i=0>(fa.positionScreen.x-J.positionScreen.x)*(ea.positionScreen.y-J.positionScreen.y)-(fa.positionScreen.y-J.positionScreen.y)*(ea.positionScreen.x-J.positionScreen.x),O.doubleSided||i!=O.flipSided)ia=
m[p]=m[p]||new THREE.RenderableFace3,p++,l=ia,l.v1.copy(J),l.v2.copy(ea),l.v3.copy(fa);else continue;else continue;else if(D instanceof THREE.Face4)if(J=k[D.a],ea=k[D.b],fa=k[D.c],ia=k[D.d],J.visible&&ea.visible&&fa.visible&&ia.visible)if(i=0>(ia.positionScreen.x-J.positionScreen.x)*(ea.positionScreen.y-J.positionScreen.y)-(ia.positionScreen.y-J.positionScreen.y)*(ea.positionScreen.x-J.positionScreen.x)||0>(ea.positionScreen.x-fa.positionScreen.x)*(ia.positionScreen.y-fa.positionScreen.y)-(ea.positionScreen.y-
fa.positionScreen.y)*(ia.positionScreen.x-fa.positionScreen.x),O.doubleSided||i!=O.flipSided)Ka=q[o]=q[o]||new THREE.RenderableFace4,o++,l=Ka,l.v1.copy(J),l.v2.copy(ea),l.v3.copy(fa),l.v4.copy(ia);else continue;else continue;l.normalWorld.copy(D.normal);!i&&(O.flipSided||O.doubleSided)&&l.normalWorld.negate();Z.multiplyVector3(l.normalWorld);l.centroidWorld.copy(D.centroid);X.multiplyVector3(l.centroidWorld);l.centroidScreen.copy(l.centroidWorld);z.multiplyVector3(l.centroidScreen);fa=D.vertexNormals;
J=0;for(ea=fa.length;J<ea;J++)ia=l.vertexNormalsWorld[J],ia.copy(fa[J]),!i&&(O.flipSided||O.doubleSided)&&ia.negate(),Z.multiplyVector3(ia);J=0;for(ea=Ma.length;J<ea;J++)if(Ka=Ma[J][Y]){fa=0;for(ia=Ka.length;fa<ia;fa++)l.uvs[J][fa]=Ka[fa]}l.material=O.material;l.faceMaterial=null!==D.materialIndex?$[D.materialIndex]:null;l.z=l.centroidScreen.z;x.elements.push(l)}}else if(O instanceof THREE.Line){v.multiply(z,X);Y=O.geometry.vertices;J=b();J.positionScreen.copy(Y[0]);v.multiplyVector4(J.positionScreen);
X=O.type===THREE.LinePieces?2:1;T=1;for(D=Y.length;T<D;T++)J=b(),J.positionScreen.copy(Y[T]),v.multiplyVector4(J.positionScreen),0<(T+1)%X||(ea=k[j-2],K.copy(J.positionScreen),F.copy(ea.positionScreen),d(K,F)&&(K.multiplyScalar(1/K.w),F.multiplyScalar(1/F.w),$=u[r]=u[r]||new THREE.RenderableLine,r++,n=$,n.v1.positionScreen.copy(K),n.v2.positionScreen.copy(F),n.z=Math.max(K.z,F.z),n.material=O.material,x.elements.push(n)))}a=0;for(H=x.sprites.length;a<H;a++)O=x.sprites[a].object,X=O.matrixWorld,O instanceof
...
j.copy(e.normal),e instanceof THREE.Face3?(k.a.copy(e.vertexNormals[0]),k.b.copy(e.vertexNormals[1]),k.c.copy(e.vertexNormals[2])):(k.a.copy(e.vertexNormals[0]),k.b.copy(e.vertexNormals[1]),k.c.copy(e.vertexNormals[2]),k.d.copy(e.vertexNormals[3]))}c=0;for(d=this.faces.length;c<d;c++)e=this.faces[c],e.normal=e.__originalFaceNormal,e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,J){h=a.vertices[b];j=a.vertices[c];k=a.vertices[d];l=g[e];p=g[f];m=g[J];o=j.x-
h.x;q=k.x-h.x;n=j.y-h.y;r=k.y-h.y;u=j.z-h.z;t=k.z-h.z;w=p.u-l.u;s=m.u-l.u;x=p.v-l.v;H=m.v-l.v;C=1/(w*H-s*x);K.set((H*o-x*q)*C,(H*n-x*r)*C,(H*u-x*t)*C);F.set((w*q-s*o)*C,(w*r-s*n)*C,(w*t-s*u)*C);v[b].addSelf(K);v[c].addSelf(K);v[d].addSelf(K);A[b].addSelf(F);A[c].addSelf(F);A[d].addSelf(F)}var b,c,d,e,f,g,h,j,k,l,p,m,o,q,n,r,u,t,w,s,x,H,C,z,v=[],A=[],K=new THREE.Vector3,F=new THREE.Vector3,Q=new THREE.Vector3,P=new THREE.Vector3,E=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)v[b]=new THREE.Vector3,
...
f+2;k=this.points[c[0]];l=this.points[c[1]];p=this.points[c[2]];m=this.points[c[3]];h=g*g;j=g*h;d.x=b(k.x,l.x,p.x,m.x,g,h,j);d.y=b(k.y,l.y,p.y,m.y,g,h,j);d.z=b(k.z,l.z,p.z,m.z,g,h,j);return d};this.getControlPointsArray=function(){var a,b,c=this.points.length,d=[];for(a=0;a<c;a++)b=this.points[a],d[a]=[b.x,b.y,b.z];return d};this.getLength=function(a){var b,c,d,e=0,f=new THREE.Vector3,g=new THREE.Vector3,h=[],j=0;h[0]=0;a||(a=100);c=this.points.length*a;f.copy(this.points[0]);for(a=1;a<c;a++)b=a/
c,d=this.getPoint(b),g.copy(d),j+=g.distanceTo(f),f.copy(d),b*=this.points.length-1,b=Math.floor(b),b!=e&&(h[b]=j,e=b);h[h.length]=j;return{chunks:h,total:j}};this.reparametrizeByArcLength=function(a){var b,c,d,e,f,g,h=[],j=new THREE.Vector3,k=this.getLength();h.push(j.copy(this.points[0]).clone());for(b=1;b<this.points.length;b++){c=k.chunks[b]-k.chunks[b-1];g=Math.ceil(a*c/k.total);e=(b-1)/(this.points.length-1);f=b/(this.points.length-1);for(c=1;c<g-1;c++)d=e+c*(1/g)*(f-e),d=this.getPoint(d),h.push(j.copy(d).clone());
h.push(j.copy(this.points[b]).clone())}this.points=h}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=new THREE.Object3D;THREE.Camera.prototype.constructor=THREE.Camera;THREE.Camera.prototype.lookAt=function(a){this.matrix.lookAt(this.position,a,this.up);this.rotationAutoUpdate&&this.rotation.getRotationFromMatrix(this.matrix)};
...
if(f&&(a[c].repeat.set(f[0],f[1]),1!=f[0]&&(a[c].wrapS=THREE.RepeatWrapping),1!=f[1]))a[c].wrapT=THREE.RepeatWrapping;g&&a[c].offset.set(g[0],g[1]);if(h&&(f={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==f[h[0]]&&(a[c].wrapS=f[h[0]]),void 0!==f[h[1]]))a[c].wrapT=f[h[1]];e(a[c],b+"/"+d)}function g(a){return(255*a[0]<<16)+(255*a[1]<<8)+255*a[2]}var h=this,j="MeshLambertMaterial",k={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,wireframe:a.wireframe};if(a.shading){var l=
a.shading.toLowerCase();"phong"===l?j="MeshPhongMaterial":"basic"===l&&(j="MeshBasicMaterial")}void 0!==a.blending&&void 0!==THREE[a.blending]&&(k.blending=THREE[a.blending]);if(void 0!==a.transparent||1>a.opacity)k.transparent=a.transparent;void 0!==a.depthTest&&(k.depthTest=a.depthTest);void 0!==a.depthWrite&&(k.depthWrite=a.depthWrite);void 0!==a.vertexColors&&("face"==a.vertexColors?k.vertexColors=THREE.FaceColors:a.vertexColors&&(k.vertexColors=THREE.VertexColors));a.colorDiffuse?k.color=g(a.colorDiffuse):
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){function c(a){return a%4?4-a%4:0}function e(a,b){return(new Uint8Array(a,b,1))[0]}function j(a,b){return(new Uint32Array(a,b,1))[0]}function k(b,c){var d,e,f,g,h,i,j,k,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=l[3*d];f=l[3*d+1];g=l[3*d+2];h=G[2*e];e=G[2*e+1];i=G[2*f];j=G[2*f+1];f=G[2*g];k=G[2*g+1];g=P.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,e));m.push(new THREE.UV(i,j));m.push(new THREE.UV(f,k));g.push(m)}}
function l(b,c){var d,e,f,g,h,i,j,k,l,m,n=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=n[4*d];f=n[4*d+1];g=n[4*d+2];h=n[4*d+3];i=G[2*e];e=G[2*e+1];j=G[2*f];l=G[2*f+1];k=G[2*g];m=G[2*g+1];g=G[2*h];f=G[2*h+1];h=P.faceVertexUvs[0];var o=[];o.push(new THREE.UV(i,e));o.push(new THREE.UV(j,l));o.push(new THREE.UV(k,m));o.push(new THREE.UV(g,f));h.push(o)}}function p(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],P.faces.push(new THREE.Face3(e,
f,g,null,null,h))}function m(b,c,d){for(var e,f,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=j[d],P.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function o(b,c,d,e){for(var f,g,h,i,j,k,l,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];j=d[3*e];k=d[3*e+1];l=d[3*e+2];i=m[e];var n=M[3*k],o=M[3*k+1];k=M[3*k+2];var p=M[3*l],q=M[3*l+1];l=M[3*l+2];P.faces.push(new THREE.Face3(f,
g,h,[new THREE.Vector3(M[3*j],M[3*j+1],M[3*j+2]),new THREE.Vector3(n,o,k),new THREE.Vector3(p,q,l)],null,i))}}function q(b,c,d,e){for(var f,g,h,i,j,k,l,m,n,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),o=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];k=d[4*e];l=d[4*e+1];m=d[4*e+2];n=d[4*e+3];j=o[e];var p=M[3*l],q=M[3*l+1];l=M[3*l+2];var r=M[3*m],s=M[3*m+1];m=M[3*m+2];var t=M[3*n],u=M[3*n+1];n=M[3*n+2];P.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(M[3*
k],M[3*k+1],M[3*k+2]),new THREE.Vector3(p,q,l),new THREE.Vector3(r,s,m),new THREE.Vector3(t,u,n)],null,j))}}var n,r,u,t,w,s,x,H,C,z,v,A,K,F,Q,P=this,E=0,M=[],G=[],i,S,T;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(P,d,b);(function(a,b,c){for(var a=new Uint8Array(a,b,c),d="",e=0;e<c;e++)d+=String.fromCharCode(a[b+e]);return d})(a,E,12);n=e(a,E+12);e(a,E+13);e(a,E+14);e(a,E+15);r=e(a,E+16);u=e(a,E+17);t=e(a,E+18);w=e(a,E+19);s=j(a,E+20);x=j(a,E+20+4);H=j(a,E+20+8);b=j(a,E+20+12);C=
j(a,E+20+16);z=j(a,E+20+20);v=j(a,E+20+24);A=j(a,E+20+28);K=j(a,E+20+32);F=j(a,E+20+36);Q=j(a,E+20+40);E+=n;n=3*r+w;T=4*r+w;i=b*n;S=C*(n+3*u);r=z*(n+3*t);w=v*(n+3*u+3*t);n=A*T;u=K*(T+4*u);t=F*(T+4*t);E+=function(b){var b=new Float32Array(a,b,3*s),c,d,e,f;for(c=0;c<s;c++)d=b[3*c],e=b[3*c+1],f=b[3*c+2],P.vertices.push(new THREE.Vector3(d,e,f));return 3*s*Float32Array.BYTES_PER_ELEMENT}(E);E+=function(b){if(x){var b=new Int8Array(a,b,3*x),c,d,e,f;for(c=0;c<x;c++)d=b[3*c],e=b[3*c+1],f=b[3*c+2],M.push(d/
127,e/127,f/127)}return 3*x*Int8Array.BYTES_PER_ELEMENT}(E);E+=c(3*x);E+=function(b){if(H){var b=new Float32Array(a,b,2*H),c,d,e;for(c=0;c<H;c++)d=b[2*c],e=b[2*c+1],G.push(d,e)}return 2*H*Float32Array.BYTES_PER_ELEMENT}(E);i=E+i+c(2*b);S=i+S+c(2*C);r=S+r+c(2*z);w=r+w+c(2*v);n=w+n+c(2*A);u=n+u+c(2*K);t=u+t+c(2*F);(function(a){if(z){var b=a+3*z*Uint32Array.BYTES_PER_ELEMENT;p(z,a,b+3*z*Uint32Array.BYTES_PER_ELEMENT);k(z,b)}})(S);(function(a){if(v){var b=a+3*v*Uint32Array.BYTES_PER_ELEMENT,c=b+3*v*Uint32Array.BYTES_PER_ELEMENT;
o(v,a,b,c+3*v*Uint32Array.BYTES_PER_ELEMENT);k(v,c)}})(r);(function(a){if(F){var b=a+4*F*Uint32Array.BYTES_PER_ELEMENT;m(F,a,b+4*F*Uint32Array.BYTES_PER_ELEMENT);l(F,b)}})(u);(function(a){if(Q){var b=a+4*Q*Uint32Array.BYTES_PER_ELEMENT,c=b+4*Q*Uint32Array.BYTES_PER_ELEMENT;q(Q,a,b,c+4*Q*Uint32Array.BYTES_PER_ELEMENT);l(Q,c)}})(t);b&&p(b,E,E+3*b*Uint32Array.BYTES_PER_ELEMENT);(function(a){if(C){var b=a+3*C*Uint32Array.BYTES_PER_ELEMENT;o(C,a,b,b+3*C*Uint32Array.BYTES_PER_ELEMENT)}})(i);A&&m(A,w,w+
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);(function(b){var c,e,j,k,l,p,m,o,q,n,r,u,t,w,s=a.faces;p=a.vertices;var x=a.normals,H=a.colors,C=0;for(c=0;c<a.uvs.length;c++)a.uvs[c].length&&C++;for(c=0;c<C;c++)d.faceUvs[c]=[],d.faceVertexUvs[c]=[];k=0;for(l=p.length;k<l;)m=new THREE.Vector3,m.x=p[k++]*b,m.y=p[k++]*b,m.z=p[k++]*b,d.vertices.push(m);k=0;for(l=s.length;k<l;){b=s[k++];p=b&1;j=b&2;c=b&4;
e=b&8;o=b&16;m=b&32;n=b&64;b&=128;p?(r=new THREE.Face4,r.a=s[k++],r.b=s[k++],r.c=s[k++],r.d=s[k++],p=4):(r=new THREE.Face3,r.a=s[k++],r.b=s[k++],r.c=s[k++],p=3);j&&(j=s[k++],r.materialIndex=j);j=d.faces.length;if(c)for(c=0;c<C;c++)u=a.uvs[c],q=s[k++],w=u[2*q],q=u[2*q+1],d.faceUvs[c][j]=new THREE.UV(w,q);if(e)for(c=0;c<C;c++){u=a.uvs[c];t=[];for(e=0;e<p;e++)q=s[k++],w=u[2*q],q=u[2*q+1],t[e]=new THREE.UV(w,q);d.faceVertexUvs[c][j]=t}o&&(o=3*s[k++],e=new THREE.Vector3,e.x=x[o++],e.y=x[o++],e.z=x[o],
r.normal=e);if(m)for(c=0;c<p;c++)o=3*s[k++],e=new THREE.Vector3,e.x=x[o++],e.y=x[o++],e.z=x[o],r.vertexNormals.push(e);n&&(m=s[k++],m=new THREE.Color(H[m]),r.color=m);if(b)for(c=0;c<p;c++)m=s[k++],m=new THREE.Color(H[m]),r.vertexColors.push(m);d.faces.push(r)}})(e);(function(){var b,c,e,j;if(a.skinWeights){b=0;for(c=a.skinWeights.length;b<c;b+=2)e=a.skinWeights[b],j=a.skinWeights[b+1],d.skinWeights.push(new THREE.Vector4(e,j,0,0))}if(a.skinIndices){b=0;for(c=a.skinIndices.length;b<c;b+=2)e=a.skinIndices[b],
j=a.skinIndices[b+1],d.skinIndices.push(new THREE.Vector4(e,j,0,0))}d.bones=a.bones;d.animation=a.animation})();(function(b){if(void 0!==a.morphTargets){var c,e,j,k,l,p;c=0;for(e=a.morphTargets.length;c<e;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];l=d.morphTargets[c].vertices;p=a.morphTargets[c].vertices;j=0;for(k=p.length;j<k;j+=3){var m=new THREE.Vector3;m.x=p[j]*b;m.y=p[j+1]*b;m.z=p[j+2]*b;l.push(m)}}}if(void 0!==a.morphColors){c=0;for(e=
a.morphColors.length;c<e;c++){d.morphColors[c]={};d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];k=d.morphColors[c].colors;l=a.morphColors[c].colors;b=0;for(j=l.length;b<j;b+=3)p=new THREE.Color(16755200),p.setRGB(l[b],l[b+1],l[b+2]),k.push(p)}}})(e);d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};
...
THREE.SceneLoader.prototype.createScene=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:k+"/"+a}function e(){var a;for(m in E.objects)if(!D.objects[m])if(u=E.objects[m],void 0!==u.geometry){if(K=D.geometries[u.geometry])F=D.materials[u.materials[0]],F instanceof THREE.ShaderMaterial&&K.computeTangents(),x=u.position,H=u.rotation,C=u.quaternion,z=u.scale,t=u.matrix,C=0,0==u.materials.length&&(F=new THREE.MeshFaceMaterial),1<u.materials.length&&(F=new THREE.MeshFaceMaterial),a=new THREE.Mesh(K,
F),a.name=m,t?(a.matrixAutoUpdate=!1,a.matrix.set(t[0],t[1],t[2],t[3],t[4],t[5],t[6],t[7],t[8],t[9],t[10],t[11],t[12],t[13],t[14],t[15])):(a.position.set(x[0],x[1],x[2]),C?(a.quaternion.set(C[0],C[1],C[2],C[3]),a.useQuaternion=!0):a.rotation.set(H[0],H[1],H[2]),a.scale.set(z[0],z[1],z[2])),a.visible=u.visible,a.doubleSided=u.doubleSided,a.castShadow=u.castShadow,a.receiveShadow=u.receiveShadow,D.scene.add(a),D.objects[m]=a}else x=u.position,H=u.rotation,C=u.quaternion,z=u.scale,C=0,a=new THREE.Object3D,
a.name=m,a.position.set(x[0],x[1],x[2]),C?(a.quaternion.set(C[0],C[1],C[2],C[3]),a.useQuaternion=!0):a.rotation.set(H[0],H[1],H[2]),a.scale.set(z[0],z[1],z[2]),a.visible=void 0!==u.visible?u.visible:!1,D.scene.add(a),D.objects[m]=a,D.empties[m]=a}function f(a){return function(b){D.geometries[a]=b;e();G-=1;j.onLoadComplete();h()}}function g(a){return function(b){D.geometries[a]=b}}function h(){j.callbackProgress({totalModels:S,totalTextures:T,loadedModels:S-G,loadedTextures:T-i},D);j.onLoadProgress();
0==G&&0==i&&b(D)}var j=this,k=THREE.Loader.prototype.extractUrlBase(c),l,p,m,o,q,n,r,u,t,w,s,x,H,C,z,v,A,K,F,Q,P,E,M,G,i,S,T,D;E=a;c=new THREE.BinaryLoader;M=new THREE.JSONLoader;i=G=0;D={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(E.transform&&(a=E.transform.position,w=E.transform.rotation,v=E.transform.scale,a&&D.scene.position.set(a[0],a[1],a[2]),w&&D.scene.rotation.set(w[0],w[1],w[2]),v&&D.scene.scale.set(v[0],v[1],v[2]),
a||w||v))D.scene.updateMatrix(),D.scene.updateMatrixWorld();a=function(){i-=1;h();j.onLoadComplete()};for(q in E.cameras)v=E.cameras[q],"perspective"==v.type?Q=new THREE.PerspectiveCamera(v.fov,v.aspect,v.near,v.far):"ortho"==v.type&&(Q=new THREE.OrthographicCamera(v.left,v.right,v.top,v.bottom,v.near,v.far)),x=v.position,w=v.target,v=v.up,Q.position.set(x[0],x[1],x[2]),Q.target=new THREE.Vector3(w[0],w[1],w[2]),v&&Q.up.set(v[0],v[1],v[2]),D.cameras[q]=Q;for(o in E.lights)w=E.lights[o],q=void 0!==
...
o.color,P.color.setRGB(v[0],v[1],v[2]),D.fogs[n]=P;D.cameras&&E.defaults.camera&&(D.currentCamera=D.cameras[E.defaults.camera]);D.fogs&&E.defaults.fog&&(D.scene.fog=D.fogs[E.defaults.fog]);v=E.defaults.bgcolor;D.bgColor=new THREE.Color;D.bgColor.setRGB(v[0],v[1],v[2]);D.bgColorAlpha=E.defaults.bgalpha;for(l in E.geometries)if(n=E.geometries[l],"bin_mesh"==n.type||"ascii_mesh"==n.type)G+=1,j.onLoadStart();S=G;for(l in E.geometries)n=E.geometries[l],"cube"==n.type?(K=new THREE.CubeGeometry(n.width,
n.height,n.depth,n.segmentsWidth,n.segmentsHeight,n.segmentsDepth,null,n.flipped,n.sides),D.geometries[l]=K):"plane"==n.type?(K=new THREE.PlaneGeometry(n.width,n.height,n.segmentsWidth,n.segmentsHeight),D.geometries[l]=K):"sphere"==n.type?(K=new THREE.SphereGeometry(n.radius,n.segmentsWidth,n.segmentsHeight),D.geometries[l]=K):"cylinder"==n.type?(K=new THREE.CylinderGeometry(n.topRad,n.botRad,n.height,n.radSegs,n.heightSegs),D.geometries[l]=K):"torus"==n.type?(K=new THREE.TorusGeometry(n.radius,n.tube,
n.segmentsR,n.segmentsT),D.geometries[l]=K):"icosahedron"==n.type?(K=new THREE.IcosahedronGeometry(n.radius,n.subdivisions),D.geometries[l]=K):"bin_mesh"==n.type?c.load(d(n.url,E.urlBaseType),f(l)):"ascii_mesh"==n.type?M.load(d(n.url,E.urlBaseType),f(l)):"embedded_mesh"==n.type&&(n=E.embeds[n.id],n.metadata=E.metadata,n&&M.createModel(n,g(l),""));for(r in E.textures)if(l=E.textures[r],l.url instanceof Array){i+=l.url.length;for(n=0;n<l.url.length;n++)j.onLoadStart()}else i+=1,j.onLoadStart();T=i;
...
a.enableSpecular.value=!0),a.uDiffuseColor.value.setHex(l),a.uSpecularColor.value.setHex(n),a.uAmbientColor.value.setHex(P),a.uShininess.value=c,t.parameters.opacity&&(a.uOpacity.value=t.parameters.opacity),F=new THREE.ShaderMaterial({fragmentShader:r.fragmentShader,vertexShader:r.vertexShader,uniforms:a,lights:!0,fog:!0})):F=new THREE[t.type](t.parameters);D.materials[p]=F}e();j.callbackSync(D);h()};
...
f,g,h,i,j;e=0;for(f=a.length;e<f;e++)g=a[e],h=g.color,g instanceof THREE.DirectionalLight?(i=g.matrixWorld.getPosition(),j=c.dot(i),0>=j||(j*=g.intensity,d.r+=h.r*j,d.g+=h.g*j,d.b+=h.b*j)):g instanceof THREE.PointLight&&(i=g.matrixWorld.getPosition(),j=c.dot(oa.sub(i,b).normalize()),0>=j||(j*=0==g.distance?1:1-Math.min(b.distanceTo(i)/g.distance,1),0!=j&&(j*=g.intensity,d.r+=h.r*j,d.g+=h.g*j,d.b+=h.b*j)))}function r(a,f,g){b(g.opacity);c(g.blending);var h,i,j,l,k,m;g instanceof THREE.ParticleBasicMaterial?
g.map&&(l=g.map.image,k=l.width>>1,m=l.height>>1,g=f.scale.x*o,j=f.scale.y*q,h=g*k,i=j*m,xa.set(a.x-h,a.y-i,a.x+h,a.y+i),Wa.intersects(xa)&&(n.save(),n.translate(a.x,a.y),n.rotate(-f.rotation),n.scale(g,-j),n.translate(-k,-m),n.drawImage(l,0,0),n.restore())):g instanceof THREE.ParticleCanvasMaterial&&(h=f.scale.x*o,i=f.scale.y*q,xa.set(a.x-h,a.y-i,a.x+h,a.y+i),Wa.intersects(xa)&&(d(g.color.getContextStyle()),e(g.color.getContextStyle()),n.save(),n.translate(a.x,a.y),n.rotate(-f.rotation),n.scale(h,
i),g.program(n),n.restore()))}function s(a,e,f,g){b(g.opacity);c(g.blending);n.beginPath();n.moveTo(a.positionScreen.x,a.positionScreen.y);n.lineTo(e.positionScreen.x,e.positionScreen.y);n.closePath();g instanceof THREE.LineBasicMaterial&&(a=g.linewidth,H!=a&&(n.lineWidth=H=a),a=g.linecap,C!=a&&(n.lineCap=C=a),a=g.linejoin,z!=a&&(n.lineJoin=z=a),d(g.color.getContextStyle()),n.stroke(),xa.inflate(2*g.linewidth))}function t(a,d,e,g,h,k,m,n){f.info.render.vertices+=3;f.info.render.faces++;b(n.opacity);
c(n.blending);E=a.positionScreen.x;M=a.positionScreen.y;G=d.positionScreen.x;i=d.positionScreen.y;S=e.positionScreen.x;T=e.positionScreen.y;x(E,M,G,i,S,T);n instanceof THREE.MeshBasicMaterial?n.map?n.map.mapping instanceof THREE.UVMapping&&(Na=m.uvs[0],ad(E,M,G,i,S,T,Na[g].u,Na[g].v,Na[h].u,Na[h].v,Na[k].u,Na[k].v,n.map)):n.envMap?n.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=l.matrixWorldInverse,oa.copy(m.vertexNormalsWorld[g]),Kb=0.5*(oa.x*a.elements[0]+oa.y*a.elements[4]+oa.z*
a.elements[8])+0.5,lb=0.5*-(oa.x*a.elements[1]+oa.y*a.elements[5]+oa.z*a.elements[9])+0.5,oa.copy(m.vertexNormalsWorld[h]),gb=0.5*(oa.x*a.elements[0]+oa.y*a.elements[4]+oa.z*a.elements[8])+0.5,Lb=0.5*-(oa.x*a.elements[1]+oa.y*a.elements[5]+oa.z*a.elements[9])+0.5,oa.copy(m.vertexNormalsWorld[k]),hb=0.5*(oa.x*a.elements[0]+oa.y*a.elements[4]+oa.z*a.elements[8])+0.5,Cb=0.5*-(oa.x*a.elements[1]+oa.y*a.elements[5]+oa.z*a.elements[9])+0.5,ad(E,M,G,i,S,T,Kb,lb,gb,Lb,hb,Cb,n.envMap)):n.wireframe?Mb(n.color,
n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):Eb(n.color):n instanceof THREE.MeshLambertMaterial?$a?!n.wireframe&&n.shading==THREE.SmoothShading&&3==m.vertexNormalsWorld.length?(X.r=Z.r=$.r=aa.r,X.g=Z.g=$.g=aa.g,X.b=Z.b=$.b=aa.b,p(j,m.v1.positionWorld,m.vertexNormalsWorld[0],X),p(j,m.v2.positionWorld,m.vertexNormalsWorld[1],Z),p(j,m.v3.positionWorld,m.vertexNormalsWorld[2],$),X.r=Math.max(0,Math.min(n.color.r*X.r,1)),X.g=Math.max(0,Math.min(n.color.g*X.g,1)),X.b=Math.max(0,Math.min(n.color.b*
X.b,1)),Z.r=Math.max(0,Math.min(n.color.r*Z.r,1)),Z.g=Math.max(0,Math.min(n.color.g*Z.g,1)),Z.b=Math.max(0,Math.min(n.color.b*Z.b,1)),$.r=Math.max(0,Math.min(n.color.r*$.r,1)),$.g=Math.max(0,Math.min(n.color.g*$.g,1)),$.b=Math.max(0,Math.min(n.color.b*$.b,1)),ha.r=0.5*(Z.r+$.r),ha.g=0.5*(Z.g+$.g),ha.b=0.5*(Z.b+$.b),Sa=Cc(X,Z,$,ha),gc(E,M,G,i,S,T,0,0,1,0,0,1,Sa)):(O.r=aa.r,O.g=aa.g,O.b=aa.b,p(j,m.centroidWorld,m.normalWorld,O),O.r=Math.max(0,Math.min(n.color.r*O.r,1)),O.g=Math.max(0,Math.min(n.color.g*
O.g,1)),O.b=Math.max(0,Math.min(n.color.b*O.b,1)),n.wireframe?Mb(O,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):Eb(O)):n.wireframe?Mb(n.color,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):Eb(n.color):n instanceof THREE.MeshDepthMaterial?(Ra=l.near,La=l.far,X.r=X.g=X.b=1-ac(a.positionScreen.z,Ra,La),Z.r=Z.g=Z.b=1-ac(d.positionScreen.z,Ra,La),$.r=$.g=$.b=1-ac(e.positionScreen.z,Ra,La),ha.r=0.5*(Z.r+$.r),ha.g=0.5*(Z.g+$.g),ha.b=0.5*(Z.b+$.b),Sa=Cc(X,Z,$,ha),gc(E,M,G,i,
S,T,0,0,1,0,0,1,Sa)):n instanceof THREE.MeshNormalMaterial&&(O.r=hc(m.normalWorld.x),O.g=hc(m.normalWorld.y),O.b=hc(m.normalWorld.z),n.wireframe?Mb(O,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):Eb(O))}function u(a,d,e,g,h,k,n,m,o){f.info.render.vertices+=4;f.info.render.faces++;b(m.opacity);c(m.blending);m.map||m.envMap?(t(a,d,g,0,1,3,n,m,o),t(h,e,k,1,2,3,n,m,o)):(E=a.positionScreen.x,M=a.positionScreen.y,G=d.positionScreen.x,i=d.positionScreen.y,S=e.positionScreen.x,T=e.positionScreen.y,
D=g.positionScreen.x,Y=g.positionScreen.y,J=h.positionScreen.x,ea=h.positionScreen.y,fa=k.positionScreen.x,ia=k.positionScreen.y,m instanceof THREE.MeshBasicMaterial?(w(E,M,G,i,S,T,D,Y),m.wireframe?Mb(m.color,m.wireframeLinewidth,m.wireframeLinecap,m.wireframeLinejoin):Eb(m.color)):m instanceof THREE.MeshLambertMaterial?$a?!m.wireframe&&m.shading==THREE.SmoothShading&&4==n.vertexNormalsWorld.length?(X.r=Z.r=$.r=ha.r=aa.r,X.g=Z.g=$.g=ha.g=aa.g,X.b=Z.b=$.b=ha.b=aa.b,p(j,n.v1.positionWorld,n.vertexNormalsWorld[0],
X),p(j,n.v2.positionWorld,n.vertexNormalsWorld[1],Z),p(j,n.v4.positionWorld,n.vertexNormalsWorld[3],$),p(j,n.v3.positionWorld,n.vertexNormalsWorld[2],ha),X.r=Math.max(0,Math.min(m.color.r*X.r,1)),X.g=Math.max(0,Math.min(m.color.g*X.g,1)),X.b=Math.max(0,Math.min(m.color.b*X.b,1)),Z.r=Math.max(0,Math.min(m.color.r*Z.r,1)),Z.g=Math.max(0,Math.min(m.color.g*Z.g,1)),Z.b=Math.max(0,Math.min(m.color.b*Z.b,1)),$.r=Math.max(0,Math.min(m.color.r*$.r,1)),$.g=Math.max(0,Math.min(m.color.g*$.g,1)),$.b=Math.max(0,
Math.min(m.color.b*$.b,1)),ha.r=Math.max(0,Math.min(m.color.r*ha.r,1)),ha.g=Math.max(0,Math.min(m.color.g*ha.g,1)),ha.b=Math.max(0,Math.min(m.color.b*ha.b,1)),Sa=Cc(X,Z,$,ha),x(E,M,G,i,D,Y),gc(E,M,G,i,D,Y,0,0,1,0,0,1,Sa),x(J,ea,S,T,fa,ia),gc(J,ea,S,T,fa,ia,1,0,1,1,0,1,Sa)):(O.r=aa.r,O.g=aa.g,O.b=aa.b,p(j,n.centroidWorld,n.normalWorld,O),O.r=Math.max(0,Math.min(m.color.r*O.r,1)),O.g=Math.max(0,Math.min(m.color.g*O.g,1)),O.b=Math.max(0,Math.min(m.color.b*O.b,1)),w(E,M,G,i,S,T,D,Y),m.wireframe?Mb(O,
m.wireframeLinewidth,m.wireframeLinecap,m.wireframeLinejoin):Eb(O)):(w(E,M,G,i,S,T,D,Y),m.wireframe?Mb(m.color,m.wireframeLinewidth,m.wireframeLinecap,m.wireframeLinejoin):Eb(m.color)):m instanceof THREE.MeshNormalMaterial?(O.r=hc(n.normalWorld.x),O.g=hc(n.normalWorld.y),O.b=hc(n.normalWorld.z),w(E,M,G,i,S,T,D,Y),m.wireframe?Mb(O,m.wireframeLinewidth,m.wireframeLinecap,m.wireframeLinejoin):Eb(O)):m instanceof THREE.MeshDepthMaterial&&(Ra=l.near,La=l.far,X.r=X.g=X.b=1-ac(a.positionScreen.z,Ra,La),
Z.r=Z.g=Z.b=1-ac(d.positionScreen.z,Ra,La),$.r=$.g=$.b=1-ac(g.positionScreen.z,Ra,La),ha.r=ha.g=ha.b=1-ac(e.positionScreen.z,Ra,La),Sa=Cc(X,Z,$,ha),x(E,M,G,i,D,Y),gc(E,M,G,i,D,Y,0,0,1,0,0,1,Sa),x(J,ea,S,T,fa,ia),gc(J,ea,S,T,fa,ia,1,0,1,1,0,1,Sa)))}function x(a,b,c,d,e,f){n.beginPath();n.moveTo(a,b);n.lineTo(c,d);n.lineTo(e,f);n.lineTo(a,b);n.closePath()}function w(a,b,c,d,e,f,g,h){n.beginPath();n.moveTo(a,b);n.lineTo(c,d);n.lineTo(e,f);n.lineTo(g,h);n.lineTo(a,b);n.closePath()}function Mb(a,b,c,e){H!=
b&&(n.lineWidth=H=b);C!=c&&(n.lineCap=C=c);z!=e&&(n.lineJoin=z=e);d(a.getContextStyle());n.stroke();xa.inflate(2*b)}function Eb(a){e(a.getContextStyle());n.fill()}function ad(a,b,c,d,f,g,h,i,j,k,l,m,p){if(0!=p.image.width){if(!0==p.needsUpdate||void 0==Ma[p.id]){var o=p.wrapS==THREE.RepeatWrapping,q=p.wrapT==THREE.RepeatWrapping;Ma[p.id]=n.createPattern(p.image,o&&q?"repeat":o&&!q?"repeat-x":!o&&q?"repeat-y":"no-repeat");p.needsUpdate=!1}e(Ma[p.id]);var o=p.offset.x/p.repeat.x,q=p.offset.y/p.repeat.y,
Db=p.image.width*p.repeat.x,r=p.image.height*p.repeat.y,h=(h+o)*Db,i=(i+q)*r,c=c-a,d=d-b,f=f-a,g=g-b,j=(j+o)*Db-h,k=(k+q)*r-i,l=(l+o)*Db-h,m=(m+q)*r-i,o=j*m-l*k;0==o?(void 0===Ka[p.id]&&(b=document.createElement("canvas"),b.width=p.image.width,b.height=p.image.height,b=b.getContext("2d"),b.drawImage(p.image,0,0),Ka[p.id]=b.getImageData(0,0,p.image.width,p.image.height).data),b=Ka[p.id],h=4*(Math.floor(h)+Math.floor(i)*p.image.width),O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),Eb(O)):(o=1/o,p=(m*c-k*
f)*o,k=(m*d-k*g)*o,c=(j*f-l*c)*o,d=(j*g-l*d)*o,a=a-p*h-c*i,h=b-k*h-d*i,n.save(),n.transform(p,k,c,d,a,h),n.fill(),n.restore())}}function gc(a,b,c,d,e,f,g,h,i,j,k,l,m){var p,o;p=m.width-1;o=m.height-1;g*=p;h*=o;c-=a;d-=b;e-=a;f-=b;i=i*p-g;j=j*o-h;k=k*p-g;l=l*o-h;o=1/(i*l-k*j);p=(l*c-j*e)*o;j=(l*d-j*f)*o;c=(i*e-k*c)*o;d=(i*f-k*d)*o;a=a-p*g-c*h;b=b-j*g-d*h;n.save();n.transform(p,j,c,d,a,b);n.clip();n.drawImage(m,0,0);n.restore()}function Cc(a,b,c,d){var e=~~(255*a.r),f=~~(255*a.g),a=~~(255*a.b),g=~~(255*
b.r),h=~~(255*b.g),b=~~(255*b.b),i=~~(255*c.r),j=~~(255*c.g),c=~~(255*c.b),k=~~(255*d.r),l=~~(255*d.g),d=~~(255*d.b);ab[0]=0>e?0:255<e?255:e;ab[1]=0>f?0:255<f?255:f;ab[2]=0>a?0:255<a?255:a;ab[4]=0>g?0:255<g?255:g;ab[5]=0>h?0:255<h?255:h;ab[6]=0>b?0:255<b?255:b;ab[8]=0>i?0:255<i?255:i;ab[9]=0>j?0:255<j?255:j;ab[10]=0>c?0:255<c?255:c;ab[12]=0>k?0:255<k?255:k;ab[13]=0>l?0:255<l?255:l;ab[14]=0>d?0:255<d?255:d;Db.putImageData(Sc,0,0);Bc.drawImage(ib,0,0);return pc}function ac(a,b,c){a=(a-b)/(c-b);return a*
a*(3-2*a)}function hc(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Nb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!=e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}var Dc,bd,Ha,eb;this.autoClear?this.clear():n.setTransform(1,0,0,-1,o,q);f.info.render.vertices=0;f.info.render.faces=0;g=k.projectScene(a,l,this.sortElements);h=g.elements;j=g.lights;($a=0<j.length)&&m(j);Dc=0;for(bd=h.length;Dc<bd;Dc++)Ha=h[Dc],eb=Ha.material,eb=eb instanceof THREE.MeshFaceMaterial?Ha.faceMaterial:eb,void 0===
eb||!1===eb.visible||(xa.empty(),Ha instanceof THREE.RenderableParticle?(v=Ha,v.x*=o,v.y*=q,r(v,Ha,eb,a)):Ha instanceof THREE.RenderableLine?(v=Ha.v1,A=Ha.v2,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=o,A.positionScreen.y*=q,xa.addPoint(v.positionScreen.x,v.positionScreen.y),xa.addPoint(A.positionScreen.x,A.positionScreen.y),Wa.intersects(xa)&&s(v,A,Ha,eb,a)):Ha instanceof THREE.RenderableFace3?(v=Ha.v1,A=Ha.v2,K=Ha.v3,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=
o,A.positionScreen.y*=q,K.positionScreen.x*=o,K.positionScreen.y*=q,eb.overdraw&&(Nb(v.positionScreen,A.positionScreen),Nb(A.positionScreen,K.positionScreen),Nb(K.positionScreen,v.positionScreen)),xa.add3Points(v.positionScreen.x,v.positionScreen.y,A.positionScreen.x,A.positionScreen.y,K.positionScreen.x,K.positionScreen.y),Wa.intersects(xa)&&t(v,A,K,0,1,2,Ha,eb,a)):Ha instanceof THREE.RenderableFace4&&(v=Ha.v1,A=Ha.v2,K=Ha.v3,F=Ha.v4,v.positionScreen.x*=o,v.positionScreen.y*=q,A.positionScreen.x*=
o,A.positionScreen.y*=q,K.positionScreen.x*=o,K.positionScreen.y*=q,F.positionScreen.x*=o,F.positionScreen.y*=q,Q.positionScreen.copy(A.positionScreen),P.positionScreen.copy(F.positionScreen),eb.overdraw&&(Nb(v.positionScreen,A.positionScreen),Nb(A.positionScreen,F.positionScreen),Nb(F.positionScreen,v.positionScreen),Nb(K.positionScreen,Q.positionScreen),Nb(K.positionScreen,P.positionScreen)),xa.addPoint(v.positionScreen.x,v.positionScreen.y),xa.addPoint(A.positionScreen.x,A.positionScreen.y),xa.addPoint(K.positionScreen.x,
K.positionScreen.y),xa.addPoint(F.positionScreen.x,F.positionScreen.y),Wa.intersects(xa)&&u(v,A,K,F,Q,P,Ha,eb,a)),Ba.addRectangle(xa));n.setTransform(1,0,0,1,0,0)}};
...
"path"),0==E&&A[a].setAttribute("shape-rendering","crispEdges"));return A[a]}function c(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}console.log("THREE.SVGRenderer",THREE.REVISION);var d=this,e,f,g,h=new THREE.Projector,j=document.createElementNS("http://www.w3.org/2000/svg","svg"),k,l,p,m,o,q,n,r,u=new THREE.Rectangle,t=new THREE.Rectangle,w=!1,s=new THREE.Color,x=new THREE.Color,H=new THREE.Color,C=new THREE.Color,z,v=new THREE.Vector3,A=[],K=[],F,Q,P,E=1;this.domElement=j;this.sortElements=this.sortObjects=
this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setQuality=function(a){switch(a){case "high":E=1;break;case "low":E=0}};this.setSize=function(a,b){k=a;l=b;p=k/2;m=l/2;j.setAttribute("viewBox",-p+" "+-m+" "+k+" "+l);j.setAttribute("width",k);j.setAttribute("height",l);u.set(-p,-m,p,m)};this.clear=function(){for(;0<j.childNodes.length;)j.removeChild(j.childNodes[0])};this.render=function(k,l){var i,v,A,D;this.autoClear&&this.clear();d.info.render.vertices=0;d.info.render.faces=0;e=h.projectScene(k,
l,this.sortElements);f=e.elements;g=e.lights;P=Q=0;if(w=0<g.length){x.setRGB(0,0,0);H.setRGB(0,0,0);C.setRGB(0,0,0);i=0;for(v=g.length;i<v;i++)D=g[i],A=D.color,D instanceof THREE.AmbientLight?(x.r+=A.r,x.g+=A.g,x.b+=A.b):D instanceof THREE.DirectionalLight?(H.r+=A.r,H.g+=A.g,H.b+=A.b):D instanceof THREE.PointLight&&(C.r+=A.r,C.g+=A.g,C.b+=A.b)}i=0;for(v=f.length;i<v;i++)if(A=f[i],D=A.material,D=D instanceof THREE.MeshFaceMaterial?A.faceMaterial:D,!(void 0===D||!1===D.visible))if(t.empty(),A instanceof
THREE.RenderableParticle)o=A,o.x*=p,o.y*=-m;else if(A instanceof THREE.RenderableLine){if(o=A.v1,q=A.v2,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=p,q.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),u.intersects(t)){A=o;var Y=q,J=P++;null==K[J]&&(K[J]=document.createElementNS("http://www.w3.org/2000/svg","line"),0==E&&K[J].setAttribute("shape-rendering","crispEdges"));F=K[J];F.setAttribute("x1",A.positionScreen.x);
F.setAttribute("y1",A.positionScreen.y);F.setAttribute("x2",Y.positionScreen.x);F.setAttribute("y2",Y.positionScreen.y);D instanceof THREE.LineBasicMaterial&&(F.setAttribute("style","fill: none; stroke: "+D.color.getContextStyle()+"; stroke-width: "+D.linewidth+"; stroke-opacity: "+D.opacity+"; stroke-linecap: "+D.linecap+"; stroke-linejoin: "+D.linejoin),j.appendChild(F))}}else if(A instanceof THREE.RenderableFace3){if(o=A.v1,q=A.v2,n=A.v3,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=
p,q.positionScreen.y*=-m,n.positionScreen.x*=p,n.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),t.addPoint(n.positionScreen.x,n.positionScreen.y),u.intersects(t)){var Y=o,J=q,ea=n;d.info.render.vertices+=3;d.info.render.faces++;F=b(Q++);F.setAttribute("d","M "+Y.positionScreen.x+" "+Y.positionScreen.y+" L "+J.positionScreen.x+" "+J.positionScreen.y+" L "+ea.positionScreen.x+","+ea.positionScreen.y+"z");D instanceof THREE.MeshBasicMaterial?
s.copy(D.color):D instanceof THREE.MeshLambertMaterial?w?(s.r=x.r,s.g=x.g,s.b=x.b,a(g,A.centroidWorld,A.normalWorld,s),s.r=Math.max(0,Math.min(D.color.r*s.r,1)),s.g=Math.max(0,Math.min(D.color.g*s.g,1)),s.b=Math.max(0,Math.min(D.color.b*s.b,1))):s.copy(D.color):D instanceof THREE.MeshDepthMaterial?(z=1-D.__2near/(D.__farPlusNear-A.z*D.__farMinusNear),s.setRGB(z,z,z)):D instanceof THREE.MeshNormalMaterial&&s.setRGB(c(A.normalWorld.x),c(A.normalWorld.y),c(A.normalWorld.z));D.wireframe?F.setAttribute("style",
"fill: none; stroke: "+s.getContextStyle()+"; stroke-width: "+D.wireframeLinewidth+"; stroke-opacity: "+D.opacity+"; stroke-linecap: "+D.wireframeLinecap+"; stroke-linejoin: "+D.wireframeLinejoin):F.setAttribute("style","fill: "+s.getContextStyle()+"; fill-opacity: "+D.opacity);j.appendChild(F)}}else if(A instanceof THREE.RenderableFace4&&(o=A.v1,q=A.v2,n=A.v3,r=A.v4,o.positionScreen.x*=p,o.positionScreen.y*=-m,q.positionScreen.x*=p,q.positionScreen.y*=-m,n.positionScreen.x*=p,n.positionScreen.y*=
-m,r.positionScreen.x*=p,r.positionScreen.y*=-m,t.addPoint(o.positionScreen.x,o.positionScreen.y),t.addPoint(q.positionScreen.x,q.positionScreen.y),t.addPoint(n.positionScreen.x,n.positionScreen.y),t.addPoint(r.positionScreen.x,r.positionScreen.y),u.intersects(t))){var Y=o,J=q,ea=n,fa=r;d.info.render.vertices+=4;d.info.render.faces++;F=b(Q++);F.setAttribute("d","M "+Y.positionScreen.x+" "+Y.positionScreen.y+" L "+J.positionScreen.x+" "+J.positionScreen.y+" L "+ea.positionScreen.x+","+ea.positionScreen.y+
" L "+fa.positionScreen.x+","+fa.positionScreen.y+"z");D instanceof THREE.MeshBasicMaterial?s.copy(D.color):D instanceof THREE.MeshLambertMaterial?w?(s.r=x.r,s.g=x.g,s.b=x.b,a(g,A.centroidWorld,A.normalWorld,s),s.r=Math.max(0,Math.min(D.color.r*s.r,1)),s.g=Math.max(0,Math.min(D.color.g*s.g,1)),s.b=Math.max(0,Math.min(D.color.b*s.b,1))):s.copy(D.color):D instanceof THREE.MeshDepthMaterial?(z=1-D.__2near/(D.__farPlusNear-A.z*D.__farMinusNear),s.setRGB(z,z,z)):D instanceof THREE.MeshNormalMaterial&&
s.setRGB(c(A.normalWorld.x),c(A.normalWorld.y),c(A.normalWorld.z));D.wireframe?F.setAttribute("style","fill: none; stroke: "+s.getContextStyle()+"; stroke-width: "+D.wireframeLinewidth+"; stroke-opacity: "+D.opacity+"; stroke-linecap: "+D.wireframeLinecap+"; stroke-linejoin: "+D.wireframeLinejoin):F.setAttribute("style","fill: "+s.getContextStyle()+"; fill-opacity: "+D.opacity);j.appendChild(F)}}};
...
var j=a.colors,k=j.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,p=a.verticesNeedUpdate,o=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){xa.copy(Ba);xa.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],$a.copy(e),xa.multiplyVector3($a),n[d]=[$a.z,d];n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[n[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<k;d++)f=3*d,e=j[n[d][1]],m[f]=e.r,m[f+1]=e.g,m[f+2]=e.b;if(q){j=0;for(k=q.length;j<k;j++)if(h=q[j],
...
h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,h.array[f+3]=g.w,f+=4}}else{if(p)for(d=0;d<g;d++)e=h[d],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;if(o)for(d=0;d<k;d++)e=j[d],f=3*d,m[f]=e.r,m[f+1]=e.g,m[f+2]=e.b;if(q){j=0;for(k=q.length;j<k;j++)if(h=q[j],h.needsUpdate&&(void 0===h.boundTo||"vertices"===h.boundTo))if(e=h.value.length,f=0,1===h.size)for(d=0;d<e;d++)h.array[d]=h.value[d];else if(2===h.size)for(d=0;d<e;d++)g=h.value[d],h.array[f]=g.x,h.array[f+1]=g.y,f+=2;else if(3===h.size)if("c"===h.type)for(d=
0;d<e;d++)g=h.value[d],h.array[f]=g.r,h.array[f+1]=g.g,h.array[f+2]=g.b,f+=3;else for(d=0;d<e;d++)g=h.value[d],h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,f+=3;else if(4===h.size)for(d=0;d<e;d++)g=h.value[d],h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,h.array[f+3]=g.w,f+=4}}if(p||c.sortParticles)i.bindBuffer(i.ARRAY_BUFFER,a.__webglVertexBuffer),i.bufferData(i.ARRAY_BUFFER,l,b);if(o||c.sortParticles)i.bindBuffer(i.ARRAY_BUFFER,a.__webglColorBuffer),i.bufferData(i.ARRAY_BUFFER,m,b);if(q){j=
0;for(k=q.length;j<k;j++)if(h=q[j],h.needsUpdate||c.sortParticles)i.bindBuffer(i.ARRAY_BUFFER,h.buffer),i.bufferData(i.ARRAY_BUFFER,h.array,b)}}function g(a,b){return b.z-a.z}function h(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++)ea=T=null,Y=J=O=ia=Ka=Ma=X=-1,Ta=!0,a[d].render(b,c,hb,Cb),ea=T=null,Y=J=O=ia=Ka=Ma=X=-1,Ta=!0}function j(a,b,c,d,e,f,g,h){var i,j,k,l;b?(j=a.length-1,l=b=-1):(j=0,b=a.length,l=1);for(var m=j;m!==b;m+=l)if(i=a[m],i.render){j=i.object;k=i.buffer;if(h)i=h;else{i=i[c];
...
a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function n(a,b,c,d,e){if(!d.program||d.needsUpdate)G.initMaterial(d,b,c,e),d.needsUpdate=!1;if(d.morphTargets&&!e.__webglMorphTargetInfluences){e.__webglMorphTargetInfluences=new Float32Array(G.maxMorphTargets);for(var f=0,g=G.maxMorphTargets;f<g;f++)e.__webglMorphTargetInfluences[f]=0}var h=!1,f=d.program,g=f.uniforms,j=d.uniforms;f!==T&&(i.useProgram(f),T=f,h=!0);d.id!==Y&&(Y=d.id,h=!0);if(h||a!==ea)i.uniformMatrix4fv(g.projectionMatrix,!1,a._projectionMatrixArray),
...
F=r.spot.exponents,K=0,X=0,M=0,O=0,c=0,h=b.length;c<h;c++)k=b[c],k.onlyShadow||(p=k.color,o=k.intensity,q=k.distance,k instanceof THREE.AmbientLight?G.gammaInput?(l+=p.r*p.r,m+=p.g*p.g,n+=p.b*p.b):(l+=p.r,m+=p.g,n+=p.b):k instanceof THREE.DirectionalLight?(q=3*K,G.gammaInput?(s[q]=p.r*p.r*o*o,s[q+1]=p.g*p.g*o*o,s[q+2]=p.b*p.b*o*o):(s[q]=p.r*o,s[q+1]=p.g*o,s[q+2]=p.b*o),aa.copy(k.matrixWorld.getPosition()),aa.subSelf(k.target.matrixWorld.getPosition()),aa.normalize(),t[q]=aa.x,t[q+1]=aa.y,t[q+2]=aa.z,
K+=1):k instanceof THREE.PointLight?(O=3*X,G.gammaInput?(u[O]=p.r*p.r*o*o,u[O+1]=p.g*p.g*o*o,u[O+2]=p.b*p.b*o*o):(u[O]=p.r*o,u[O+1]=p.g*o,u[O+2]=p.b*o),p=k.matrixWorld.getPosition(),v[O]=p.x,v[O+1]=p.y,v[O+2]=p.z,x[X]=q,X+=1):k instanceof THREE.SpotLight&&(O=3*M,G.gammaInput?(z[O]=p.r*p.r*o*o,z[O+1]=p.g*p.g*o*o,z[O+2]=p.b*p.b*o*o):(z[O]=p.r*o,z[O+1]=p.g*o,z[O+2]=p.b*o),p=k.matrixWorld.getPosition(),A[O]=p.x,A[O+1]=p.y,A[O+2]=p.z,E[M]=q,aa.copy(p),aa.subSelf(k.target.matrixWorld.getPosition()),aa.normalize(),
D[O]=aa.x,D[O+1]=aa.y,D[O+2]=aa.z,J[M]=Math.cos(k.angle),F[M]=k.exponent,M+=1));c=3*K;for(h=s.length;c<h;c++)s[c]=0;c=3*X;for(h=u.length;c<h;c++)u[c]=0;c=3*M;for(h=z.length;c<h;c++)z[c]=0;r.directional.length=K;r.point.length=X;r.spot.length=M;r.ambient[0]=l;r.ambient[1]=m;r.ambient[2]=n;Ta=!1}c=Qa;j.ambientLightColor.value=c.ambient;j.directionalLightColor.value=c.directional.colors;j.directionalLightDirection.value=c.directional.positions;j.pointLightColor.value=c.point.colors;j.pointLightPosition.value=
c.point.positions;j.pointLightDistance.value=c.point.distances;j.spotLightColor.value=c.spot.colors;j.spotLightPosition.value=c.spot.positions;j.spotLightDistance.value=c.spot.distances;j.spotLightDirection.value=c.spot.directions;j.spotLightAngle.value=c.spot.angles;j.spotLightExponent.value=c.spot.exponents}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial)j.opacity.value=d.opacity,G.gammaInput?j.diffuse.value.copyGammaToLinear(d.color):
...
c=0;for(k=b.length;h<k;h++)if(l=b[h],l.castShadow&&(l instanceof THREE.SpotLight||l instanceof THREE.DirectionalLight&&!l.shadowCascade))j.shadowMap.texture[c]=l.shadowMap,j.shadowMapSize.value[c]=l.shadowMapSize,j.shadowMatrix.value[c]=l.shadowMatrix,j.shadowDarkness.value[c]=l.shadowDarkness,j.shadowBias.value[c]=l.shadowBias,c++}b=d.uniformsList;j=0;for(c=b.length;j<c;j++)if(l=f.uniforms[b[j][1]])switch(h=b[j][0],m=h.type,k=h.value,m){case "i":i.uniform1i(l,k);break;case "f":i.uniform1f(l,k);break;
case "v2":i.uniform2f(l,k.x,k.y);break;case "v3":i.uniform3f(l,k.x,k.y,k.z);break;case "v4":i.uniform4f(l,k.x,k.y,k.z,k.w);break;case "c":i.uniform3f(l,k.r,k.g,k.b);break;case "fv1":i.uniform1fv(l,k);break;case "fv":i.uniform3fv(l,k);break;case "v2v":h._array||(h._array=new Float32Array(2*k.length));m=0;for(n=k.length;m<n;m++)r=2*m,h._array[r]=k[m].x,h._array[r+1]=k[m].y;i.uniform2fv(l,h._array);break;case "v3v":h._array||(h._array=new Float32Array(3*k.length));m=0;for(n=k.length;m<n;m++)r=3*m,h._array[r]=
k[m].x,h._array[r+1]=k[m].y,h._array[r+2]=k[m].z;i.uniform3fv(l,h._array);break;case "v4v":h._array||(h._array=new Float32Array(4*k.length));m=0;for(n=k.length;m<n;m++)r=4*m,h._array[r]=k[m].x,h._array[r+1]=k[m].y,h._array[r+2]=k[m].z,h._array[r+3]=k[m].w;i.uniform4fv(l,h._array);break;case "m4":h._array||(h._array=new Float32Array(16));k.flattenToArray(h._array);i.uniformMatrix4fv(l,!1,h._array);break;case "m4v":h._array||(h._array=new Float32Array(16*k.length));m=0;for(n=k.length;m<n;m++)k[m].flattenToArrayOffset(h._array,
16*m);i.uniformMatrix4fv(l,!1,h._array);break;case "t":i.uniform1i(l,k);l=h.texture;if(!l)continue;if(l.image instanceof Array&&6===l.image.length){if(h=l,6===h.image.length)if(h.needsUpdate){h.image.__webglTextureCube||(h.image.__webglTextureCube=i.createTexture());i.activeTexture(i.TEXTURE0+k);i.bindTexture(i.TEXTURE_CUBE_MAP,h.image.__webglTextureCube);k=[];for(l=0;6>l;l++)m=k,n=l,G.autoScaleCubemaps?(r=h.image[l],t=ib,r.width<=t&&r.height<=t||(u=Math.max(r.width,r.height),s=Math.floor(r.width*
t/u),t=Math.floor(r.height*t/u),u=document.createElement("canvas"),u.width=s,u.height=t,u.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,s,t),r=u)):r=h.image[l],m[n]=r;l=k[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);n=H(h.format);r=H(h.type);w(i.TEXTURE_CUBE_MAP,h,m);for(l=0;6>l;l++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,n,n,r,k[l]);h.generateMipmaps&&m&&i.generateMipmap(i.TEXTURE_CUBE_MAP);h.needsUpdate=!1;if(h.onUpdate)h.onUpdate()}else i.activeTexture(i.TEXTURE0+k),i.bindTexture(i.TEXTURE_CUBE_MAP,
h.image.__webglTextureCube)}else l instanceof THREE.WebGLRenderTargetCube?(h=l,i.activeTexture(i.TEXTURE0+k),i.bindTexture(i.TEXTURE_CUBE_MAP,h.__webglTexture)):G.setTexture(l,k);break;case "tv":if(!h._array){h._array=[];m=0;for(n=h.texture.length;m<n;m++)h._array[m]=k+m}i.uniform1iv(l,h._array);m=0;for(n=h.texture.length;m<n;m++)(l=h.texture[m])&&G.setTexture(l,h._array[m])}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==g.cameraPosition)b=a.matrixWorld.getPosition(),
i.uniform3f(g.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&null!==g.viewMatrix&&i.uniformMatrix4fv(g.viewMatrix,!1,a._viewMatrixArray);d.skinning&&i.uniformMatrix4fv(g.boneGlobalMatrices,!1,e.boneMatrices)}i.uniformMatrix4fv(g.modelViewMatrix,!1,e._modelViewMatrix.elements);g.normalMatrix&&i.uniformMatrix3fv(g.normalMatrix,!1,e._normalMatrix.elements);null!==g.objectMatrix&&i.uniformMatrix4fv(g.objectMatrix,
!1,e.matrixWorld.elements);return f}function r(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function u(a,b,c){Ra!==a&&(a?i.enable(i.POLYGON_OFFSET_FILL):i.disable(i.POLYGON_OFFSET_FILL),Ra=a);if(a&&(La!==b||Sa!==c))i.polygonOffset(b,c),La=b,Sa=c}function t(a,b){var c;"fragment"===a?c=i.createShader(i.FRAGMENT_SHADER):"vertex"===a&&(c=i.createShader(i.VERTEX_SHADER));i.shaderSource(c,b);i.compileShader(c);
return!i.getShaderParameter(c,i.COMPILE_STATUS)?(console.error(i.getShaderInfoLog(c)),console.error(b),null):c}function w(a,b,c){c?(i.texParameteri(a,i.TEXTURE_WRAP_S,H(b.wrapS)),i.texParameteri(a,i.TEXTURE_WRAP_T,H(b.wrapT)),i.texParameteri(a,i.TEXTURE_MAG_FILTER,H(b.magFilter)),i.texParameteri(a,i.TEXTURE_MIN_FILTER,H(b.minFilter))):(i.texParameteri(a,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(a,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),i.texParameteri(a,i.TEXTURE_MAG_FILTER,x(b.magFilter)),i.texParameteri(a,
i.TEXTURE_MIN_FILTER,x(b.minFilter)))}function s(a,b){i.bindRenderbuffer(i.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?(i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_COMPONENT16,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,a)):b.depthBuffer&&b.stencilBuffer?(i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,a)):i.renderbufferStorage(i.RENDERBUFFER,
...
z=void 0!==a.precision?a.precision:"highp",v=void 0!==a.alpha?a.alpha:!0,A=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,K=void 0!==a.antialias?a.antialias:!1,F=void 0!==a.stencil?a.stencil:!0,Q=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,P=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),E=void 0!==a.clearAlpha?a.clearAlpha:0,M=void 0!==a.maxLights?a.maxLights:4;this.domElement=C;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=
...
!1,"",b,n,p,!0,d),k(a.__webglObjectsImmediate,"",b,n,p,!1,d)):(this.setBlending(THREE.NormalBlending),j(a.__webglObjects,!0,"opaque",b,n,p,!1),k(a.__webglObjectsImmediate,"opaque",b,n,p,!1),j(a.__webglObjects,!1,"transparent",b,n,p,!0),k(a.__webglObjectsImmediate,"transparent",b,n,p,!0));h(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)&&(c instanceof THREE.WebGLRenderTargetCube?(i.bindTexture(i.TEXTURE_CUBE_MAP,c.__webglTexture),
i.generateMipmap(i.TEXTURE_CUBE_MAP),i.bindTexture(i.TEXTURE_CUBE_MAP,null)):(i.bindTexture(i.TEXTURE_2D,c.__webglTexture),i.generateMipmap(i.TEXTURE_2D),i.bindTexture(i.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)};this.renderImmediateObject=function(a,b,c,d,e){var f=n(a,b,c,d,e);J=-1;G.setObjectFaces(e);e.immediateRenderCallback?e.immediateRenderCallback(f,i,Wa):e.render(function(a){G.renderBufferImmediate(a,f,d.shading)})};this.initWebGLObjects=function(a){a.__webglObjects||
(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var g=a.__objectsAdded[0],h=a,j=void 0,k=void 0,n=void 0;if(!g.__webglInit)if(g.__webglInit=!0,g._modelViewMatrix=new THREE.Matrix4,g._normalMatrix=new THREE.Matrix3,g instanceof THREE.Mesh){if(k=g.geometry,k instanceof THREE.Geometry){if(void 0===k.geometryGroups){var r=k,s=void 0,t=void 0,u=void 0,v=void 0,x=void 0,w=void 0,z=void 0,A={},D=r.morphTargets.length,E=r.morphNormals.length;
...
vertices:0,numMorphTargets:D,numMorphNormals:E})),u instanceof THREE.Face3?r.geometryGroups[z].faces3.push(s):r.geometryGroups[z].faces4.push(s),r.geometryGroups[z].vertices+=x;r.geometryGroupsList=[];var J=void 0;for(J in r.geometryGroups)r.geometryGroups[J].id=fa++,r.geometryGroupsList.push(r.geometryGroups[J])}for(j in k.geometryGroups)if(n=k.geometryGroups[j],!n.__webglVertexBuffer){var C=n;C.__webglVertexBuffer=i.createBuffer();C.__webglNormalBuffer=i.createBuffer();C.__webglTangentBuffer=i.createBuffer();
C.__webglColorBuffer=i.createBuffer();C.__webglUVBuffer=i.createBuffer();C.__webglUV2Buffer=i.createBuffer();C.__webglSkinVertexABuffer=i.createBuffer();C.__webglSkinVertexBBuffer=i.createBuffer();C.__webglSkinIndicesBuffer=i.createBuffer();C.__webglSkinWeightsBuffer=i.createBuffer();C.__webglFaceBuffer=i.createBuffer();C.__webglLineBuffer=i.createBuffer();var H=void 0,K=void 0;if(C.numMorphTargets){C.__webglMorphTargetsBuffers=[];H=0;for(K=C.numMorphTargets;H<K;H++)C.__webglMorphTargetsBuffers.push(i.createBuffer())}if(C.numMorphNormals){C.__webglMorphNormalsBuffers=
[];H=0;for(K=C.numMorphNormals;H<K;H++)C.__webglMorphNormalsBuffers.push(i.createBuffer())}G.info.memory.geometries++;var F=n,X=g,O=X.geometry,M=F.faces3,$=F.faces4,P=3*M.length+4*$.length,Z=1*M.length+2*$.length,Y=3*M.length+4*$.length,Q=c(X,F),S=e(Q),ea=d(Q),ia=Q.vertexColors?Q.vertexColors:!1;F.__vertexArray=new Float32Array(3*P);ea&&(F.__normalArray=new Float32Array(3*P));O.hasTangents&&(F.__tangentArray=new Float32Array(4*P));ia&&(F.__colorArray=new Float32Array(3*P));if(S){if(0<O.faceUvs.length||
0<O.faceVertexUvs.length)F.__uvArray=new Float32Array(2*P);if(1<O.faceUvs.length||1<O.faceVertexUvs.length)F.__uv2Array=new Float32Array(2*P)}X.geometry.skinWeights.length&&X.geometry.skinIndices.length&&(F.__skinVertexAArray=new Float32Array(4*P),F.__skinVertexBArray=new Float32Array(4*P),F.__skinIndexArray=new Float32Array(4*P),F.__skinWeightArray=new Float32Array(4*P));F.__faceArray=new Uint16Array(3*Z);F.__lineArray=new Uint16Array(2*Y);var T=void 0,ha=void 0;if(F.numMorphTargets){F.__morphTargetsArrays=
[];T=0;for(ha=F.numMorphTargets;T<ha;T++)F.__morphTargetsArrays.push(new Float32Array(3*P))}if(F.numMorphNormals){F.__morphNormalsArrays=[];T=0;for(ha=F.numMorphNormals;T<ha;T++)F.__morphNormalsArrays.push(new Float32Array(3*P))}F.__webglFaceCount=3*Z;F.__webglLineCount=2*Y;if(Q.attributes){void 0===F.__webglCustomAttributesList&&(F.__webglCustomAttributesList=[]);var Ra=void 0;for(Ra in Q.attributes){var Ma=Q.attributes[Ra],aa={},Ka;for(Ka in Ma)aa[Ka]=Ma[Ka];if(!aa.__webglInitialized||aa.createUniqueBuffers){aa.__webglInitialized=
!0;var La=1;"v2"===aa.type?La=2:"v3"===aa.type?La=3:"v4"===aa.type?La=4:"c"===aa.type&&(La=3);aa.size=La;aa.array=new Float32Array(P*La);aa.buffer=i.createBuffer();aa.buffer.belongsToAttribute=Ra;Ma.needsUpdate=!0;aa.__original=Ma}F.__webglCustomAttributesList.push(aa)}}F.__inittedArrays=!0;k.verticesNeedUpdate=!0;k.morphTargetsNeedUpdate=!0;k.elementsNeedUpdate=!0;k.uvsNeedUpdate=!0;k.normalsNeedUpdate=!0;k.tangetsNeedUpdate=!0;k.colorsNeedUpdate=!0}}}else if(g instanceof THREE.Ribbon){if(k=g.geometry,
!k.__webglVertexBuffer){var Sa=k;Sa.__webglVertexBuffer=i.createBuffer();Sa.__webglColorBuffer=i.createBuffer();G.info.memory.geometries++;var oa=k,xa=oa.vertices.length;oa.__vertexArray=new Float32Array(3*xa);oa.__colorArray=new Float32Array(3*xa);oa.__webglVertexCount=xa;k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0}}else if(g instanceof THREE.Line){if(k=g.geometry,!k.__webglVertexBuffer){var Ba=k;Ba.__webglVertexBuffer=i.createBuffer();Ba.__webglColorBuffer=i.createBuffer();G.info.memory.geometries++;
var Na=k,Ta=g,Wa=Na.vertices.length;Na.__vertexArray=new Float32Array(3*Wa);Na.__colorArray=new Float32Array(3*Wa);Na.__webglLineCount=Wa;b(Na,Ta);k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0}}else if(g instanceof THREE.ParticleSystem&&(k=g.geometry,!k.__webglVertexBuffer)){var $a=k;$a.__webglVertexBuffer=i.createBuffer();$a.__webglColorBuffer=i.createBuffer();G.info.geometries++;var Qa=k,Kb=g,lb=Qa.vertices.length;Qa.__vertexArray=new Float32Array(3*lb);Qa.__colorArray=new Float32Array(3*lb);Qa.__sortArray=
[];Qa.__webglParticleCount=lb;b(Qa,Kb);k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0}if(!g.__webglActive){if(g instanceof THREE.Mesh)if(k=g.geometry,k instanceof THREE.BufferGeometry)l(h.__webglObjects,k,g);else for(j in k.geometryGroups)n=k.geometryGroups[j],l(h.__webglObjects,n,g);else g instanceof THREE.Ribbon||g instanceof THREE.Line||g instanceof THREE.ParticleSystem?(k=g.geometry,l(h.__webglObjects,k,g)):g instanceof THREE.ImmediateRenderObject||g.immediateRenderCallback?h.__webglObjectsImmediate.push({object:g,
...
nd;Cb++)if(hb=ga.geometryGroupsList[Cb],Ua=c(jb,hb),ic=Ua.attributes&&p(Ua),ga.verticesNeedUpdate||ga.morphTargetsNeedUpdate||ga.elementsNeedUpdate||ga.uvsNeedUpdate||ga.normalsNeedUpdate||ga.colorsNeedUpdate||ga.tangetsNeedUpdate||ic){var ca=hb,od=jb,Xa=i.DYNAMIC_DRAW,pd=!ga.dynamic,bc=Ua;if(ca.__inittedArrays){var cd=d(bc),Tc=bc.vertexColors?bc.vertexColors:!1,dd=e(bc),Ec=cd===THREE.SmoothShading,I=void 0,R=void 0,fb=void 0,N=void 0,jc=void 0,Ob=void 0,kb=void 0,Fc=void 0,Fb=void 0,kc=void 0,lc=
...
cc[N.d],Fa[Aa]=U.x,Fa[Aa+1]=U.y,Fa[Aa+2]=U.z,Fa[Aa+3]=V.x,Fa[Aa+4]=V.y,Fa[Aa+5]=V.z,Fa[Aa+6]=W.x,Fa[Aa+7]=W.y,Fa[Aa+8]=W.z,Fa[Aa+9]=ma.x,Fa[Aa+10]=ma.y,Fa[Aa+11]=ma.z,Aa+=12;i.bindBuffer(i.ARRAY_BUFFER,ca.__webglVertexBuffer);i.bufferData(i.ARRAY_BUFFER,Fa,Xa)}if(ud){Ea=0;for(fd=Yb.length;Ea<fd;Ea++){I=ba=0;for(R=ka.length;I<R;I++)Wb=ka[I],N=za[Wb],U=Yb[Ea].vertices[N.a],V=Yb[Ea].vertices[N.b],W=Yb[Ea].vertices[N.c],Ca=Uc[Ea],Ca[ba]=U.x,Ca[ba+1]=U.y,Ca[ba+2]=U.z,Ca[ba+3]=V.x,Ca[ba+4]=V.y,Ca[ba+5]=
...
Ca[ba+5]=V.z,Ca[ba+6]=W.x,Ca[ba+7]=W.y,Ca[ba+8]=W.z,Ca[ba+9]=ma.x,Ca[ba+10]=ma.y,Ca[ba+11]=ma.z,bc.morphNormals&&(Ec?(Gb=Ic[Ea].vertexNormals[Wb],pb=Gb.a,qb=Gb.b,rb=Gb.c,rc=Gb.d):rc=rb=qb=pb=Ic[Ea].faceNormals[Wb],Da=Vc[Ea],Da[ba]=pb.x,Da[ba+1]=pb.y,Da[ba+2]=pb.z,Da[ba+3]=qb.x,Da[ba+4]=qb.y,Da[ba+5]=qb.z,Da[ba+6]=rb.x,Da[ba+7]=rb.y,Da[ba+8]=rb.z,Da[ba+9]=rc.x,Da[ba+10]=rc.y,Da[ba+11]=rc.z),ba+=12;i.bindBuffer(i.ARRAY_BUFFER,ca.__webglMorphTargetsBuffers[Ea]);i.bufferData(i.ARRAY_BUFFER,Uc[Ea],Xa);
bc.morphNormals&&(i.bindBuffer(i.ARRAY_BUFFER,ca.__webglMorphNormalsBuffers[Ea]),i.bufferData(i.ARRAY_BUFFER,Vc[Ea],Xa))}}if(Xb.length){I=0;for(R=ka.length;I<R;I++)N=za[ka[I]],vb=Xb[N.a],wb=Xb[N.b],xb=Xb[N.c],ua[L]=vb.x,ua[L+1]=vb.y,ua[L+2]=vb.z,ua[L+3]=vb.w,ua[L+4]=wb.x,ua[L+5]=wb.y,ua[L+6]=wb.z,ua[L+7]=wb.w,ua[L+8]=xb.x,ua[L+9]=xb.y,ua[L+10]=xb.z,ua[L+11]=xb.w,yb=fc[N.a],zb=fc[N.b],Ab=fc[N.c],ta[L]=yb.x,ta[L+1]=yb.y,ta[L+2]=yb.z,ta[L+3]=yb.w,ta[L+4]=zb.x,ta[L+5]=zb.y,ta[L+6]=zb.z,ta[L+7]=zb.w,ta[L+
...
8]=ob.x,qa[na+9]=ob.y,qa[na+10]=ob.z,qa[na+11]=ob.w,qa[na+12]=qc.x,qa[na+13]=qc.y,qa[na+14]=qc.z,qa[na+15]=qc.w,na+=16;i.bindBuffer(i.ARRAY_BUFFER,ca.__webglTangentBuffer);i.bufferData(i.ARRAY_BUFFER,qa,Xa)}if(rd&&cd){I=0;for(R=ka.length;I<R;I++)if(N=za[ka[I]],jc=N.vertexNormals,Ob=N.normal,3===jc.length&&Ec)for(ja=0;3>ja;ja++)Vb=jc[ja],db[Ja]=Vb.x,db[Ja+1]=Vb.y,db[Ja+2]=Vb.z,Ja+=3;else for(ja=0;3>ja;ja++)db[Ja]=Ob.x,db[Ja+1]=Ob.y,db[Ja+2]=Ob.z,Ja+=3;I=0;for(R=la.length;I<R;I++)if(N=za[la[I]],jc=
N.vertexNormals,Ob=N.normal,4===jc.length&&Ec)for(ja=0;4>ja;ja++)Vb=jc[ja],db[Ja]=Vb.x,db[Ja+1]=Vb.y,db[Ja+2]=Vb.z,Ja+=3;else for(ja=0;4>ja;ja++)db[Ja]=Ob.x,db[Ja+1]=Ob.y,db[Ja+2]=Ob.z,Ja+=3;i.bindBuffer(i.ARRAY_BUFFER,ca.__webglNormalBuffer);i.bufferData(i.ARRAY_BUFFER,db,Xa)}if(gd&&Xc&&dd){I=0;for(R=ka.length;I<R;I++)if(fb=ka[I],N=za[fb],kc=Xc[fb],void 0!==kc)for(ja=0;3>ja;ja++)mc=kc[ja],vc[Hb]=mc.u,vc[Hb+1]=mc.v,Hb+=2;I=0;for(R=la.length;I<R;I++)if(fb=la[I],N=za[fb],kc=Xc[fb],void 0!==kc)for(ja=
0;4>ja;ja++)mc=kc[ja],vc[Hb]=mc.u,vc[Hb+1]=mc.v,Hb+=2;0<Hb&&(i.bindBuffer(i.ARRAY_BUFFER,ca.__webglUVBuffer),i.bufferData(i.ARRAY_BUFFER,vc,Xa))}if(gd&&Yc&&dd){I=0;for(R=ka.length;I<R;I++)if(fb=ka[I],N=za[fb],lc=Yc[fb],void 0!==lc)for(ja=0;3>ja;ja++)nc=lc[ja],wc[Ib]=nc.u,wc[Ib+1]=nc.v,Ib+=2;I=0;for(R=la.length;I<R;I++)if(fb=la[I],N=za[fb],lc=Yc[fb],void 0!==lc)for(ja=0;4>ja;ja++)nc=lc[ja],wc[Ib]=nc.u,wc[Ib+1]=nc.v,Ib+=2;0<Ib&&(i.bindBuffer(i.ARRAY_BUFFER,ca.__webglUV2Buffer),i.bufferData(i.ARRAY_BUFFER,
...
y.array[B+10]=W.z,y.array[B+11]=W.w,B+=12;I=0;for(R=la.length;I<R;I++)ma=W=V=U=Ya=y.value[la[I]],y.array[B]=U.x,y.array[B+1]=U.y,y.array[B+2]=U.z,y.array[B+3]=U.w,y.array[B+4]=V.x,y.array[B+5]=V.y,y.array[B+6]=V.z,y.array[B+7]=V.w,y.array[B+8]=W.x,y.array[B+9]=W.y,y.array[B+10]=W.z,y.array[B+11]=W.w,y.array[B+12]=ma.x,y.array[B+13]=ma.y,y.array[B+14]=ma.z,y.array[B+15]=ma.w,B+=16}i.bindBuffer(i.ARRAY_BUFFER,y.buffer);i.bufferData(i.ARRAY_BUFFER,y.array,Xa)}}pd&&(delete ca.__inittedArrays,delete ca.__colorArray,
...
ga.colorsNeedUpdate){var Zb=ga,hd=i.DYNAMIC_DRAW,xc=void 0,yc=void 0,Jc=void 0,$b=void 0,Kc=void 0,id=Zb.vertices,jd=Zb.colors,vd=id.length,wd=jd.length,Lc=Zb.__vertexArray,Mc=Zb.__colorArray,xd=Zb.colorsNeedUpdate;if(Zb.verticesNeedUpdate){for(xc=0;xc<vd;xc++)Jc=id[xc],$b=3*xc,Lc[$b]=Jc.x,Lc[$b+1]=Jc.y,Lc[$b+2]=Jc.z;i.bindBuffer(i.ARRAY_BUFFER,Zb.__webglVertexBuffer);i.bufferData(i.ARRAY_BUFFER,Lc,hd)}if(xd){for(yc=0;yc<wd;yc++)Kc=jd[yc],$b=3*yc,Mc[$b]=Kc.r,Mc[$b+1]=Kc.g,Mc[$b+2]=Kc.b;i.bindBuffer(i.ARRAY_BUFFER,
Zb.__webglColorBuffer);i.bufferData(i.ARRAY_BUFFER,Mc,hd)}}ga.verticesNeedUpdate=!1;ga.colorsNeedUpdate=!1}else if(jb instanceof THREE.Line){Ua=c(jb,hb);ic=Ua.attributes&&p(Ua);if(ga.verticesNeedUpdate||ga.colorsNeedUpdate||ic){var Jb=ga,Zc=i.DYNAMIC_DRAW,zc=void 0,Ac=void 0,Nc=void 0,va=void 0,Oc=void 0,kd=Jb.vertices,ld=Jb.colors,yd=kd.length,zd=ld.length,Pc=Jb.__vertexArray,Qc=Jb.__colorArray,Ad=Jb.colorsNeedUpdate,$c=Jb.__webglCustomAttributesList,Rc=void 0,md=void 0,Ia=void 0,oc=void 0,Va=void 0,
pa=void 0;if(Jb.verticesNeedUpdate){for(zc=0;zc<yd;zc++)Nc=kd[zc],va=3*zc,Pc[va]=Nc.x,Pc[va+1]=Nc.y,Pc[va+2]=Nc.z;i.bindBuffer(i.ARRAY_BUFFER,Jb.__webglVertexBuffer);i.bufferData(i.ARRAY_BUFFER,Pc,Zc)}if(Ad){for(Ac=0;Ac<zd;Ac++)Oc=ld[Ac],va=3*Ac,Qc[va]=Oc.r,Qc[va+1]=Oc.g,Qc[va+2]=Oc.b;i.bindBuffer(i.ARRAY_BUFFER,Jb.__webglColorBuffer);i.bufferData(i.ARRAY_BUFFER,Qc,Zc)}if($c){Rc=0;for(md=$c.length;Rc<md;Rc++)if(pa=$c[Rc],pa.needsUpdate&&(void 0===pa.boundTo||"vertices"===pa.boundTo)){va=0;oc=pa.value.length;
...
2]=Va.z,pa.array[va+3]=Va.w,va+=4;i.bindBuffer(i.ARRAY_BUFFER,pa.buffer);i.bufferData(i.ARRAY_BUFFER,pa.array,Zc)}}}ga.verticesNeedUpdate=!1;ga.colorsNeedUpdate=!1;Ua.attributes&&m(Ua)}else jb instanceof THREE.ParticleSystem&&(Ua=c(jb,hb),ic=Ua.attributes&&p(Ua),(ga.verticesNeedUpdate||ga.colorsNeedUpdate||jb.sortParticles||ic)&&f(ga,i.DYNAMIC_DRAW,jb),ga.verticesNeedUpdate=!1,ga.colorsNeedUpdate=!1,Ua.attributes&&m(Ua))}};this.initMaterial=function(a,b,c,d){var e,f,g;a instanceof THREE.MeshDepthMaterial?
g="depth":a instanceof THREE.MeshNormalMaterial?g="normal":a instanceof THREE.MeshBasicMaterial?g="basic":a instanceof THREE.MeshLambertMaterial?g="lambert":a instanceof THREE.MeshPhongMaterial?g="phong":a instanceof THREE.LineBasicMaterial?g="basic":a instanceof THREE.ParticleBasicMaterial&&(g="particle_basic");if(g){var h=THREE.ShaderLib[g];a.uniforms=THREE.UniformsUtils.clone(h.uniforms);a.vertexShader=h.vertexShader;a.fragmentShader=h.fragmentShader}var j,k,l,m,n;j=m=n=h=0;for(k=b.length;j<k;j++)l=
b[j],l.onlyShadow||(l instanceof THREE.DirectionalLight&&m++,l instanceof THREE.PointLight&&n++,l instanceof THREE.SpotLight&&h++);n+h+m<=M?(k=m,l=n,m=h):(k=Math.ceil(M*m/(n+m)),m=l=M-k);var p=0,h=0;for(n=b.length;h<n;h++)j=b[h],j.castShadow&&(j instanceof THREE.SpotLight&&p++,j instanceof THREE.DirectionalLight&&!j.shadowCascade&&p++);var o=50;void 0!==d&&d instanceof THREE.SkinnedMesh&&(o=d.bones.length);var q;a:{n=a.fragmentShader;j=a.vertexShader;var h=a.uniforms,b=a.attributes,c={map:!!a.map,
...
i.attachShader(r,t("fragment",k+n));i.attachShader(r,t("vertex",d+j));i.linkProgram(r);i.getProgramParameter(r,i.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+i.getProgramParameter(r,i.VALIDATE_STATUS)+", gl error ["+i.getError()+"]");r.uniforms={};r.attributes={};var s,d="viewMatrix modelViewMatrix projectionMatrix normalMatrix objectMatrix cameraPosition boneGlobalMatrices morphTargetInfluences".split(" ");for(s in h)d.push(s);s=d;d=0;for(h=s.length;d<h;d++)n=s[d],
r.uniforms[n]=i.getUniformLocation(r,n);d="position normal uv uv2 tangent color skinVertexA skinVertexB skinIndex skinWeight".split(" ");for(s=0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<c.maxMorphNormals;s++)d.push("morphNormal"+s);for(q in b)d.push(q);q=d;s=0;for(b=q.length;s<b;s++)c=q[s],r.attributes[c]=i.getAttribLocation(r,c);r.id=S.length;S.push({program:r,code:g});G.info.memory.programs=S.length;q=r}a.program=q;q=a.program.attributes;0<=q.position&&i.enableVertexAttribArray(q.position);
0<=q.color&&i.enableVertexAttribArray(q.color);0<=q.normal&&i.enableVertexAttribArray(q.normal);0<=q.tangent&&i.enableVertexAttribArray(q.tangent);a.skinning&&(0<=q.skinVertexA&&0<=q.skinVertexB&&0<=q.skinIndex&&0<=q.skinWeight)&&(i.enableVertexAttribArray(q.skinVertexA),i.enableVertexAttribArray(q.skinVertexB),i.enableVertexAttribArray(q.skinIndex),i.enableVertexAttribArray(q.skinWeight));if(a.attributes)for(f in a.attributes)void 0!==q[f]&&0<=q[f]&&i.enableVertexAttribArray(q[f]);if(a.morphTargets){a.numSupportedMorphTargets=
0;r="morphTarget";for(f=0;f<this.maxMorphTargets;f++)s=r+f,0<=q[s]&&(i.enableVertexAttribArray(q[s]),a.numSupportedMorphTargets++)}if(a.morphNormals){a.numSupportedMorphNormals=0;r="morphNormal";for(f=0;f<this.maxMorphNormals;f++)s=r+f,0<=q[s]&&(i.enableVertexAttribArray(q[s]),a.numSupportedMorphNormals++)}a.uniformsList=[];for(e in a.uniforms)a.uniformsList.push([a.uniforms[e],e])};this.setFaceCulling=function(a,b){a?(!b||"ccw"===b?i.frontFace(i.CCW):i.frontFace(i.CW),"back"===a?i.cullFace(i.BACK):
"front"===a?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK),i.enable(i.CULL_FACE)):i.disable(i.CULL_FACE)};this.setObjectFaces=function(a){ia!==a.doubleSided&&(a.doubleSided?i.disable(i.CULL_FACE):i.enable(i.CULL_FACE),ia=a.doubleSided);O!==a.flipSided&&(a.flipSided?i.frontFace(i.CW):i.frontFace(i.CCW),O=a.flipSided)};this.setDepthTest=function(a){Ma!==a&&(a?i.enable(i.DEPTH_TEST):i.disable(i.DEPTH_TEST),Ma=a)};this.setDepthWrite=function(a){Ka!==a&&(i.depthMask(a),Ka=a)};this.setBlending=function(a,
b,c,d){if(a!==X){switch(a){case THREE.NoBlending:i.disable(i.BLEND);break;case THREE.AdditiveBlending:i.enable(i.BLEND);i.blendEquation(i.FUNC_ADD);i.blendFunc(i.SRC_ALPHA,i.ONE);break;case THREE.SubtractiveBlending:i.enable(i.BLEND);i.blendEquation(i.FUNC_ADD);i.blendFunc(i.ZERO,i.ONE_MINUS_SRC_COLOR);break;case THREE.MultiplyBlending:i.enable(i.BLEND);i.blendEquation(i.FUNC_ADD);i.blendFunc(i.ZERO,i.SRC_COLOR);break;case THREE.CustomBlending:i.enable(i.BLEND);break;default:i.enable(i.BLEND),i.blendEquationSeparate(i.FUNC_ADD,
i.FUNC_ADD),i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA)}X=a}if(a===THREE.CustomBlending){if(b!==Z&&(i.blendEquation(H(b)),Z=b),c!==$||d!==ha)i.blendFunc(H(c),H(d)),$=c,ha=d}else ha=$=Z=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=i.createTexture(),G.info.memory.textures++);i.activeTexture(i.TEXTURE0+b);i.bindTexture(i.TEXTURE_2D,a.__webglTexture);i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);
var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=H(a.format),f=H(a.type);w(i.TEXTURE_2D,a,d);a instanceof THREE.DataTexture?i.texImage2D(i.TEXTURE_2D,0,e,c.width,c.height,0,e,f,c.data):i.texImage2D(i.TEXTURE_2D,0,e,e,f,a.image);a.generateMipmaps&&d&&i.generateMipmap(i.TEXTURE_2D);a.needsUpdate=!1;if(a.onUpdate)a.onUpdate()}else i.activeTexture(i.TEXTURE0+b),i.bindTexture(i.TEXTURE_2D,a.__webglTexture)};this.setRenderTarget=function(a){var b=a instanceof THREE.WebGLRenderTargetCube;
if(a&&!a.__webglFramebuffer){void 0===a.depthBuffer&&(a.depthBuffer=!0);void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.__webglTexture=i.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=H(a.format),e=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];i.bindTexture(i.TEXTURE_CUBE_MAP,a.__webglTexture);w(i.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=i.createFramebuffer();a.__webglRenderbuffer[f]=i.createRenderbuffer();i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+
f,0,d,a.width,a.height,0,d,e,null);var g=a,h=i.TEXTURE_CUBE_MAP_POSITIVE_X+f;i.bindFramebuffer(i.FRAMEBUFFER,a.__webglFramebuffer[f]);i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,h,g.__webglTexture,0);s(a.__webglRenderbuffer[f],a)}c&&i.generateMipmap(i.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=i.createFramebuffer(),a.__webglRenderbuffer=i.createRenderbuffer(),i.bindTexture(i.TEXTURE_2D,a.__webglTexture),w(i.TEXTURE_2D,a,c),i.texImage2D(i.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=
i.TEXTURE_2D,i.bindFramebuffer(i.FRAMEBUFFER,a.__webglFramebuffer),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,d,a.__webglTexture,0),s(a.__webglRenderbuffer,a),c&&i.generateMipmap(i.TEXTURE_2D);b?i.bindTexture(i.TEXTURE_CUBE_MAP,null):i.bindTexture(i.TEXTURE_2D,null);i.bindRenderbuffer(i.RENDERBUFFER,null);i.bindFramebuffer(i.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=gb,a=Lb,d=Kb,e=lb);b!==D&&(i.bindFramebuffer(i.FRAMEBUFFER,
b),i.viewport(d,e,c,a),D=b);hb=c;Cb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,e=a.vertices.length,f=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=f.vertices,j=a.faces,k=f.faces,l=a.faceVertexUvs[0],p=f.faceVertexUvs[0],m={},o=0;o<a.materials.length;o++)m[a.materials[o].id]=o;b instanceof THREE.Mesh&&(b.matrixAutoUpdate&&b.updateMatrix(),c=b.matrix,d=new THREE.Matrix4,d.extractRotation(c,b.scale));for(var o=0,q=h.length;o<q;o++){var n=h[o].clone();c&&c.multiplyVector3(n);g.push(n)}o=0;for(q=k.length;o<q;o++){var g=k[o],
...
a.faces[b],d instanceof THREE.Face4){e=d.a;var j=d.b,k=d.c,l=d.d,p=new THREE.Face3,m=new THREE.Face3;p.color.copy(d.color);m.color.copy(d.color);p.materialIndex=d.materialIndex;m.materialIndex=d.materialIndex;p.a=e;p.b=j;p.c=l;m.a=j;m.b=k;m.c=l;4===d.vertexColors.length&&(p.vertexColors[0]=d.vertexColors[0].clone(),p.vertexColors[1]=d.vertexColors[1].clone(),p.vertexColors[2]=d.vertexColors[3].clone(),m.vertexColors[0]=d.vertexColors[1].clone(),m.vertexColors[1]=d.vertexColors[2].clone(),m.vertexColors[2]=
d.vertexColors[3].clone());f.push(p,m);d=0;for(e=a.faceVertexUvs.length;d<e;d++)a.faceVertexUvs[d].length&&(p=a.faceVertexUvs[d][b],j=p[1],k=p[2],l=p[3],p=[p[0].clone(),j.clone(),l.clone()],j=[j.clone(),k.clone(),l.clone()],h[d].push(p,j));d=0;for(e=a.faceUvs.length;d<e;d++)a.faceUvs[d].length&&(j=a.faceUvs[d][b],g[d].push(j,j))}else{f.push(d);d=0;for(e=a.faceUvs.length;d<e;d++)g[d].push(a.faceUvs[d]);d=0;for(e=a.faceVertexUvs.length;d<e;d++)h[d].push(a.faceVertexUvs[d])}a.faces=f;a.faceUvs=g;a.faceVertexUvs=
h;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals();a.hasTangents&&a.computeTangents()},explode:function(a){for(var b=[],c=0,d=a.faces.length;c<d;c++){var e=b.length,f=a.faces[c];if(f instanceof THREE.Face4){var g=f.a,h=f.b,j=f.c,g=a.vertices[g],h=a.vertices[h],j=a.vertices[j],k=a.vertices[f.d];b.push(g.clone());b.push(h.clone());b.push(j.clone());b.push(k.clone());f.a=e;f.b=e+1;f.c=e+2;f.d=e+3}else g=f.a,h=f.b,j=f.c,g=a.vertices[g],h=a.vertices[h],j=a.vertices[j],b.push(g.clone()),
b.push(h.clone()),b.push(j.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,j,k,l,p,m,o,q,n,r,u,t,w,s,x=[],H=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)H[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,k=a.vertices[f],l=a.vertices[g],p=a.vertices[h],o=k.distanceTo(l),q=l.distanceTo(p),m=k.distanceTo(p),o>b||q>b||m>b){j=a.vertices.length;w=e.clone();s=e.clone();o>=q&&o>=m?(k=k.clone(),
k.lerpSelf(l,0.5),w.a=f,w.b=j,w.c=h,s.a=j,s.b=g,s.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),w.vertexNormals[1].copy(f),s.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),w.vertexColors[1].copy(f),s.vertexColors[0].copy(f)),e=0):q>=o&&q>=m?(k=l.clone(),k.lerpSelf(p,0.5),w.a=f,w.b=g,w.c=j,s.a=j,s.b=h,s.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],
0.5),w.vertexNormals[2].copy(f),s.vertexNormals[0].copy(f),s.vertexNormals[1].copy(e.vertexNormals[2]),s.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),w.vertexColors[2].copy(f),s.vertexColors[0].copy(f),s.vertexColors[1].copy(e.vertexColors[2]),s.vertexColors[2].copy(e.vertexColors[0])),e=1):(k=k.clone(),k.lerpSelf(p,0.5),w.a=f,w.b=g,w.c=j,s.a=j,s.b=g,s.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),
...
l.lerpSelf(w,0.5),k=[s.clone(),h.clone(),l.clone()],h=[l.clone(),w.clone(),s.clone()]):(l=s.clone(),l.lerpSelf(w,0.5),k=[s.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),w.clone()]),H[f].push(k,h))}else{x.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)H[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,j=e.d,k=a.vertices[f],l=a.vertices[g],p=a.vertices[h],m=a.vertices[j],o=k.distanceTo(l),q=l.distanceTo(p),n=p.distanceTo(m),r=k.distanceTo(m),o>b||q>b||n>b||r>b){u=a.vertices.length;t=
a.vertices.length+1;w=e.clone();s=e.clone();o>=q&&o>=n&&o>=r||n>=q&&n>=o&&n>=r?(o=k.clone(),o.lerpSelf(l,0.5),l=p.clone(),l.lerpSelf(m,0.5),w.a=f,w.b=u,w.c=t,w.d=j,s.a=u,s.b=g,s.c=h,s.d=t,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),w.vertexNormals[1].copy(f),w.vertexNormals[2].copy(g),s.vertexNormals[0].copy(f),s.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),
f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),w.vertexColors[1].copy(f),w.vertexColors[2].copy(g),s.vertexColors[0].copy(f),s.vertexColors[3].copy(g)),e=0):(o=l.clone(),o.lerpSelf(p,0.5),l=m.clone(),l.lerpSelf(k,0.5),w.a=f,w.b=g,w.c=u,w.d=t,s.a=t,s.b=u,s.c=h,s.d=j,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),w.vertexNormals[2].copy(f),w.vertexNormals[3].copy(g),
...
0.5),p=w.clone(),p.lerpSelf(k,0.5),s=[s.clone(),l.clone(),p.clone(),k.clone()],h=[l.clone(),h.clone(),w.clone(),p.clone()]):(l=h.clone(),l.lerpSelf(w,0.5),p=k.clone(),p.lerpSelf(s,0.5),s=[s.clone(),h.clone(),l.clone(),p.clone()],h=[p.clone(),l.clone(),w.clone(),k.clone()]),H[f].push(s,h))}else{x.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)H[f].push(a.faceVertexUvs[f][c])}a.faces=x;a.faceVertexUvs=H}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},b=b|1,d=a.width,e=a.height,f=document.createElement("canvas");f.width=d;f.height=e;var g=f.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,e).data,j=g.createImageData(d,e),k=j.data,l=0;l<d;l++)for(var p=0;p<e;p++){var m=0>p-1?0:p-1,o=p+1>e-1?e-1:p+1,q=0>l-1?0:l-1,n=l+1>d-1?d-1:l+1,r=[],u=[0,0,h[4*(p*d+l)]/255*b];r.push([-1,0,h[4*(p*d+q)]/255*b]);r.push([-1,-1,h[4*(m*d+q)]/255*b]);r.push([0,
...
u=4*(p*d+l);k[u]=255*((r[0]+1)/2)|0;k[u+1]=255*(r[1]+0.5)|0;k[u+2]=255*r[2]|0;k[u+3]=255}g.putImageData(j,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,a,b,THREE.RGBFormat);a.needsUpdate=!0;return a}};
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(a,b);var a=a||12,c=[],d,e,f,g,h,j,k,l,p,m,o,q,n;d=0;for(e=this.actions.length;d<e;d++)switch(f=this.actions[d],g=f.action,f=f.args,g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=f[2];j=f[3];p=f[0];m=f[1];0<c.length?(g=c[c.length-1],o=g.x,
q=g.y):(g=this.actions[d-1].args,o=g[g.length-2],q=g[g.length-1]);for(f=1;f<=a;f++)n=f/a,g=THREE.Shape.Utils.b2(n,o,p,h),n=THREE.Shape.Utils.b2(n,q,m,j),c.push(new THREE.Vector2(g,n));break;case THREE.PathActions.BEZIER_CURVE_TO:h=f[4];j=f[5];p=f[0];m=f[1];k=f[2];l=f[3];0<c.length?(g=c[c.length-1],o=g.x,q=g.y):(g=this.actions[d-1].args,o=g[g.length-2],q=g[g.length-1]);for(f=1;f<=a;f++)n=f/a,g=THREE.Shape.Utils.b3(n,o,p,k,h),n=THREE.Shape.Utils.b3(n,q,m,l,j),c.push(new THREE.Vector2(g,n));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;n=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*f[0].length;n=n.concat(f[0]);n=new THREE.SplineCurve(n);for(f=1;f<=g;f++)c.push(n.getPointAt(f/g));break;case THREE.PathActions.ARC:h=f[0];j=f[1];k=f[2];p=f[3];m=!!f[5];l=f[4]-p;o=2*a;for(f=1;f<=o;f++)n=f/o,m||(n=1-n),n=p+n*l,g=h+k*Math.cos(n),n=j+k*Math.sin(n),c.push(new THREE.Vector2(g,n))}d=c[c.length-1];1.0E-10>Math.abs(d.x-c[0].x)&&1.0E-10>Math.abs(d.y-c[0].y)&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
THREE.Path.prototype.transform=function(a,b){this.getBoundingBox();return this.getWrapPoints(this.getPoints(b),a)};THREE.Path.prototype.nltransform=function(a,b,c,d,e,f){var g=this.getPoints(),h,j,k,l,p;h=0;for(j=g.length;h<j;h++)k=g[h],l=k.x,p=k.y,k.x=a*l+b*p+c,k.y=d*p+e*l+f;return g};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),e,f,g,h,j,k,l,p,m,o,q=[];for(j=0;j<b.length;j++){k=b[j];Array.prototype.push.apply(d,k);f=Number.POSITIVE_INFINITY;for(e=0;e<k.length;e++){m=k[e];o=[];for(p=0;p<c.length;p++)l=c[p],l=m.distanceToSquared(l),o.push(l),l<f&&(f=l,g=e,h=p)}e=0<=h-1?h-1:c.length-1;f=0<=g-1?g-1:k.length-1;var n=[k[g],c[h],c[e]];p=THREE.FontUtils.Triangulate.area(n);var r=[k[g],k[f],c[h]];m=THREE.FontUtils.Triangulate.area(r);o=h;l=g;h+=1;g+=-1;0>
...
THREE.Animation.prototype.update=function(a){if(this.isPlaying){var b=["pos","rot","scl"],c,d,e,f,g,h,j,k,l=this.data.JIT.hierarchy,p,m;m=this.currentTime+=a*this.timeScale;p=this.currentTime%=this.data.length;k=parseInt(Math.min(p*this.data.fps,this.data.length*this.data.fps),10);for(var o=0,q=this.hierarchy.length;o<q;o++)if(a=this.hierarchy[o],j=a.animationCache,this.JITCompile&&void 0!==l[o][k])a instanceof THREE.Bone?(a.skinMatrix=l[o][k],a.matrixAutoUpdate=!1,a.matrixWorldNeedsUpdate=!1):(a.matrix=
l[o][k],a.matrixAutoUpdate=!1,a.matrixWorldNeedsUpdate=!0);else{this.JITCompile&&(a instanceof THREE.Bone?a.skinMatrix=a.animationCache.originalMatrix:a.matrix=a.animationCache.originalMatrix);for(var n=0;3>n;n++){c=b[n];g=j.prevKey[c];h=j.nextKey[c];if(h.time<=m){if(p<m)if(this.loop){g=this.data.hierarchy[o].keys[0];for(h=this.getNextKeyWith(c,o,1);h.time<p;)g=h,h=this.getNextKeyWith(c,o,h.index+1)}else{this.stop();return}else{do g=h,h=this.getNextKeyWith(c,o,h.index+1);while(h.time<p)}j.prevKey[c]=
g;j.nextKey[c]=h}a.matrixAutoUpdate=!0;a.matrixWorldNeedsUpdate=!0;d=(p-g.time)/(h.time-g.time);e=g[c];f=h[c];if(0>d||1<d)console.log("THREE.Animation.update: Warning! Scale out of bounds:"+d+" on bone "+o),d=0>d?0:1;if("pos"===c)if(c=a.position,this.interpolationType===THREE.AnimationHandler.LINEAR)c.x=e[0]+(f[0]-e[0])*d,c.y=e[1]+(f[1]-e[1])*d,c.z=e[2]+(f[2]-e[2])*d;else{if(this.interpolationType===THREE.AnimationHandler.CATMULLROM||this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD)this.points[0]=
...
THREE.KeyFrameAnimation.prototype.update=function(a){if(this.isPlaying){var b,c,d,e,f=this.data.JIT.hierarchy,g,h,j;h=this.currentTime+=a*this.timeScale;g=this.currentTime%=this.data.length;g<this.startTimeMs&&(g=this.currentTime=this.startTimeMs+g);e=parseInt(Math.min(g*this.data.fps,this.data.length*this.data.fps),10);if((j=g<h)&&!this.loop){for(var a=0,k=this.hierarchy.length;a<k;a++){var l=this.data.hierarchy[a].keys,f=this.data.hierarchy[a].sids;d=l.length-1;e=this.hierarchy[a];if(l.length){for(l=
...
1,a,b);h.up.set(0,-1,0);h.lookAt(new THREE.Vector3(0,0,1));this.add(h);var j=new THREE.PerspectiveCamera(90,1,a,b);j.up.set(0,-1,0);j.lookAt(new THREE.Vector3(0,0,-1));this.add(j);this.renderTarget=new THREE.WebGLRenderTargetCube(c,c,{format:THREE.RGBFormat,magFilter:THREE.LinearFilter,minFilter:THREE.LinearFilter});this.updateCubeMap=function(a,b){var c=this.renderTarget,m=c.generateMipmaps;c.generateMipmaps=!1;c.activeCubeFace=0;a.render(b,d,c);c.activeCubeFace=1;a.render(b,e,c);c.activeCubeFace=
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=void 0!==b?b:document;this.mouseLook=!0;this.autoForward=!1;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=!1;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,e=new THREE.Vector3,f=new THREE.Matrix4,g=!1,h=1,j=0,k=0,l=0,p=0,m=0,o=window.innerWidth/2,q=window.innerHeight/2;this.update=function(a){if(this.mouseLook){var b=a*this.lookSpeed;
this.rotateHorizontally(b*p);this.rotateVertically(b*m)}b=a*this.movementSpeed;this.object.translateZ(-b*(0<j||this.autoForward&&!(0>j)?1:j));this.object.translateX(b*k);this.object.translateY(b*l);g&&(this.roll+=this.rollSpeed*a*h);this.forward.y>this.constrainVertical[1]?(this.forward.y=this.constrainVertical[1],this.forward.normalize()):this.forward.y<this.constrainVertical[0]&&(this.forward.y=this.constrainVertical[0],this.forward.normalize());e.copy(this.forward);d.set(0,1,0);c.cross(d,e).normalize();
...
c.noRotate||c.rotateCamera();c.noZoom||c.zoomCamera();c.noPan||c.panCamera();c.object.position.add(c.target,g);c.checkDistances();c.object.lookAt(c.target);0<d.distanceTo(c.object.position)&&(c.dispatchEvent(o),d.copy(c.object.position))};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousemove",function(a){c.enabled&&(e&&(h=j=c.getMouseProjectionOnBall(a.clientX,a.clientY),k=l=c.getMouseOnScreen(a.clientX,a.clientY),p=m=c.getMouseOnScreen(a.clientX,
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function j(a,b,c,g,h,j,l,m){var n,p=d||1,o=e||1,q=h/2,r=j/2,t=k.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)n="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)n="y",o=f||1;else if("z"===a&&"y"===b||"y"===a&&"z"===b)n="x",p=f||1;var i=p+1,u=o+1,w=h/p,D=j/o,Y=new THREE.Vector3;Y[n]=0<l?1:-1;for(h=0;h<u;h++)for(j=0;j<i;j++){var J=new THREE.Vector3;J[a]=(j*w-q)*c;J[b]=(h*D-r)*g;J[n]=l;k.vertices.push(J)}for(h=0;h<o;h++)for(j=0;j<p;j++)a=new THREE.Face4(j+
i*h+t,j+i*(h+1)+t,j+1+i*(h+1)+t,j+1+i*h+t),a.normal.copy(Y),a.vertexNormals.push(Y.clone(),Y.clone(),Y.clone(),Y.clone()),a.materialIndex=m,k.faces.push(a),k.faceVertexUvs[0].push([new THREE.UV(j/p,h/o),new THREE.UV(j/p,(h+1)/o),new THREE.UV((j+1)/p,(h+1)/o),new THREE.UV((j+1)/p,h/o)])}THREE.Geometry.call(this);var k=this,l=a/2,p=b/2,m=c/2,o,q,n,r,u,t;if(void 0!==g){if(g instanceof Array)this.materials=g;else{this.materials=[];for(o=0;6>o;o++)this.materials.push(g)}o=0;r=1;q=2;u=3;n=4;t=5}else this.materials=
[];this.sides={px:!0,nx:!0,py:!0,ny:!0,pz:!0,nz:!0};if(void 0!=h)for(var w in h)void 0!==this.sides[w]&&(this.sides[w]=h[w]);this.sides.px&&j("z","y",-1,-1,c,b,l,o);this.sides.nx&&j("z","y",1,-1,c,b,-l,r);this.sides.py&&j("x","z",1,1,a,c,p,q);this.sides.ny&&j("x","z",1,-1,a,c,-p,u);this.sides.pz&&j("x","y",1,-1,a,b,m,n);this.sides.nz&&j("x","y",-1,-1,a,b,-m,t);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=new THREE.Geometry;THREE.CubeGeometry.prototype.constructor=THREE.CubeGeometry;
THREE.CylinderGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);var a=void 0!==a?a:20,b=void 0!==b?b:20,c=void 0!==c?c:100,g=c/2,d=d||8,e=e||1,h,j,k=[],l=[];for(j=0;j<=e;j++){var p=[],m=[],o=j/e,q=o*(b-a)+a;for(h=0;h<=d;h++){var n=h/d,r=new THREE.Vector3;r.x=q*Math.sin(2*n*Math.PI);r.y=-o*c+g;r.z=q*Math.cos(2*n*Math.PI);this.vertices.push(r);p.push(this.vertices.length-1);m.push(new THREE.UV(n,o))}k.push(p);l.push(m)}c=(b-a)/c;for(h=0;h<d;h++){0!==a?(p=this.vertices[k[0][h]].clone(),m=this.vertices[k[0][h+
1]].clone()):(p=this.vertices[k[1][h]].clone(),m=this.vertices[k[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(j=0;j<e;j++){var o=k[j][h],q=k[j+1][h],n=k[j+1][h+1],r=k[j][h+1],u=p.clone(),t=p.clone(),w=m.clone(),s=m.clone(),x=l[j][h].clone(),H=l[j+1][h].clone(),C=l[j+1][h+1].clone(),z=l[j][h+1].clone();this.faces.push(new THREE.Face4(o,q,n,r,[u,t,w,s]));this.faceVertexUvs[0].push([x,H,C,z])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)o=k[0][h],q=k[0][h+1],n=this.vertices.length-1,u=new THREE.Vector3(0,1,0),t=new THREE.Vector3(0,1,0),w=new THREE.Vector3(0,1,0),x=l[0][h].clone(),H=l[0][h+1].clone(),C=new THREE.UV(H.u,0),this.faces.push(new THREE.Face3(o,q,n,[u,t,w])),this.faceVertexUvs[0].push([x,H,C])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)o=k[j][h+1],q=k[j][h],n=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),t=new THREE.Vector3(0,-1,0),w=new THREE.Vector3(0,-1,0),x=
l[j][h+1].clone(),H=l[j][h].clone(),C=new THREE.UV(H.u,1),this.faces.push(new THREE.Face3(o,q,n,[u,t,w])),this.faceVertexUvs[0].push([x,H,C])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=new THREE.Geometry;THREE.CylinderGeometry.prototype.constructor=THREE.CylinderGeometry;
...
for(var g=0,h=m+2*l,g=0;g<h;g++){var j=T*g,i=T*(g+1),k=d+e+j,j=d+f+j,n=d+f+i,i=d+e+i,p=c,o=g,q=h,k=k+K,j=j+K,n=n+K,i=i+K;A.faces.push(new THREE.Face4(k,j,n,i,null,null,t));k=O.generateSideWallUV(A,a,p,b,k,j,n,i,o,q);A.faceVertexUvs[0].push(k)}}}function f(a,b,c){A.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=K;d+=K;e+=K;A.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?O.generateBottomUV(A,a,b,c,d,e):O.generateTopUV(A,a,b,c,d,e);A.faceVertexUvs[0].push(c)}var h=void 0!==b.amount?
b.amount:100,j=void 0!==b.bevelThickness?b.bevelThickness:6,k=void 0!==b.bevelSize?b.bevelSize:j-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,m=void 0!==b.steps?b.steps:1,o=b.bendPath,q=b.extrudePath,n,r=!1,u=b.material,t=b.extrudeMaterial,w,s,x,H;q&&(n=q.getSpacedPoints(m),r=!0,p=!1,w=new THREE.TubeGeometry.FrenetFrames(q,m,!1),s=new THREE.Vector3,x=new THREE.Vector3,H=new THREE.Vector3);p||(k=j=l=0);var C,z,v,A=this,K=this.vertices.length;o&&a.addWrapPath(o);
var q=a.extractPoints(),o=q.shape,F=q.holes;if(q=!THREE.Shape.Utils.isClockWise(o)){o=o.reverse();z=0;for(v=F.length;z<v;z++)C=F[z],THREE.Shape.Utils.isClockWise(C)&&(F[z]=C.reverse());q=!1}var Q=THREE.Shape.Utils.triangulateShape(o,F),P=o;z=0;for(v=F.length;z<v;z++)C=F[z],o=o.concat(C);var E,M,G,i,S,T=o.length,D,Y=Q.length,q=[],J=0;G=P.length;E=G-1;for(M=J+1;J<G;J++,E++,M++)E===G&&(E=0),M===G&&(M=0),q[J]=d(P[J],P[E],P[M]);var ea=[],fa,ia=q.concat();z=0;for(v=F.length;z<v;z++){C=F[z];fa=[];J=0;G=
C.length;E=G-1;for(M=J+1;J<G;J++,E++,M++)E===G&&(E=0),M===G&&(M=0),fa[J]=d(C[J],C[E],C[M]);ea.push(fa);ia=ia.concat(fa)}for(E=0;E<l;E++){G=E/l;i=j*(1-G);M=k*Math.sin(G*Math.PI/2);J=0;for(G=P.length;J<G;J++)S=c(P[J],q[J],M),f(S.x,S.y,-i);z=0;for(v=F.length;z<v;z++){C=F[z];fa=ea[z];J=0;for(G=C.length;J<G;J++)S=c(C[J],fa[J],M),f(S.x,S.y,-i)}}M=k;for(J=0;J<T;J++)S=p?c(o[J],ia[J],M):o[J],r?(x.copy(w.normals[0]).multiplyScalar(S.x),s.copy(w.binormals[0]).multiplyScalar(S.y),H.copy(n[0]).addSelf(x).addSelf(s),
f(H.x,H.y,H.z)):f(S.x,S.y,0);for(G=1;G<=m;G++)for(J=0;J<T;J++)S=p?c(o[J],ia[J],M):o[J],r?(x.copy(w.normals[G]).multiplyScalar(S.x),s.copy(w.binormals[G]).multiplyScalar(S.y),H.copy(n[G]).addSelf(x).addSelf(s),f(H.x,H.y,H.z)):f(S.x,S.y,h/m*G);for(E=l-1;0<=E;E--){G=E/l;i=j*(1-G);M=k*Math.sin(G*Math.PI/2);J=0;for(G=P.length;J<G;J++)S=c(P[J],q[J],M),f(S.x,S.y,h+i);z=0;for(v=F.length;z<v;z++){C=F[z];fa=ea[z];J=0;for(G=C.length;J<G;J++)S=c(C[J],fa[J],M),r?f(S.x,S.y+n[m-1].y,n[m-1].x+i):f(S.x,S.y,h+i)}}var O=
THREE.ExtrudeGeometry.WorldUVGenerator;(function(){if(p){var a;a=T*0;for(J=0;J<Y;J++){D=Q[J];g(D[2]+a,D[1]+a,D[0]+a,true)}a=m+l*2;a=T*a;for(J=0;J<Y;J++){D=Q[J];g(D[0]+a,D[1]+a,D[2]+a,false)}}else{for(J=0;J<Y;J++){D=Q[J];g(D[2],D[1],D[0],true)}for(J=0;J<Y;J++){D=Q[J];g(D[0]+T*m,D[1]+T*m,D[2]+T*m,false)}}})();(function(){var a=0;e(P,a);a=a+P.length;z=0;for(v=F.length;z<v;z++){C=F[z];e(C,a);a=a+C.length}})()};
...
THREE.SphereGeometry=function(a,b,c,d,e,f,g){THREE.Geometry.call(this);var a=a||50,d=void 0!==d?d:0,e=void 0!==e?e:2*Math.PI,f=void 0!==f?f:0,g=void 0!==g?g:Math.PI,b=Math.max(3,Math.floor(b)||8),c=Math.max(2,Math.floor(c)||6),h,j,k=[],l=[];for(j=0;j<=c;j++){var p=[],m=[];for(h=0;h<=b;h++){var o=h/b,q=j/c,n=new THREE.Vector3;n.x=-a*Math.cos(d+o*e)*Math.sin(f+q*g);n.y=a*Math.cos(f+q*g);n.z=a*Math.sin(d+o*e)*Math.sin(f+q*g);this.vertices.push(n);p.push(this.vertices.length-1);m.push(new THREE.UV(o,
q))}k.push(p);l.push(m)}for(j=0;j<c;j++)for(h=0;h<b;h++){var d=k[j][h+1],e=k[j][h],f=k[j+1][h],g=k[j+1][h+1],p=this.vertices[d].clone().normalize(),m=this.vertices[e].clone().normalize(),o=this.vertices[f].clone().normalize(),q=this.vertices[g].clone().normalize(),n=l[j][h+1].clone(),r=l[j][h].clone(),u=l[j+1][h].clone(),t=l[j+1][h+1].clone();Math.abs(this.vertices[d].y)==a?(this.faces.push(new THREE.Face3(d,f,g,[p,o,q])),this.faceVertexUvs[0].push([n,u,t])):Math.abs(this.vertices[f].y)==a?(this.faces.push(new THREE.Face3(d,
...
0,e=(""+a).split(""),f=e.length,g=[],a=0;a<f;a++){var h=new THREE.Path,h=this.extractGlyphPoints(e[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,e){var f=[],g,h,j,k,l,p,m,o,q,n,r,u=b.glyphs[a]||b.glyphs["?"];if(u){if(u.o){b=u._cachedOutline||(u._cachedOutline=u.o.split(" "));k=b.length;for(a=0;a<k;)switch(j=b[a++],j){case "m":j=b[a++]*c+d;l=b[a++]*c;f.push(new THREE.Vector2(j,l));e.moveTo(j,l);break;case "l":j=b[a++]*c+d;l=b[a++]*c;f.push(new THREE.Vector2(j,
l));e.lineTo(j,l);break;case "q":j=b[a++]*c+d;l=b[a++]*c;o=b[a++]*c+d;q=b[a++]*c;e.quadraticCurveTo(o,q,j,l);if(g=f[f.length-1]){p=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){var t=g/h,w=THREE.Shape.Utils.b2(t,p,o,j),t=THREE.Shape.Utils.b2(t,m,q,l);f.push(new THREE.Vector2(w,t))}}break;case "b":if(j=b[a++]*c+d,l=b[a++]*c,o=b[a++]*c+d,q=b[a++]*-c,n=b[a++]*c+d,r=b[a++]*-c,e.bezierCurveTo(j,l,o,q,n,r),g=f[f.length-1]){p=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++)t=g/h,w=THREE.Shape.Utils.b3(t,p,o,
n,j),t=THREE.Shape.Utils.b3(t,m,q,r,l),f.push(new THREE.Vector2(w,t))}}}return{offset:u.ha*c,points:f,path:e}}}};
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],j,k,l;if(0<b(a))for(k=0;k<e;k++)g[k]=k;else for(k=0;k<e;k++)g[k]=e-1-k;var p=2*e;for(k=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}j=k;e<=j&&(j=0);k=j+1;e<=k&&(k=0);l=k+1;e<=l&&(l=0);var m;a:{m=a;var o=j,q=k,n=l,r=e,u=g,t=void 0,w=void 0,s=void 0,x=void 0,H=void 0,
C=void 0,z=void 0,v=void 0,A=void 0,w=m[u[o]].x,s=m[u[o]].y,x=m[u[q]].x,H=m[u[q]].y,C=m[u[n]].x,z=m[u[n]].y;if(1.0E-10>(x-w)*(z-s)-(H-s)*(C-w))m=!1;else{for(t=0;t<r;t++)if(!(t==o||t==q||t==n)){var v=m[u[t]].x,A=m[u[t]].y,K=void 0,F=void 0,Q=void 0,P=void 0,E=void 0,M=void 0,G=void 0,i=void 0,S=void 0,T=void 0,D=void 0,Y=void 0,K=C-x,F=z-H,Q=w-C,P=s-z,E=x-w,M=H-s,G=v-w,i=A-s,S=v-x,T=A-H,D=v-C,Y=A-z,K=K*T-F*S,E=E*i-M*G,Q=Q*Y-P*D;if(0<=K&&0<=Q&&0<=E){m=!1;break a}}m=!0}}if(m){f.push([a[g[j]],a[g[k]],
a[g[l]]]);h.push([g[j],g[k],g[l]]);j=k;for(l=k+1;l<e;j++,l++)g[j]=g[l];e--;p=2*e}}return d?h:f};a.Triangulate.area=b;return a})(THREE.FontUtils);self._typeface_js={faces:THREE.FontUtils.faces,loadFace:THREE.FontUtils.loadFace};
...
THREE.TubeGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=e||!1;f&&(this.debug=new THREE.Object3D);this.grid=[];var g,h,f=this.segments+1,j,k,l,p=new THREE.Vector3,m,o,q,b=new THREE.TubeGeometry.FrenetFrames(a,b,e);m=b.tangents;o=b.normals;q=b.binormals;this.tangents=m;this.normals=o;this.binormals=q;for(b=0;b<f;b++){this.grid[b]=[];d=b/(f-1);l=a.getPointAt(d);d=m[b];g=o[b];h=q[b];this.debug&&(this.debug.add(new THREE.ArrowHelper(d,
l,c,255)),this.debug.add(new THREE.ArrowHelper(g,l,c,16711680)),this.debug.add(new THREE.ArrowHelper(h,l,c,65280)));for(d=0;d<this.segmentsRadius;d++)j=2*(d/this.segmentsRadius)*Math.PI,k=-this.radius*Math.cos(j),j=this.radius*Math.sin(j),p.copy(l),p.x+=k*g.x+j*h.x,p.y+=k*g.y+j*h.y,p.z+=k*g.z+j*h.z,this.grid[b][d]=this.vertices.push(new THREE.Vector3(p.x,p.y,p.z))-1}for(b=0;b<this.segments;b++)for(d=0;d<this.segmentsRadius;d++)f=e?(b+1)%this.segments:b+1,p=(d+1)%this.segmentsRadius,a=this.grid[b][d],
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var e=this.vertices,f=this.faces,g=this.faceVertexUvs[0],d=void 0===d?!1:d,h,j,k,l,p=b+1;for(h=0;h<=c;h++){l=h/c;for(j=0;j<=b;j++)k=j/b,k=a(k,l),e.push(k)}var m,o,q,n;for(h=0;h<c;h++)for(j=0;j<b;j++)a=h*p+j,e=h*p+j+1,l=(h+1)*p+j,k=(h+1)*p+j+1,m=new THREE.UV(h/b,j/c),o=new THREE.UV(h/b,(j+1)/c),q=new THREE.UV((h+1)/b,j/c),n=new THREE.UV((h+1)/b,(j+1)/c),d?(f.push(new THREE.Face3(a,e,l)),f.push(new THREE.Face3(e,k,l)),g.push([m,o,
...
THREE.SubdivisionModifier.prototype.smooth=function(a){function b(){m.debug&&console.log.apply(console,arguments)}function c(){console&&console.log.apply(console,arguments)}function d(a,c,d,e,g,h,j){var i=new THREE.Face4(a,c,d,e,null,g.color,g.material);if(m.useOldVertexColors){i.vertexColors=[];for(var k,n,o,q=0;4>q;q++){o=h[q];k=new THREE.Color;k.setRGB(0,0,0);for(var r=0;r<o.length;r++)n=g.vertexColors[o[r]-1],k.r+=n.r,k.g+=n.g,k.b+=n.b;k.r/=o.length;k.g/=o.length;k.b/=o.length;i.vertexColors[q]=
k}}l.push(i);m.supportUVs&&(g=[f(a,""),f(c,j),f(d,j),f(e,j)],g[0]?g[1]?g[2]?g[3]?p.push(g):b("d :( ",e+":"+j):b("c :( ",d+":"+j):b("b :( ",c+":"+j):b("a :( ",a+":"+j))}function e(a,b){return Math.min(a,b)+"_"+Math.max(a,b)}function f(a,d){var e=a+":"+d,f=t[e];return!f?(a>=w&&a<w+q.length?b("face pt"):b("edge pt"),c("warning, UV not found for",e),null):f}function g(a,b,d){var e=a+":"+b;e in t?c("dup vertexNo",a,"oldFaceNo",b,"value",d,"key",e,t[e]):t[e]=d}function h(a,b){void 0===Q[a]&&(Q[a]=[]);Q[a].push(b)}
function j(a,b,c){void 0===P[a]&&(P[a]={});P[a][b]=c}var k=[],l=[],p=[],m=this,o=a.vertices,q=a.faces,k=o.concat(),n=[],r={},u={},t={},w=o.length,s,x,H,C,z,v=a.faceVertexUvs[0],A;b("originalFaces, uvs, originalVerticesLength",q.length,v.length,w);if(m.supportUVs){s=0;for(x=v.length;s<x;s++){H=0;for(C=v[s].length;H<C;H++)A=q[s]["abcd".charAt(H)],g(A,s,v[s][H])}}0==v.length&&(m.supportUVs=!1);s=0;for(z in t)s++;s||(m.supportUVs=!1,b("no uvs"));b("-- Original Faces + Vertices UVs completed",t,"vs",v.length);
...
d;c++){f=a.faces[c];if(f instanceof THREE.Face3){g=e(f.a,f.b);b(g,c);g=e(f.b,f.c);b(g,c);g=e(f.c,f.a);b(g,c)}else if(f instanceof THREE.Face4){g=e(f.a,f.b);b(g,c);g=e(f.b,f.c);b(g,c);g=e(f.c,f.d);b(g,c);g=e(f.d,f.a);b(g,c)}}return h}(a);A=0;var K,F,Q={},P={};for(s in x){v=x[s];K=s.split("_");F=K[0];K=K[1];h(F,[F,K]);h(K,[F,K]);H=0;for(C=v.length;H<C;H++)z=v[H],j(F,z,s),j(K,z,s);2>v.length&&(u[s]=!0)}b("vertexEdgeMap",Q,"vertexFaceMap",P);for(s in x)if(v=x[s],z=v[0],C=v[1],K=s.split("_"),F=K[0],K=
K[1],v=new THREE.Vector3,u[s]?(v.addSelf(o[F]),v.addSelf(o[K]),v.multiplyScalar(0.5)):(v.addSelf(n[z]),v.addSelf(n[C]),v.addSelf(o[F]),v.addSelf(o[K]),v.multiplyScalar(0.25)),r[s]=w+q.length+A,k.push(v),A++,m.supportUVs)v=new THREE.UV,v.u=f(F,z).u+f(K,z).u,v.v=f(F,z).v+f(K,z).v,v.u/=2,v.v/=2,g(r[s],z,v),u[s]||(v=new THREE.UV,v.u=f(F,C).u+f(K,C).u,v.v=f(F,C).v+f(K,C).v,v.u/=2,v.v/=2,g(r[s],C,v));b("-- Step 2 done");var E,M;C=["123","12","2","23"];K=["123","23","3","31"];var G=["123","31","1","12"],
i=["1234","12","2","23"],S=["1234","23","3","34"],T=["1234","34","4","41"],D=["1234","41","1","12"];s=0;for(x=n.length;s<x;s++)z=q[s],v=w+s,z instanceof THREE.Face3?(A=e(z.a,z.b),F=e(z.b,z.c),E=e(z.c,z.a),d(v,r[A],z.b,r[F],z,C,s),d(v,r[F],z.c,r[E],z,K,s),d(v,r[E],z.a,r[A],z,G,s)):z instanceof THREE.Face4?(A=e(z.a,z.b),F=e(z.b,z.c),E=e(z.c,z.d),M=e(z.d,z.a),d(v,r[A],z.b,r[F],z,i,s),d(v,r[F],z.c,r[E],z,S,s),d(v,r[E],z.d,r[M],z,T,s),d(v,r[M],z.a,r[A],z,D,s)):b("face should be a face!",z);r=new THREE.Vector3;
z=new THREE.Vector3;s=0;for(x=o.length;s<x;s++)if(void 0!==Q[s]){r.set(0,0,0);z.set(0,0,0);F=new THREE.Vector3(0,0,0);v=0;for(H in P[s])r.addSelf(n[H]),v++;C=0;A=Q[s].length;for(H=0;H<A;H++)u[e(Q[s][H][0],Q[s][H][1])]&&C++;if(2!=C){r.divideScalar(v);for(H=0;H<A;H++)v=Q[s][H],v=o[v[0]].clone().addSelf(o[v[1]]).divideScalar(2),z.addSelf(v);z.divideScalar(A);F.addSelf(o[s]);F.multiplyScalar(A-3);F.addSelf(r);F.addSelf(z.multiplyScalar(2));F.divideScalar(A);k[s]=F}}a.vertices=k;a.faces=l;a.faceVertexUvs[0]=
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");o=!1};this.render=function(a,d,e,u){var a=a.__webglFlares,t=a.length;if(t){var w=new THREE.Vector3,s=u/e,x=0.5*e,H=0.5*u,C=16/u,z=new THREE.Vector2(C*s,C),v=new THREE.Vector3(1,1,0),A=new THREE.Vector2(1,1),K=m,C=p;b.useProgram(l);o||(b.enableVertexAttribArray(p.vertex),b.enableVertexAttribArray(p.uv),o=!0);b.uniform1i(K.occlusionMap,0);b.uniform1i(K.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(C.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(C.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var F,Q,P,E,M;for(F=0;F<t;F++)if(C=16/u,z.set(C*s,C),E=a[F],w.set(E.matrixWorld.elements[12],E.matrixWorld.elements[13],E.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(w),d.projectionMatrix.multiplyVector3(w),v.copy(w),A.x=v.x*x+x,A.y=v.y*H+H,k||0<A.x&&A.x<e&&0<A.y&&A.y<u){b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,A.x-8,A.y-8,16,16,0);b.uniform1i(K.renderType,0);b.uniform2f(K.scale,z.x,z.y);b.uniform3f(K.screenPosition,v.x,v.y,v.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,j);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,A.x-8,A.y-8,16,16,0);b.uniform1i(K.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);E.positionScreen.copy(v);E.customUpdateCallback?E.customUpdateCallback(E):E.updateLensFlares();b.uniform1i(K.renderType,2);b.enable(b.BLEND);Q=0;for(P=E.lensFlares.length;Q<P;Q++)M=E.lensFlares[Q],0.001<M.opacity&&0.001<M.scale&&(v.x=M.x,v.y=M.y,v.z=M.z,C=M.size*M.scale/u,z.x=C*s,z.y=C,b.uniform3f(K.screenPosition,v.x,v.y,v.z),b.uniform2f(K.scale,z.x,z.y),b.uniform1f(K.rotation,M.rotation),b.uniform1f(K.opacity,M.opacity),b.uniform3f(K.color,M.color.r,
...
m.shadowCameraTop,m.shadowCameraBottom,m.shadowCameraNear,m.shadowCameraFar);else{console.error("Unsupported light type for shadow");continue}j.add(m.shadowCamera);b.autoUpdateScene&&j.updateMatrixWorld()}m.shadowCameraVisible&&!m.cameraHelper&&(m.cameraHelper=new THREE.CameraHelper(m.shadowCamera),m.shadowCamera.add(m.cameraHelper));if(m.isVirtual&&s.originalCamera==k){q=k;o=m.shadowCamera;n=m.pointsFrustum;t=m.pointsWorld;g.set(Infinity,Infinity,Infinity);h.set(-Infinity,-Infinity,-Infinity);for(r=
...
q.matrixWorldInverse);e.setFromMatrix(f);b.setRenderTarget(o);b.clear();t=j.__webglObjects;m=0;for(o=t.length;m<o;m++)if(r=t[m],n=r.object,r.render=!1,n.visible&&n.castShadow&&(!(n instanceof THREE.Mesh)||!n.frustumCulled||e.contains(n)))n._modelViewMatrix.multiply(q.matrixWorldInverse,n.matrixWorld),r.render=!0;m=0;for(o=t.length;m<o;m++)r=t[m],r.render&&(n=r.object,r=r.buffer,u=n.customDepthMaterial?n.customDepthMaterial:n.geometry.morphTargets.length?d:c,r instanceof THREE.BufferGeometry?b.renderBufferDirect(q,
j.__lights,null,u,r,n):b.renderBuffer(q,j.__lights,null,u,r,n));t=j.__webglObjectsImmediate;m=0;for(o=t.length;m<o;m++)r=t[m],n=r.object,n.visible&&n.castShadow&&(n._modelViewMatrix.multiply(q.matrixWorldInverse,n.matrixWorld),b.renderImmediateObject(q,j.__lights,null,c,n))}l=b.getClearColor();p=b.getClearAlpha();a.clearColor(l.r,l.g,l.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
k.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=!1};this.render=function(d,e,o,q){var d=d.__webglSprites,n=d.length;if(n){var r=j,u=k,t=q/o,o=0.5*o,w=0.5*q,s=!0;b.useProgram(h);l||(b.enableVertexAttribArray(r.position),b.enableVertexAttribArray(r.uv),l=!0);b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(!0);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(r.position,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(u.projectionMatrix,
!1,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(u.map,0);for(var x,H=[],r=0;r<n;r++)x=d[r],x.visible&&0!==x.opacity&&(x.useScreenCoordinates?x.z=-x.position.z:(x._modelViewMatrix.multiply(e.matrixWorldInverse,x.matrixWorld),x.z=-x._modelViewMatrix.elements[14]));d.sort(a);for(r=0;r<n;r++)if(x=d[r],x.visible&&0!==x.opacity&&x.map&&x.map.image&&x.map.image.width)x.useScreenCoordinates?(b.uniform1i(u.useScreenCoordinates,1),b.uniform3f(u.screenPosition,(x.position.x-o)/o,(w-x.position.y)/
w,Math.max(0,Math.min(1,x.position.z)))):(b.uniform1i(u.useScreenCoordinates,0),b.uniform1i(u.affectedByDistance,x.affectedByDistance?1:0),b.uniformMatrix4fv(u.modelViewMatrix,!1,x._modelViewMatrix.elements)),e=x.map.image.width/(x.scaleByViewport?q:1),H[0]=e*t*x.scale.x,H[1]=e*x.scale.y,b.uniform2f(u.uvScale,x.uvScale.x,x.uvScale.y),b.uniform2f(u.uvOffset,x.uvOffset.x,x.uvOffset.y),b.uniform2f(u.alignment,x.alignment.x,x.alignment.y),b.uniform1f(u.opacity,x.opacity),b.uniform3f(u.color,x.color.r,
x.color.g,x.color.b),b.uniform1f(u.rotation,x.rotation),b.uniform2fv(u.scale,H),x.mergeWith3D&&!s?(b.enable(b.DEPTH_TEST),s=!0):!x.mergeWith3D&&s&&(b.disable(b.DEPTH_TEST),s=!1),c.setBlending(x.blending,x.blendEquation,x.blendSrc,x.blendDst),c.setTexture(x.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(!0)}}};
...
h.matrixWorldInverse);e.setFromMatrix(f);b.setRenderTarget(this.renderTarget);b.clear();o=g.__webglObjects;j=0;for(k=o.length;j<k;j++)if(l=o[j],m=l.object,l.render=!1,m.visible&&(!(m instanceof THREE.Mesh)||!m.frustumCulled||e.contains(m)))m._modelViewMatrix.multiply(h.matrixWorldInverse,m.matrixWorld),l.render=!0;j=0;for(k=o.length;j<k;j++)l=o[j],l.render&&(m=l.object,l=l.buffer,b.setObjectFaces(m),p=m.customDepthMaterial?m.customDepthMaterial:m.geometry.morphTargets.length?d:c,l instanceof THREE.BufferGeometry?
b.renderBufferDirect(h,g.__lights,null,p,l,m):b.renderBuffer(h,g.__lights,null,p,l,m));o=g.__webglObjectsImmediate;j=0;for(k=o.length;j<k;j++)l=o[j],m=l.object,m.visible&&m.castShadow&&(m._modelViewMatrix.multiply(h.matrixWorldInverse,m.matrixWorld),b.renderImmediateObject(h,g.__lights,null,c,m));j=b.getClearColor();k=b.getClearAlpha();a.clearColor(j.r,j.g,j.b,k);a.enable(a.BLEND)}};
...
tQuery.World.register("addBoilerplate",function(a){console.assert(!0!==this.hasBoilerplate());var a=tQuery.extend(a,{stats:!0,cameraControls:!0,windowResize:!0,screenshot:!0,fullscreen:!0}),b={};tQuery.data(this,"_boilerplateCtx",b);a.stats&&(b.stats=new Stats,b.stats.domElement.style.position="absolute",b.stats.domElement.style.bottom="0px",document.body.appendChild(b.stats.domElement),b.loopStats=function(){b.stats.update()},this.loop().hook(b.loopStats));var c=this.camera(),d=this.renderer();a.cameraControls&&
...
var Stats=function(){var a,b,c=0,d=0,e=Date.now(),f=e,g=e,h=0,j=1E3,k=0,l,p,m,o=[[16,16,48],[0,255,255]],q=0,n=1E3,r=0,u,t,w,s=[[16,48,16],[0,255,0]];a=document.createElement("div");a.style.cursor="pointer";a.style.width="80px";a.style.opacity="0.9";a.style.zIndex="10001";a.addEventListener("mousedown",function(a){a.preventDefault();c=(c+1)%2;0==c?(l.style.display="block",u.style.display="none"):(l.style.display="none",u.style.display="block")},!1);l=document.createElement("div");l.style.textAlign=
