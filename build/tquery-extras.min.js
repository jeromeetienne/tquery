...
function define(a,b){1===arguments.length&&(b=arguments[0],a=[]);b()}var THREEx=THREEx||{};THREEx.WindowResize=function(a,b){var c=function(){a.setSize(window.innerWidth,window.innerHeight);b.aspect=window.innerWidth/window.innerHeight;b.updateProjectionMatrix()};window.addEventListener("resize",c,!1);return{stop:function(){window.removeEventListener("resize",c)}}};THREEx.WindowResize.bind=function(a,b){return THREEx.WindowResize(a,b)};THREEx=THREEx||{};
(function(){var a=function(a,c,d,e){var f=function(a,b){return function(){return a.apply(b,arguments)}}(function(){var a,b,f=document.createElement("canvas");f.width=c;f.height=d;var j=f.getContext("2d");j.fillStyle="black";j.fillRect(0,0,f.width,f.height);a=f.width;var m=f.height,k=h.width;b=h.height;var l=b/k;k>=a&&1>=l?(k=a,b=a*l):b>=m&&(b=m,k=m/l);a=k;j.drawImage(h,(f.width-a)/2,(f.height-b)/2,a,b);f=f.toDataURL("image/png");e&&e(f)},this),h=new Image;h.onload=f;h.src=a};THREEx.Screenshot={toDataURL:function(a,
c){return a.domElement.toDataURL(c||"image/png")},bindKey:function(b,c){var c=c||{},d=c.charCode||112,e=c.width,f=c.height,h=c.callback||function(a){window.open(a,"name-"+Math.random())},g=function(a,b){return function(){return a.apply(b,arguments)}}(function(c){c.which===d&&(c=this.toDataURL(b),void 0===e&&void 0===f?h(c):a(c,e,f,h))},this);document.addEventListener("keypress",g,!1);return{unbind:function(){document.removeEventListener("keypress",g,!1)}}}}})();THREEx=THREEx||{};
...
THREEx.KeyboardState.prototype.pressed=function(a){for(var a=a.split("+"),b=0;b<a.length;b++){var c=a[b];if(!(-1!==THREEx.KeyboardState.MODIFIERS.indexOf(c)?this.modifiers[c]:-1!=Object.keys(THREEx.KeyboardState.ALIAS).indexOf(c)?this.keyCodes[THREEx.KeyboardState.ALIAS[c]]:this.keyCodes[c.toUpperCase().charCodeAt(0)]))return!1}return!0};THREEx=THREEx||{};
...
var Stats=function(){var a,b,c=0,d=0,e=Date.now(),f=e,h=e,g=0,i=1E3,o=0,j,m,k,l=[[16,16,48],[0,255,255]],s=0,t=1E3,u=0,p,r,q,n=[[16,48,16],[0,255,0]];a=document.createElement("div");a.style.cursor="pointer";a.style.width="80px";a.style.opacity="0.9";a.style.zIndex="10001";a.addEventListener("mousedown",function(a){a.preventDefault();c=(c+1)%2;0==c?(j.style.display="block",p.style.display="none"):(j.style.display="none",p.style.display="block")},!1);j=document.createElement("div");j.style.textAlign=
"left";j.style.lineHeight="1.2em";j.style.backgroundColor="rgb("+Math.floor(l[0][0]/2)+","+Math.floor(l[0][1]/2)+","+Math.floor(l[0][2]/2)+")";j.style.padding="0 0 3px 3px";a.appendChild(j);m=document.createElement("div");m.style.fontFamily="Helvetica, Arial, sans-serif";m.style.fontSize="9px";m.style.color="rgb("+l[1][0]+","+l[1][1]+","+l[1][2]+")";m.style.fontWeight="bold";m.innerHTML="FPS";j.appendChild(m);k=document.createElement("div");k.style.position="relative";k.style.width="74px";k.style.height=
"30px";k.style.backgroundColor="rgb("+l[1][0]+","+l[1][1]+","+l[1][2]+")";for(j.appendChild(k);74>k.children.length;)b=document.createElement("span"),b.style.width="1px",b.style.height="30px",b.style.cssFloat="left",b.style.backgroundColor="rgb("+l[0][0]+","+l[0][1]+","+l[0][2]+")",k.appendChild(b);p=document.createElement("div");p.style.textAlign="left";p.style.lineHeight="1.2em";p.style.backgroundColor="rgb("+Math.floor(n[0][0]/2)+","+Math.floor(n[0][1]/2)+","+Math.floor(n[0][2]/2)+")";p.style.padding=
"0 0 3px 3px";p.style.display="none";a.appendChild(p);r=document.createElement("div");r.style.fontFamily="Helvetica, Arial, sans-serif";r.style.fontSize="9px";r.style.color="rgb("+n[1][0]+","+n[1][1]+","+n[1][2]+")";r.style.fontWeight="bold";r.innerHTML="MS";p.appendChild(r);q=document.createElement("div");q.style.position="relative";q.style.width="74px";q.style.height="30px";q.style.backgroundColor="rgb("+n[1][0]+","+n[1][1]+","+n[1][2]+")";for(p.appendChild(q);74>q.children.length;)b=document.createElement("span"),
b.style.width="1px",b.style.height=30*Math.random()+"px",b.style.cssFloat="left",b.style.backgroundColor="rgb("+n[0][0]+","+n[0][1]+","+n[0][2]+")",q.appendChild(b);return{domElement:a,update:function(){e=Date.now();s=e-f;t=Math.min(t,s);u=Math.max(u,s);r.textContent=s+" MS ("+t+"-"+u+")";var a=Math.min(30,30-30*(s/200));q.appendChild(q.firstChild).style.height=a+"px";f=e;d++;e>h+1E3&&(g=Math.round(1E3*d/(e-h)),i=Math.min(i,g),o=Math.max(o,g),m.textContent=g+" FPS ("+i+"-"+o+")",a=Math.min(30,30-
30*(g/100)),k.appendChild(k.firstChild).style.height=a+"px",h=e,d=0)}}};define(["threex/THREEx.KeyboardState"],function(){var a=null;tQuery.register("keyboard",function(){a||(a=new THREEx.KeyboardState);return a})});tQuery.register("Shape",function(a){this._tShape=a||new THREE.Shape});tQuery.Shape.prototype.extrude=function(a){a=tQuery.extend(a,tQuery.defaultExtrudeSettings);a=this._tShape.extrude(a);a.dynamic=!0;return tQuery(a)};tQuery.Shape.forwardFns=["moveTo","lineTo","bezierCurveTo","quadraticCurveTo"];
...
var CSG=function(){this.root=new CSG.Node};CSG.fromPolygons=function(a){var b=new CSG;b.root.build(a);return b};
...
CSG.sphere=function(a){function b(a,b){var a=a*2*Math.PI,b=b*Math.PI,e=new CSG.Vector(Math.cos(a)*Math.sin(b),Math.cos(b),Math.sin(a)*Math.sin(b));h.push(new CSG.Vertex(c.plus(e.times(d)),e))}for(var a=a||{},c=new CSG.Vector(a.center||[0,0,0]),d=a.radius||1,e=a.slices||16,a=a.stacks||8,f=[],h,g=0;g<e;g++)for(var i=0;i<a;i++)h=[],b(g/e,i/a),0<i&&b((g+1)/e,i/a),i<a-1&&b((g+1)/e,(i+1)/a),b(g/e,(i+1)/a),f.push(new CSG.Polygon(h));return CSG.fromPolygons(f)};
CSG.cylinder=function(a){function b(a,b,d){b=2*b*Math.PI;b=i.times(Math.cos(b)).plus(o.times(Math.sin(b)));a=c.plus(e.times(a)).plus(b.times(f));d=b.times(1-Math.abs(d)).plus(h.times(d));return new CSG.Vertex(a,d)}for(var a=a||{},c=new CSG.Vector(a.start||[0,-1,0]),d=new CSG.Vector(a.end||[0,1,0]),e=d.minus(c),f=a.radius||1,a=a.slices||16,h=e.unit(),g=0.5<Math.abs(h.y),i=(new CSG.Vector(g,!g,0)).cross(h).unit(),o=i.cross(h).unit(),g=new CSG.Vertex(c,h.negated()),d=new CSG.Vertex(d,h.unit()),j=[],
m=0;m<a;m++){var k=m/a,l=(m+1)/a;j.push(new CSG.Polygon([g,b(0,k,-1),b(0,l,-1)]));j.push(new CSG.Polygon([b(0,l,0),b(0,k,0),b(1,k,0),b(1,l,0)]));j.push(new CSG.Polygon([d,b(1,l,1),b(1,k,1)]))}return CSG.fromPolygons(j)};CSG.Vector=function(a,b,c){3==arguments.length?(this.x=a,this.y=b,this.z=c):"x"in a?(this.x=a.x,this.y=a.y,this.z=a.z):(this.x=a[0],this.y=a[1],this.z=a[2])};
...
CSG.Plane.prototype={clone:function(){return new CSG.Plane(this.normal.clone(),this.w)},flip:function(){this.normal=this.normal.negated();this.w=-this.w},splitPolygon:function(a,b,c,d,e){for(var f=0,h=[],g=0;g<a.vertices.length;g++){var i=this.normal.dot(a.vertices[g].pos)-this.w,i=i<-CSG.Plane.EPSILON?2:i>CSG.Plane.EPSILON?1:0,f=f|i;h.push(i)}switch(f){case 0:(0<this.normal.dot(a.plane.normal)?b:c).push(a);break;case 1:d.push(a);break;case 2:e.push(a);break;case 3:b=[];c=[];for(g=0;g<a.vertices.length;g++){var o=
(g+1)%a.vertices.length,i=h[g],j=h[o],f=a.vertices[g],o=a.vertices[o];2!=i&&b.push(f);1!=i&&c.push(2!=i?f.clone():f);3==(i|j)&&(i=(this.w-this.normal.dot(f.pos))/this.normal.dot(o.pos.minus(f.pos)),i=f.interpolate(o,i),b.push(i),c.push(i.clone()))}3<=b.length&&d.push(new CSG.Polygon(b,a.shared));3<=c.length&&e.push(new CSG.Polygon(c,a.shared))}}};CSG.Polygon=function(a,b){this.vertices=a;this.shared=b;this.plane=CSG.Plane.fromPoints(a[0].pos,a[1].pos,a[2].pos)};
...
a)})});
tQuery.register("createTVSnowTexture",function(a){for(var a=tQuery.extend(a,{loop:tQuery.world.loop(),width:256,height:256,nCanvases:10}),b=function(a,b){var c=document.createElement("canvas"),d=c.getContext("2d");c.width=a;c.height=b;for(var e=d.createImageData(c.width,c.height),f=e.data,g=0;g<f.length;g+=4){var h=Math.floor(256*Math.random());f[g]=h;f[g+1]=h;f[g+2]=h;f[g+3]=255}d.putImageData(e,0,0);return c},c=[],d=0;d<a.nCanvases;d++){var e=b(a.width,a.height);c.push(e)}var e=document.createElement("canvas"),f=
e.getContext("2d");e.width=a.width;e.height=a.height;var h=new THREE.Texture(e),g=0;a.loop.hook(function(){f.drawImage(c[g],0,0);g=(g+1)%c.length;h.needsUpdate=!0});return h});
...
tQuery.mixinAttributes(tQuery.MeshPhongMaterial,{color:tQuery.convert.toThreeColor,ambient:tQuery.convert.toThreeColor,specular:tQuery.convert.toThreeColor,shininess:tQuery.convert.toNumber,map:tQuery.convert.toTexture});
