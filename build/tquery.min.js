...
tQuery.inherit=function(a,b){var c=function(){};c.prototype=b.prototype;a.prototype=new c;a.prototype.parent=b.prototype;a.prototype.constructor=a};tQuery.pluginsMixin=function(a,b){b=b||a.prototype||a;a.register=function(a,d){if(b[a])throw Error("Conflict! Already method called: "+a);b[a]=d};a.unregister=function(a){if(!1===b.hasOwnProperty(a))throw Error("Plugin not found: "+a);delete b[a]};a.registered=function(a){return!0===b.hasOwnProperty(a)}};tQuery.pluginsMixin(tQuery,tQuery);
tQuery.register("createScene",function(){return new tQuery.Scene});tQuery.register("createLoop",function(a){return new tQuery.Loop(a)});tQuery.register("createCube",function(){var a=new THREE.MeshNormalMaterial,b=new THREE.CubeGeometry(1,1,1);b.dynamic=!0;a=new THREE.Mesh(b,a);return tQuery(a)});tQuery.register("createTorus",function(){var a=new THREE.MeshNormalMaterial,b=new THREE.TorusGeometry(0.35,0.15);b.dynamic=!0;a=new THREE.Mesh(b,a);return tQuery(a)});
tQuery.register("createSphere",function(){var a=new THREE.MeshNormalMaterial,b=new THREE.SphereGeometry(0.5,0.5);b.dynamic=!0;a=new THREE.Mesh(b,a);return tQuery(a)});tQuery.register("createAxis",function(){var a=new THREE.AxisHelper;a.scale.multiplyScalar(0.025);return tQuery(a)});tQuery.Node=function(a){this._lists=a instanceof Array?a:a?[a]:[];this.length=this._lists.length};
tQuery.Node.prototype.get=function(a){if(void 0===a)return this._lists;console.assert(this._lists[a],"element not defined");return this._lists[a]};tQuery.Node.prototype.each=function(a){for(var b=0;b<this._lists.length;b++)if(!1===a(this._lists[b]))return!1;return!0};tQuery.Node.prototype.back=function(a){if(void 0===a)return this._back;this._back=a;return this};tQuery.Object3D=function(a,b){"string"===typeof a&&(a=tQuery.Object3D._select(a,b));this._lists=a instanceof Array?a:[a];this.length=this._lists.length};
tQuery.pluginsMixin(tQuery.Object3D);tQuery.Object3D.prototype.get=function(a){if(void 0===a)return this._lists;console.assert(this._lists[a],"element not defined");return this._lists[a]};tQuery.Object3D.prototype.each=function(a){for(var b=0;b<this._lists.length;b++)if(!1===a(this._lists[b]))return!1;return!0};tQuery.Object3D.prototype.geometry=function(){var a=[];this.each(function(b){a.push(b.geometry)});return(new tQuery.Geometry(a)).back(this)};
tQuery.Object3D.prototype.material=function(){var a=[];this.each(function(b){a.push(b.material)});return new tQuery.Material(a)};tQuery.Object3D.prototype.addTo=function(a){console.assert(a instanceof tQuery.Scene);this.each(function(b){a.add(b)}.bind(this));return this};tQuery.Object3D.prototype.removeFrom=function(a){console.assert(a instanceof tQuery.Scene);this.each(function(b){a.remove(b)}.bind(this));return this};
...
tQuery.Object3D._selectItemMatch=function(a,b){console.assert(a instanceof THREE.Object3D);console.assert("string"===typeof b);var c="buffer,cube,cylinder,extrude,icosahedron,lathe,octahedron,plane,sphere,text,torus,torusknot".split(","),d=b.match(RegExp("([^.#]+|.[^.#]+|#[^.#]+)","g"));return tQuery.each(d,function(b){var d=b.charAt(0),e=b.slice(1);if("."===d)return tQuery.Object3D._hasClassOne(a,e)?!0:!1;if("#"===d)return a._tqId===e?!0:!1;if(-1!==c.indexOf(b))return d=a.geometry,b=b.charAt(0).toUpperCase()+
