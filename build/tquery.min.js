...
tQuery.register("_createMesh",function(a,b,c){var c=Array.prototype.slice.call(c),d=tQuery.defaultObject3DMaterial;c.length&&c[c.length-1]instanceof THREE.Material&&(d=c.pop());0===c.length&&(c=b.slice());c.unshift(a);a=function(a,b,c,d,q,g,m,l,h){console.assert(9>=arguments.length);return new a(b,c,d,q,g,m,l,h)}.apply(this,c);a.dynamic=!0;d=new THREE.Mesh(a,d);return tQuery(d)});tQuery.register("createAxis",function(){var a=new THREE.AxisHelper;a.scale.multiplyScalar(0.01);return tQuery(a)});
...
false&&this.removeBoilerplate()});return this});tQuery.World.register("hasBoilerplate",function(){return void 0===tQuery.data(this,"_boilerplateCtx")?!1:!0});
...
(function(){var a=function(a,c,d,e){var f=function(a,b){return function(){return a.apply(b,arguments)}}(function(){var a,b,g=document.createElement("canvas");g.width=c;g.height=d;var f=g.getContext("2d");f.fillStyle="black";f.fillRect(0,0,g.width,g.height);a=g.width;var l=g.height,h=i.width;b=i.height;var j=b/h;h>=a&&1>=j?(h=a,b=a*j):b>=l&&(b=l,h=l/j);a=h;f.drawImage(i,(g.width-a)/2,(g.height-b)/2,a,b);g=g.toDataURL("image/png");e&&e(g)},this),i=new Image;i.onload=f;i.src=a};THREEx.Screenshot={toDataURL:function(a,
c){return a.domElement.toDataURL(c||"image/png")},bindKey:function(b,c){var c=c||{},d=c.charCode||112,e=c.width,f=c.height,i=c.callback||function(a){window.open(a,"name-"+Math.random())},k=function(a,b){return function(){return a.apply(b,arguments)}}(function(c){c.which===d&&(c=this.toDataURL(b),void 0===e&&void 0===f?i(c):a(c,e,f,i))},this);document.addEventListener("keypress",k,!1);return{unbind:function(){document.removeEventListener("keypress",k,!1)}}}}})();THREEx=THREEx||{};
...
var Stats=function(){var a,b,c=0,d=0,e=Date.now(),f=e,i=e,k=0,q=1E3,g=0,m,l,h,j=[[16,16,48],[0,255,255]],s=0,t=1E3,u=0,o,r,p,n=[[16,48,16],[0,255,0]];a=document.createElement("div");a.style.cursor="pointer";a.style.width="80px";a.style.opacity="0.9";a.style.zIndex="10001";a.addEventListener("mousedown",function(a){a.preventDefault();c=(c+1)%2;0==c?(m.style.display="block",o.style.display="none"):(m.style.display="none",o.style.display="block")},!1);m=document.createElement("div");m.style.textAlign=
"left";m.style.lineHeight="1.2em";m.style.backgroundColor="rgb("+Math.floor(j[0][0]/2)+","+Math.floor(j[0][1]/2)+","+Math.floor(j[0][2]/2)+")";m.style.padding="0 0 3px 3px";a.appendChild(m);l=document.createElement("div");l.style.fontFamily="Helvetica, Arial, sans-serif";l.style.fontSize="9px";l.style.color="rgb("+j[1][0]+","+j[1][1]+","+j[1][2]+")";l.style.fontWeight="bold";l.innerHTML="FPS";m.appendChild(l);h=document.createElement("div");h.style.position="relative";h.style.width="74px";h.style.height=
"30px";h.style.backgroundColor="rgb("+j[1][0]+","+j[1][1]+","+j[1][2]+")";for(m.appendChild(h);74>h.children.length;)b=document.createElement("span"),b.style.width="1px",b.style.height="30px",b.style.cssFloat="left",b.style.backgroundColor="rgb("+j[0][0]+","+j[0][1]+","+j[0][2]+")",h.appendChild(b);o=document.createElement("div");o.style.textAlign="left";o.style.lineHeight="1.2em";o.style.backgroundColor="rgb("+Math.floor(n[0][0]/2)+","+Math.floor(n[0][1]/2)+","+Math.floor(n[0][2]/2)+")";o.style.padding=
"0 0 3px 3px";o.style.display="none";a.appendChild(o);r=document.createElement("div");r.style.fontFamily="Helvetica, Arial, sans-serif";r.style.fontSize="9px";r.style.color="rgb("+n[1][0]+","+n[1][1]+","+n[1][2]+")";r.style.fontWeight="bold";r.innerHTML="MS";o.appendChild(r);p=document.createElement("div");p.style.position="relative";p.style.width="74px";p.style.height="30px";p.style.backgroundColor="rgb("+n[1][0]+","+n[1][1]+","+n[1][2]+")";for(o.appendChild(p);74>p.children.length;)b=document.createElement("span"),
b.style.width="1px",b.style.height=30*Math.random()+"px",b.style.cssFloat="left",b.style.backgroundColor="rgb("+n[0][0]+","+n[0][1]+","+n[0][2]+")",p.appendChild(b);return{domElement:a,update:function(){e=Date.now();s=e-f;t=Math.min(t,s);u=Math.max(u,s);r.textContent=s+" MS ("+t+"-"+u+")";var a=Math.min(30,30-30*(s/200));p.appendChild(p.firstChild).style.height=a+"px";f=e;d++;e>i+1E3&&(k=Math.round(1E3*d/(e-i)),q=Math.min(q,k),g=Math.max(g,k),l.textContent=k+" FPS ("+q+"-"+g+")",a=Math.min(30,30-
30*(k/100)),h.appendChild(h.firstChild).style.height=a+"px",i=e,d=0)}}};
