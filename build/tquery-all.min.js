...
function(){l.clearRect(0,0,i.width,i.height);l.drawImage(q,0,0,i.width,i.height);this.trigger("load")}.bind(this);q.src=this._opts.url;this.createMesh=function(a,c){var d=b(a+c*g);if(!d)return null;d=new THREE.Mesh(d,j);return tQuery(d)};this.createGeometry=b;this.imgW=function(){return c};this.imgH=function(){return d};this.spriteW=function(){return e};this.spriteH=function(){return f};this.nSpriteX=function(){return g};this.nSpriteY=function(){return h}});tQuery.MicroeventMixin(tQuery.Spritesheet.prototype);
